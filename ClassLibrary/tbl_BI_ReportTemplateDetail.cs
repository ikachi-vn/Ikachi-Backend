...
namespace ClassLibrary
{
    ...
    public partial class tbl_BI_ReportTemplateDetail
    {
...
{
	using System;
	public partial class DTO_BI_ReportTemplateDetail
	{
		public int IDTemplate { get; set; }
		public Nullable<int> IDParent { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_BI_ReportTemplateDetail 
    {
		...
		public static IQueryable<DTO_BI_ReportTemplateDetail> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_BI_ReportTemplateDetail> allItems = db.tbl_BI_ReportTemplateDetail.Where(d => d.IsDeleted == false).Select(s => new DTO_BI_ReportTemplateDetail()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_BI_ReportTemplateDetail.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_BI_ReportTemplateDetail> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_BI_ReportTemplateDetail> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS BI_ReportTemplateDetail";
		...
		public static DTO_BI_ReportTemplateDetail getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_BI_ReportTemplateDetail.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_BI_ReportTemplateDetail getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_BI_ReportTemplateDetail
        ...
        {
            bool result = false;
            var dbitem = db.tbl_BI_ReportTemplateDetail.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_BI_ReportTemplateDetail",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_BI_ReportTemplateDetail dbitem, string Username)
        {
            Type type = typeof(tbl_BI_ReportTemplateDetail);
        ...
        public static void patchDTOtoDBValue( DTO_BI_ReportTemplateDetail item, tbl_BI_ReportTemplateDetail dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDTemplate = item.IDTemplate;							
			...
			dbitem.CashFlowID = item.CashFlowID;        }

		public static DTO_BI_ReportTemplateDetail post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_BI_ReportTemplateDetail dbitem = new tbl_BI_ReportTemplateDetail();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_BI_ReportTemplateDetail.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_BI_ReportTemplateDetail",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_BI_ReportTemplateDetail();
                    ...
                    {
                        dbitem = new tbl_BI_ReportTemplateDetail();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_BI_ReportTemplateDetail.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_BI_ReportTemplateDetail.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_BI_ReportTemplateDetail.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_BI_ReportTemplateDetail", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_BI_ReportTemplateDetail",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_BI_ReportTemplateDetail",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_BI_ReportTemplateDetail.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_BI_ReportTemplateDetail.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_BI_ReportTemplateDetail> toDTO(IQueryable<tbl_BI_ReportTemplateDetail> query)
        {
			return query
			.Select(s => new DTO_BI_ReportTemplateDetail(){							
				IDTemplate = s.IDTemplate,							
				IDParent = s.IDParent,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
		...
		public static DTO_BI_ReportTemplateDetail toDTO(tbl_BI_ReportTemplateDetail dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_BI_ReportTemplateDetail()
				{							
					IDTemplate = dbResult.IDTemplate,							
					...
					CashFlowID = dbResult.CashFlowID,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_BI_ReportTemplateDetail> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_BI_ReportTemplateDetail> query = db.tbl_BI_ReportTemplateDetail.AsNoTracking();//.Where(d => d.IsDeleted == false );
			...
			//Query IDTemplate (int)
			if (QueryStrings.Any(d => d.Key == "IDTemplate"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDTemplate").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int> IDs = new List<int>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDTemplate));
            }
...
//                    
			...
			//Query CashFlowID (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "CashFlowID"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "CashFlowID").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.CashFlowID));
////                    query = query.Where(d => IDs.Contains(d.CashFlowID));
//                    
            }
            return query;
        ...
        public static IQueryable<tbl_BI_ReportTemplateDetail> _sortBuilder(IQueryable<tbl_BI_ReportTemplateDetail> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_BI_ReportTemplateDetail>;
                        bool isOrdered = ordered.ToString().IndexOf("ORDER BY") !=-1;

                        switch (item)
                        {
							case "IDTemplate":
								query = isOrdered ? ordered.ThenBy(o => o.IDTemplate) : query.OrderBy(o => o.IDTemplate);
								 break;
							case "IDTemplate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDTemplate) : query.OrderByDescending(o => o.IDTemplate);
                                break;
							case "IDParent":
							...
							case "CostCenter_desc":
                                ...
                                break;
							case "CashFlowID":
								query = isOrdered ? ordered.ThenBy(o => o.CashFlowID) : query.OrderBy(o => o.CashFlowID);
								 break;
							case "CashFlowID_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.CashFlowID) : query.OrderByDescending(o => o.CashFlowID);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_BI_ReportTemplateDetail> _pagingBuilder(IQueryable<tbl_BI_ReportTemplateDetail> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
