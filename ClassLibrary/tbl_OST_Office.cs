...
namespace ClassLibrary
{
    ...
    public partial class tbl_OST_Office
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_OST_Office()
        {
            this.tbl_OST_OfficeGate = new HashSet<tbl_OST_OfficeGate>();
        }
        ...
        public virtual ICollection<tbl_OST_OfficeGate> tbl_OST_OfficeGate { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_OST_Office
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_OST_Office 
    {
		...
		public static IQueryable<DTO_OST_Office> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS OST_Office";
		...
		public static DTO_OST_Office getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_OST_Office.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_OST_Office getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_OST_Office
        ...
        {
            bool result = false;
            var dbitem = db.tbl_OST_Office.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_OST_Office",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_OST_Office dbitem, string Username)
        {
            Type type = typeof(tbl_OST_Office);
        ...
        public static void patchDTOtoDBValue( DTO_OST_Office item, tbl_OST_Office dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_OST_Office post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_OST_Office dbitem = new tbl_OST_Office();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_OST_Office.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_OST_Office",e);
                    return null;
                }
            }
            return toDTO(dbitem);
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_OST_Office();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_OST_Office.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_OST_Office.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_OST_Office.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_OST_Office", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_OST_Office",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_OST_Office",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_OST_Office.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_OST_Office.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_OST_Office> toDTO(IQueryable<tbl_OST_Office> query)
        {
			return query
			.Select(s => new DTO_OST_Office(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Address = s.Address,							
		...
		public static DTO_OST_Office toDTO(tbl_OST_Office dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_OST_Office()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
		...
		public static IQueryable<tbl_OST_Office> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_OST_Office> query = db.tbl_OST_Office.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_OST_Office> _sortBuilder(IQueryable<tbl_OST_Office> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_OST_Office>;
        ...
        public static IQueryable<tbl_OST_Office> _pagingBuilder(IQueryable<tbl_OST_Office> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
