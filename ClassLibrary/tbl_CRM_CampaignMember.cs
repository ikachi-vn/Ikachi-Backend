...
namespace ClassLibrary
{
    ...
    public partial class tbl_CRM_CampaignMember
    {
...
{
	using System;
	public partial class DTO_CRM_CampaignMember
	{
		public Nullable<int> IDCampaign { get; set; }
		public Nullable<int> IDLead { get; set; }
		public Nullable<int> IDContact { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CRM_CampaignMember 
    {
		...
		public static IQueryable<DTO_CRM_CampaignMember> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS CRM_CampaignMember";
		...
		public static DTO_CRM_CampaignMember getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_CRM_CampaignMember.Find(id);
		...
		public static DTO_CRM_CampaignMember getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_CRM_CampaignMember
        ...
        {
            bool result = false;
            var dbitem = db.tbl_CRM_CampaignMember.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_CRM_CampaignMember",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_CRM_CampaignMember dbitem, string Username)
        {
            Type type = typeof(tbl_CRM_CampaignMember);
        ...
        public static void patchDTOtoDBValue( DTO_CRM_CampaignMember item, tbl_CRM_CampaignMember dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_CRM_CampaignMember post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_CRM_CampaignMember dbitem = new tbl_CRM_CampaignMember();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_CRM_CampaignMember.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_CRM_CampaignMember",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_CRM_CampaignMember();
                    ...
                    {
                        dbitem = new tbl_CRM_CampaignMember();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_CRM_CampaignMember.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_CRM_CampaignMember.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_CRM_CampaignMember.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_CRM_CampaignMember", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_CRM_CampaignMember",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_CRM_CampaignMember",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_CRM_CampaignMember.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_CRM_CampaignMember.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_CRM_CampaignMember> toDTO(IQueryable<tbl_CRM_CampaignMember> query)
        {
			return query
			.Select(s => new DTO_CRM_CampaignMember(){							
		...
		public static DTO_CRM_CampaignMember toDTO(tbl_CRM_CampaignMember dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CRM_CampaignMember()
				{							
		...
		public static IQueryable<tbl_CRM_CampaignMember> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_CRM_CampaignMember> query = db.tbl_CRM_CampaignMember.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_CRM_CampaignMember> _sortBuilder(IQueryable<tbl_CRM_CampaignMember> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_CRM_CampaignMember>;
        ...
        public static IQueryable<tbl_CRM_CampaignMember> _pagingBuilder(IQueryable<tbl_CRM_CampaignMember> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
