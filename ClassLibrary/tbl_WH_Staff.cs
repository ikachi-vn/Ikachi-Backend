...
namespace ClassLibrary
{
    ...
    public partial class tbl_WH_Staff
    {
...
{
	using System;
	public partial class DTO_WH_Staff
	{
		public Nullable<int> IDBranch { get; set; }
		public Nullable<int> IDDepartment { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WH_Staff 
    {
		...
		public static IQueryable<DTO_WH_Staff> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WH_Staff";
		...
		public static DTO_WH_Staff getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WH_Staff.Find(id);
		...
		public static DTO_WH_Staff getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WH_Staff
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WH_Staff.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WH_Staff",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WH_Staff dbitem, string Username)
        {
            Type type = typeof(tbl_WH_Staff);
        ...
        public static void patchDTOtoDBValue( DTO_WH_Staff item, tbl_WH_Staff dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WH_Staff post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WH_Staff dbitem = new tbl_WH_Staff();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WH_Staff.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WH_Staff",e);
                    return null;
                }
            }
            return toDTO(dbitem);
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_WH_Staff();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WH_Staff.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WH_Staff.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WH_Staff.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WH_Staff", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WH_Staff",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WH_Staff",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WH_Staff.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WH_Staff.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WH_Staff> toDTO(IQueryable<tbl_WH_Staff> query)
        {
			return query
			.Select(s => new DTO_WH_Staff(){							
				IDBranch = s.IDBranch,							
		...
		public static DTO_WH_Staff toDTO(tbl_WH_Staff dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WH_Staff()
				{							
		...
		public static IQueryable<tbl_WH_Staff> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WH_Staff> query = db.tbl_WH_Staff.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_WH_Staff> _sortBuilder(IQueryable<tbl_WH_Staff> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WH_Staff>;
        ...
        public static IQueryable<tbl_WH_Staff> _pagingBuilder(IQueryable<tbl_WH_Staff> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
