...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_GlobalConfig
    {
...
{
	using System;
	public partial class DTO_SYS_GlobalConfig
	{
		public int IDBranch { get; set; }
		public int Id { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_GlobalConfig 
    {
		...
		public static IQueryable<DTO_SYS_GlobalConfig> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_GlobalConfig";
		...
		public static DTO_SYS_GlobalConfig getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_GlobalConfig.Find(id);
		...
		public static DTO_SYS_GlobalConfig getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_SYS_GlobalConfig
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_GlobalConfig.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_GlobalConfig",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_GlobalConfig dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_GlobalConfig);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_GlobalConfig item, tbl_SYS_GlobalConfig dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SYS_GlobalConfig post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_GlobalConfig dbitem = new tbl_SYS_GlobalConfig();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_GlobalConfig.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_GlobalConfig",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_SYS_GlobalConfig();
                    ...
                    {
                        dbitem = new tbl_SYS_GlobalConfig();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_GlobalConfig.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_GlobalConfig.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_GlobalConfig.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_SYS_GlobalConfig", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_GlobalConfig",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_GlobalConfig",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_GlobalConfig.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_GlobalConfig.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_GlobalConfig> toDTO(IQueryable<tbl_SYS_GlobalConfig> query)
        {
			return query
			.Select(s => new DTO_SYS_GlobalConfig(){							
				IDBranch = s.IDBranch,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
		...
		public static DTO_SYS_GlobalConfig toDTO(tbl_SYS_GlobalConfig dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_GlobalConfig()
				{							
		...
		public static IQueryable<tbl_SYS_GlobalConfig> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_GlobalConfig> query = db.tbl_SYS_GlobalConfig.AsNoTracking();//.Where(d => d.IsDeleted == false);
        ...
        public static IQueryable<tbl_SYS_GlobalConfig> _sortBuilder(IQueryable<tbl_SYS_GlobalConfig> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_GlobalConfig>;
                        ...
                        switch (item)
                        {
							...
							case "Value_desc":
                                ...
                                break;
							case "IsLocalHost":
								query = isOrdered ? ordered.ThenBy(o => o.IsLocalHost) : query.OrderBy(o => o.IsLocalHost);
								 break;
							case "IsLocalHost_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsLocalHost) : query.OrderByDescending(o => o.IsLocalHost);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_SYS_GlobalConfig> _pagingBuilder(IQueryable<tbl_SYS_GlobalConfig> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
