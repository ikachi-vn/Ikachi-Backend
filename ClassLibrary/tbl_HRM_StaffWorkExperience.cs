...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffWorkExperience
    {
...
{
	using System;
	public partial class DTO_HRM_StaffWorkExperience
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffWorkExperience 
    {
		...
		public static IQueryable<DTO_HRM_StaffWorkExperience> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffWorkExperience";
		...
		public static DTO_HRM_StaffWorkExperience getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffWorkExperience.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffWorkExperience getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffWorkExperience
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffWorkExperience.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffWorkExperience",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffWorkExperience dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffWorkExperience);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffWorkExperience item, tbl_HRM_StaffWorkExperience dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.FromDate = item.FromDate;							
			dbitem.ToDate = item.ToDate;							
			dbitem.Workplace = item.Workplace;							
			dbitem.IDField = item.IDField;							
			dbitem.IDJobTitle = item.IDJobTitle;							
			dbitem.Description = item.Description;        }

		public static DTO_HRM_StaffWorkExperience post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffWorkExperience dbitem = new tbl_HRM_StaffWorkExperience();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffWorkExperience.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffWorkExperience",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffWorkExperience();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffWorkExperience();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffWorkExperience.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffWorkExperience.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffWorkExperience.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffWorkExperience", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffWorkExperience",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_StaffWorkExperience",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_StaffWorkExperience.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_StaffWorkExperience.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffWorkExperience> toDTO(IQueryable<tbl_HRM_StaffWorkExperience> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffWorkExperience(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
		...
		public static DTO_HRM_StaffWorkExperience toDTO(tbl_HRM_StaffWorkExperience dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffWorkExperience()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					FromDate = dbResult.FromDate,							
					ToDate = dbResult.ToDate,							
					Workplace = dbResult.Workplace,							
					IDField = dbResult.IDField,							
		...
		public static IQueryable<tbl_HRM_StaffWorkExperience> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffWorkExperience> query = db.tbl_HRM_StaffWorkExperience.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
			...
			//Query FromDate (Nullable<System.DateTime>)
			if (QueryStrings.Any(d => d.Key == "FromDateFrom") && QueryStrings.Any(d => d.Key == "FromDateTo"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "FromDateFrom").Value, out DateTime fromDate) && DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "FromDateTo").Value, out DateTime toDate))
                    query = query.Where(d => fromDate <= d.FromDate && d.FromDate <= toDate);

            if (QueryStrings.Any(d => d.Key == "FromDate"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "FromDate").Value, out DateTime val))
                    query = query.Where(d => d.FromDate != null && DbFunctions.TruncateTime(val) == DbFunctions.TruncateTime(d.FromDate));


			//Query ToDate (Nullable<System.DateTime>)
			if (QueryStrings.Any(d => d.Key == "ToDateFrom") && QueryStrings.Any(d => d.Key == "ToDateTo"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ToDateFrom").Value, out DateTime fromDate) && DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ToDateTo").Value, out DateTime toDate))
                    query = query.Where(d => fromDate <= d.ToDate && d.ToDate <= toDate);

            if (QueryStrings.Any(d => d.Key == "ToDate"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ToDate").Value, out DateTime val))
                    query = query.Where(d => d.ToDate != null && DbFunctions.TruncateTime(val) == DbFunctions.TruncateTime(d.ToDate));


			//Query Workplace (string)
			if (QueryStrings.Any(d => d.Key == "Workplace_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Workplace_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Workplace_eq").Value;
                query = query.Where(d=>d.Workplace == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "Workplace") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Workplace").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Workplace").Value;
                query = query.Where(d=>d.Workplace.Contains(keyword));
            }
            

			//Query IDField (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDField"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDField").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDField));
////                    query = query.Where(d => IDs.Contains(d.IDField));
//                    
            }
...
//                    
			...
			if (QueryStrings.Any(d => d.Key == "Description_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Description_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Description_eq").Value;
                query = query.Where(d=>d.Description == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "Description") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Description").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Description").Value;
        ...
        public static IQueryable<tbl_HRM_StaffWorkExperience> _sortBuilder(IQueryable<tbl_HRM_StaffWorkExperience> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffWorkExperience>;
                        ...
                        switch (item)
                        {
							...
							case "IDStaff_desc":
                                ...
                                break;
							case "FromDate":
								query = isOrdered ? ordered.ThenBy(o => o.FromDate) : query.OrderBy(o => o.FromDate);
								 break;
							case "FromDate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.FromDate) : query.OrderByDescending(o => o.FromDate);
                                break;
							case "ToDate":
								query = isOrdered ? ordered.ThenBy(o => o.ToDate) : query.OrderBy(o => o.ToDate);
								 break;
							case "ToDate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.ToDate) : query.OrderByDescending(o => o.ToDate);
                                break;
							case "Workplace":
								query = isOrdered ? ordered.ThenBy(o => o.Workplace) : query.OrderBy(o => o.Workplace);
								 break;
							case "Workplace_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.Workplace) : query.OrderByDescending(o => o.Workplace);
                                break;
							case "IDField":
								query = isOrdered ? ordered.ThenBy(o => o.IDField) : query.OrderBy(o => o.IDField);
								 break;
							case "IDField_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDField) : query.OrderByDescending(o => o.IDField);
                                break;
							case "IDJobTitle":
							...
							case "IDJobTitle_desc":
                                ...
                                break;
							case "Description":
								query = isOrdered ? ordered.ThenBy(o => o.Description) : query.OrderBy(o => o.Description);
								 break;
							case "Description_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.Description) : query.OrderByDescending(o => o.Description);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_HRM_StaffWorkExperience> _pagingBuilder(IQueryable<tbl_HRM_StaffWorkExperience> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
