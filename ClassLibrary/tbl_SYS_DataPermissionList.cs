...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_DataPermissionList
    {
...
{
	using System;
	public partial class DTO_SYS_DataPermissionList
	{
		public int IDRole { get; set; }
		public int IDForm { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_DataPermissionList 
    {
		...
		public static IQueryable<DTO_SYS_DataPermissionList> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_DataPermissionList";
		...
		public static DTO_SYS_DataPermissionList getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_DataPermissionList.Find(id);
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_DataPermissionList.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_DataPermissionList",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_DataPermissionList dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_DataPermissionList);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_DataPermissionList item, tbl_SYS_DataPermissionList dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SYS_DataPermissionList post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_DataPermissionList dbitem = new tbl_SYS_DataPermissionList();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_DataPermissionList.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_DataPermissionList",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_SYS_DataPermissionList();
                    ...
                    {
                        dbitem = new tbl_SYS_DataPermissionList();
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_DataPermissionList.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_DataPermissionList.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_DataPermissionList.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_SYS_DataPermissionList", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_DataPermissionList",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_DataPermissionList.Any(e => e.Id == id && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_DataPermissionList> toDTO(IQueryable<tbl_SYS_DataPermissionList> query)
        {
			return query
			.Select(s => new DTO_SYS_DataPermissionList(){							
				IDRole = s.IDRole,							
				IDForm = s.IDForm,							
				Id = s.Id,							
				IDBranch = s.IDBranch,							
		...
		public static DTO_SYS_DataPermissionList toDTO(tbl_SYS_DataPermissionList dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_DataPermissionList()
				{							
		...
		public static IQueryable<tbl_SYS_DataPermissionList> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_DataPermissionList> query = db.tbl_SYS_DataPermissionList.AsNoTracking();//.Where(d => d.IsDeleted == false);
        ...
        public static IQueryable<tbl_SYS_DataPermissionList> _sortBuilder(IQueryable<tbl_SYS_DataPermissionList> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_DataPermissionList>;
                        bool isOrdered = ordered.ToString().IndexOf("ORDER BY") !=-1;

                        switch (item)
                        {
							case "IDRole":
								query = isOrdered ? ordered.ThenBy(o => o.IDRole) : query.OrderBy(o => o.IDRole);
								 break;
							case "IDRole_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDRole) : query.OrderByDescending(o => o.IDRole);
                                break;
							case "IDForm":
								query = isOrdered ? ordered.ThenBy(o => o.IDForm) : query.OrderBy(o => o.IDForm);
								 break;
							case "IDForm_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDForm) : query.OrderByDescending(o => o.IDForm);
                                break;
							case "Id":
							...
							case "IDBranch_desc":
                                ...
                                break;
							case "Visible":
								query = isOrdered ? ordered.ThenBy(o => o.Visible) : query.OrderBy(o => o.Visible);
								 break;
							case "Visible_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.Visible) : query.OrderByDescending(o => o.Visible);
                                break;
							case "IsDeleted":
        ...
        public static IQueryable<tbl_SYS_DataPermissionList> _pagingBuilder(IQueryable<tbl_SYS_DataPermissionList> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
