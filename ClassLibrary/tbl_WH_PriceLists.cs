...
namespace ClassLibrary
{
    ...
    public partial class tbl_WH_PriceLists
    {
...
{
	using System;
	public partial class DTO_WH_PriceLists
	{
		public int Id { get; set; }
		public Nullable<int> IDBranch { get; set; }
		public Nullable<int> IDBasePriceList { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WH_PriceLists 
    {
		...
		public static IQueryable<DTO_WH_PriceLists> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WH_PriceLists";
		...
		public static DTO_WH_PriceLists getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WH_PriceLists.Find(id);
		...
		public static DTO_WH_PriceLists getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WH_PriceLists
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WH_PriceLists.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WH_PriceLists",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WH_PriceLists dbitem, string Username)
        {
            Type type = typeof(tbl_WH_PriceLists);
        ...
        public static void patchDTOtoDBValue( DTO_WH_PriceLists item, tbl_WH_PriceLists dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WH_PriceLists post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WH_PriceLists dbitem = new tbl_WH_PriceLists();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WH_PriceLists.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WH_PriceLists",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WH_PriceLists();
                    ...
                    {
                        dbitem = new tbl_WH_PriceLists();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WH_PriceLists.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WH_PriceLists.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WH_PriceLists.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WH_PriceLists", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WH_PriceLists",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WH_PriceLists",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WH_PriceLists.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WH_PriceLists.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WH_PriceLists> toDTO(IQueryable<tbl_WH_PriceLists> query)
        {
			return query
			.Select(s => new DTO_WH_PriceLists(){							
				Id = s.Id,							
				IDBranch = s.IDBranch,							
		...
		public static DTO_WH_PriceLists toDTO(tbl_WH_PriceLists dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WH_PriceLists()
				{							
					Id = dbResult.Id,							
		...
		public static IQueryable<tbl_WH_PriceLists> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WH_PriceLists> query = db.tbl_WH_PriceLists.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_WH_PriceLists> _sortBuilder(IQueryable<tbl_WH_PriceLists> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WH_PriceLists>;
        ...
        public static IQueryable<tbl_WH_PriceLists> _pagingBuilder(IQueryable<tbl_WH_PriceLists> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
