...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffTrainingProcessSkill
    {
        ...
        public Nullable<int> IDTrainingProcess { get; set; }
        public Nullable<int> IDSkill { get; set; }
        //List 0:1
        public virtual tbl_HRM_StaffTrainingProcess tbl_HRM_StaffTrainingProcess { get; set; }
        //List 0:1
...
{
	using System;
	public partial class DTO_HRM_StaffTrainingProcessSkill
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffTrainingProcessSkill 
    {
		...
		public static IQueryable<DTO_HRM_StaffTrainingProcessSkill> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffTrainingProcessSkill";
            ...
            if (workBook != null)
            {
                ...
                //var HRM_StaffTrainingProcessList = BS_HRM_StaffTrainingProcess.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_HRM_StaffTrainingProcessSkill getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffTrainingProcessSkill.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffTrainingProcessSkill getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffTrainingProcessSkill
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffTrainingProcessSkill.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffTrainingProcessSkill",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffTrainingProcessSkill dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffTrainingProcessSkill);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffTrainingProcessSkill item, tbl_HRM_StaffTrainingProcessSkill dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDTrainingProcess = item.IDTrainingProcess;							
			dbitem.IDSkill = item.IDSkill;        }

		public static DTO_HRM_StaffTrainingProcessSkill post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffTrainingProcessSkill dbitem = new tbl_HRM_StaffTrainingProcessSkill();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffTrainingProcessSkill.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffTrainingProcessSkill",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffTrainingProcessSkill();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffTrainingProcessSkill();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffTrainingProcessSkill.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffTrainingProcessSkill.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffTrainingProcessSkill.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffTrainingProcessSkill", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffTrainingProcessSkill",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_StaffTrainingProcessSkill",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_StaffTrainingProcessSkill.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_StaffTrainingProcessSkill.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffTrainingProcessSkill> toDTO(IQueryable<tbl_HRM_StaffTrainingProcessSkill> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffTrainingProcessSkill(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
				...
				IDTrainingProcess = s.IDTrainingProcess,							
				IDSkill = s.IDSkill,					
			});//.OrderBy(o => o.Sort == null).ThenBy(u => u.Sort);
                              
        }

		public static DTO_HRM_StaffTrainingProcessSkill toDTO(tbl_HRM_StaffTrainingProcessSkill dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffTrainingProcessSkill()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					IDTrainingProcess = dbResult.IDTrainingProcess,							
					IDSkill = dbResult.IDSkill,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_HRM_StaffTrainingProcessSkill> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffTrainingProcessSkill> query = db.tbl_HRM_StaffTrainingProcessSkill.AsNoTracking();//.Where(d => d.IsDeleted == false );
			...
			//Query IDTrainingProcess (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDTrainingProcess"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDTrainingProcess").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDTrainingProcess));
////                    query = query.Where(d => IDs.Contains(d.IDTrainingProcess));
//                    
            }

			//Query IDSkill (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDSkill"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDSkill").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDSkill));
////                    query = query.Where(d => IDs.Contains(d.IDSkill));
//                    
            }
            return query;
        ...
        public static IQueryable<tbl_HRM_StaffTrainingProcessSkill> _sortBuilder(IQueryable<tbl_HRM_StaffTrainingProcessSkill> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffTrainingProcessSkill>;
                        ...
                        switch (item)
                        {
							...
							case "ModifiedDate_desc":
                                ...
                                break;
							case "IDTrainingProcess":
								query = isOrdered ? ordered.ThenBy(o => o.IDTrainingProcess) : query.OrderBy(o => o.IDTrainingProcess);
								 break;
							case "IDTrainingProcess_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDTrainingProcess) : query.OrderByDescending(o => o.IDTrainingProcess);
                                break;
							case "IDSkill":
								query = isOrdered ? ordered.ThenBy(o => o.IDSkill) : query.OrderBy(o => o.IDSkill);
								 break;
							case "IDSkill_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDSkill) : query.OrderByDescending(o => o.IDSkill);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_HRM_StaffTrainingProcessSkill> _pagingBuilder(IQueryable<tbl_HRM_StaffTrainingProcessSkill> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
