...
namespace ClassLibrary
{
    ...
    public partial class tbl_MR_CompetiorOrder
    {
        public int IDTrackingCompetitor { get; set; }
        ...
        //List 0:1
        public virtual tbl_MR_TrackingCompetitor tbl_MR_TrackingCompetitor { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_MR_CompetiorOrder
	{
		public int IDTrackingCompetitor { get; set; }
		public int IDService { get; set; }
		public int IDProductType { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_MR_CompetiorOrder 
    {
		...
		public static IQueryable<DTO_MR_CompetiorOrder> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS MR_CompetiorOrder";
		...
		public static DTO_MR_CompetiorOrder getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_MR_CompetiorOrder.Find(id);
        ...
        {
            bool result = false;
            var dbitem = db.tbl_MR_CompetiorOrder.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_MR_CompetiorOrder",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_MR_CompetiorOrder dbitem, string Username)
        {
            Type type = typeof(tbl_MR_CompetiorOrder);
        ...
        public static void patchDTOtoDBValue( DTO_MR_CompetiorOrder item, tbl_MR_CompetiorOrder dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDTrackingCompetitor = item.IDTrackingCompetitor;							
		...
		public static DTO_MR_CompetiorOrder post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_MR_CompetiorOrder dbitem = new tbl_MR_CompetiorOrder();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_MR_CompetiorOrder.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_MR_CompetiorOrder",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_MR_CompetiorOrder();
                    ...
                    {
                        dbitem = new tbl_MR_CompetiorOrder();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_MR_CompetiorOrder.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_MR_CompetiorOrder.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_MR_CompetiorOrder.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_MR_CompetiorOrder", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_MR_CompetiorOrder",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_MR_CompetiorOrder.Any(e => e.Id == id && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_MR_CompetiorOrder> toDTO(IQueryable<tbl_MR_CompetiorOrder> query)
        {
			return query
			.Select(s => new DTO_MR_CompetiorOrder(){							
				IDTrackingCompetitor = s.IDTrackingCompetitor,							
		...
		public static DTO_MR_CompetiorOrder toDTO(tbl_MR_CompetiorOrder dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_MR_CompetiorOrder()
				{							
					IDTrackingCompetitor = dbResult.IDTrackingCompetitor,							
		...
		public static IQueryable<tbl_MR_CompetiorOrder> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_MR_CompetiorOrder> query = db.tbl_MR_CompetiorOrder.AsNoTracking();//.Where(d => d.IsDeleted == false );
			...
			//Query IDTrackingCompetitor (int)
			if (QueryStrings.Any(d => d.Key == "IDTrackingCompetitor"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDTrackingCompetitor").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int> IDs = new List<int>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDTrackingCompetitor));
            }
        ...
        public static IQueryable<tbl_MR_CompetiorOrder> _sortBuilder(IQueryable<tbl_MR_CompetiorOrder> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_MR_CompetiorOrder>;
                        bool isOrdered = ordered.ToString().IndexOf("ORDER BY") !=-1;

                        switch (item)
                        {
							case "IDTrackingCompetitor":
								query = isOrdered ? ordered.ThenBy(o => o.IDTrackingCompetitor) : query.OrderBy(o => o.IDTrackingCompetitor);
								 break;
							case "IDTrackingCompetitor_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDTrackingCompetitor) : query.OrderByDescending(o => o.IDTrackingCompetitor);
                                break;
							case "IDService":
        ...
        public static IQueryable<tbl_MR_CompetiorOrder> _pagingBuilder(IQueryable<tbl_MR_CompetiorOrder> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
