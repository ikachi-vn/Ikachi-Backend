...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffForeignLanguage
    {
        ...
        public Nullable<int> IDForeignLanguage { get; set; }
        public Nullable<int> IDCertificateType { get; set; }
        public string CertificateNumber { get; set; }
        public Nullable<System.DateTime> DateOfIssue { get; set; }
        public string PlaceOfIssue { get; set; }
        public Nullable<System.DateTime> DateOfExpiry { get; set; }
        public Nullable<int> IDListeningSkill { get; set; }
        public Nullable<int> IDSpeakingSkill { get; set; }
        public Nullable<int> IDReadingSkill { get; set; }
        public Nullable<int> IDWritingSkill { get; set; }
        //List 0:1
        ...
        //List 0:1
        public virtual tbl_LIST_General tbl_LIST_General3 { get; set; }
        //List 0:1
        public virtual tbl_LIST_General tbl_LIST_General4 { get; set; }
        //List 0:1
        public virtual tbl_LIST_General tbl_LIST_General5 { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_HRM_StaffForeignLanguage
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffForeignLanguage 
    {
		...
		public static IQueryable<DTO_HRM_StaffForeignLanguage> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffForeignLanguage";
            ...
            if (workBook != null)
            {
                ...
                //var LIST_General3List = BS_LIST_General.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
                //var LIST_General4List = BS_LIST_General.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
                //var LIST_General5List = BS_LIST_General.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_HRM_StaffForeignLanguage getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffForeignLanguage.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffForeignLanguage getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffForeignLanguage
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffForeignLanguage.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffForeignLanguage",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffForeignLanguage dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffForeignLanguage);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffForeignLanguage item, tbl_HRM_StaffForeignLanguage dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDForeignLanguage = item.IDForeignLanguage;							
			dbitem.IDCertificateType = item.IDCertificateType;							
			dbitem.CertificateNumber = item.CertificateNumber;							
			dbitem.DateOfIssue = item.DateOfIssue;							
			dbitem.PlaceOfIssue = item.PlaceOfIssue;							
			dbitem.DateOfExpiry = item.DateOfExpiry;							
			dbitem.IDListeningSkill = item.IDListeningSkill;							
			dbitem.IDSpeakingSkill = item.IDSpeakingSkill;							
			dbitem.IDReadingSkill = item.IDReadingSkill;							
			dbitem.IDWritingSkill = item.IDWritingSkill;        }

		public static DTO_HRM_StaffForeignLanguage post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffForeignLanguage dbitem = new tbl_HRM_StaffForeignLanguage();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffForeignLanguage.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffForeignLanguage",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffForeignLanguage();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffForeignLanguage();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffForeignLanguage.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffForeignLanguage.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffForeignLanguage.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffForeignLanguage", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffForeignLanguage",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_StaffForeignLanguage",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_StaffForeignLanguage.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_StaffForeignLanguage.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffForeignLanguage> toDTO(IQueryable<tbl_HRM_StaffForeignLanguage> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffForeignLanguage(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
				...
				IDStaff = s.IDStaff,							
				IDForeignLanguage = s.IDForeignLanguage,							
				IDCertificateType = s.IDCertificateType,							
				CertificateNumber = s.CertificateNumber,							
				DateOfIssue = s.DateOfIssue,							
				PlaceOfIssue = s.PlaceOfIssue,							
				DateOfExpiry = s.DateOfExpiry,							
				IDListeningSkill = s.IDListeningSkill,							
				IDSpeakingSkill = s.IDSpeakingSkill,							
				IDReadingSkill = s.IDReadingSkill,							
				IDWritingSkill = s.IDWritingSkill,					
			});//.OrderBy(o => o.Sort == null).ThenBy(u => u.Sort);
                              
        }

		public static DTO_HRM_StaffForeignLanguage toDTO(tbl_HRM_StaffForeignLanguage dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffForeignLanguage()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					IDForeignLanguage = dbResult.IDForeignLanguage,							
					IDCertificateType = dbResult.IDCertificateType,							
					CertificateNumber = dbResult.CertificateNumber,							
					DateOfIssue = dbResult.DateOfIssue,							
					PlaceOfIssue = dbResult.PlaceOfIssue,							
					DateOfExpiry = dbResult.DateOfExpiry,							
					IDListeningSkill = dbResult.IDListeningSkill,							
					IDSpeakingSkill = dbResult.IDSpeakingSkill,							
					IDReadingSkill = dbResult.IDReadingSkill,							
					IDWritingSkill = dbResult.IDWritingSkill,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_HRM_StaffForeignLanguage> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffForeignLanguage> query = db.tbl_HRM_StaffForeignLanguage.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
			...
			//Query IDForeignLanguage (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDForeignLanguage"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDForeignLanguage").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDForeignLanguage));
////                    query = query.Where(d => IDs.Contains(d.IDForeignLanguage));
//                    
            }

			//Query IDCertificateType (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDCertificateType"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDCertificateType").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDCertificateType));
////                    query = query.Where(d => IDs.Contains(d.IDCertificateType));
//                    
            }

			//Query CertificateNumber (string)
			if (QueryStrings.Any(d => d.Key == "CertificateNumber_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "CertificateNumber_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "CertificateNumber_eq").Value;
                query = query.Where(d=>d.CertificateNumber == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "CertificateNumber") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "CertificateNumber").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "CertificateNumber").Value;
                query = query.Where(d=>d.CertificateNumber.Contains(keyword));
            }
			...
			//Query IDListeningSkill (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDListeningSkill"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDListeningSkill").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDListeningSkill));
////                    query = query.Where(d => IDs.Contains(d.IDListeningSkill));
//                    
            }

			//Query IDSpeakingSkill (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDSpeakingSkill"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDSpeakingSkill").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDSpeakingSkill));
////                    query = query.Where(d => IDs.Contains(d.IDSpeakingSkill));
//                    
            }

			//Query IDReadingSkill (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDReadingSkill"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDReadingSkill").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDReadingSkill));
////                    query = query.Where(d => IDs.Contains(d.IDReadingSkill));
//                    
            }

			//Query IDWritingSkill (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDWritingSkill"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDWritingSkill").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDWritingSkill));
////                    query = query.Where(d => IDs.Contains(d.IDWritingSkill));
//                    
            }
            return query;
        ...
        public static IQueryable<tbl_HRM_StaffForeignLanguage> _sortBuilder(IQueryable<tbl_HRM_StaffForeignLanguage> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffForeignLanguage>;
                        ...
                        switch (item)
                        {
							...
							case "IDStaff_desc":
                                ...
                                break;
							case "IDForeignLanguage":
								query = isOrdered ? ordered.ThenBy(o => o.IDForeignLanguage) : query.OrderBy(o => o.IDForeignLanguage);
								 break;
							case "IDForeignLanguage_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDForeignLanguage) : query.OrderByDescending(o => o.IDForeignLanguage);
                                break;
							case "IDCertificateType":
								query = isOrdered ? ordered.ThenBy(o => o.IDCertificateType) : query.OrderBy(o => o.IDCertificateType);
								 break;
							case "IDCertificateType_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDCertificateType) : query.OrderByDescending(o => o.IDCertificateType);
                                break;
							case "CertificateNumber":
								query = isOrdered ? ordered.ThenBy(o => o.CertificateNumber) : query.OrderBy(o => o.CertificateNumber);
								 break;
							case "CertificateNumber_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.CertificateNumber) : query.OrderByDescending(o => o.CertificateNumber);
                                break;
							case "DateOfIssue":
							...
							case "DateOfExpiry_desc":
                                ...
                                break;
							case "IDListeningSkill":
								query = isOrdered ? ordered.ThenBy(o => o.IDListeningSkill) : query.OrderBy(o => o.IDListeningSkill);
								 break;
							case "IDListeningSkill_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDListeningSkill) : query.OrderByDescending(o => o.IDListeningSkill);
                                break;
							case "IDSpeakingSkill":
								query = isOrdered ? ordered.ThenBy(o => o.IDSpeakingSkill) : query.OrderBy(o => o.IDSpeakingSkill);
								 break;
							case "IDSpeakingSkill_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDSpeakingSkill) : query.OrderByDescending(o => o.IDSpeakingSkill);
                                break;
							case "IDReadingSkill":
								query = isOrdered ? ordered.ThenBy(o => o.IDReadingSkill) : query.OrderBy(o => o.IDReadingSkill);
								 break;
							case "IDReadingSkill_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDReadingSkill) : query.OrderByDescending(o => o.IDReadingSkill);
                                break;
							case "IDWritingSkill":
								query = isOrdered ? ordered.ThenBy(o => o.IDWritingSkill) : query.OrderBy(o => o.IDWritingSkill);
								 break;
							case "IDWritingSkill_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDWritingSkill) : query.OrderByDescending(o => o.IDWritingSkill);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_HRM_StaffForeignLanguage> _pagingBuilder(IQueryable<tbl_HRM_StaffForeignLanguage> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
