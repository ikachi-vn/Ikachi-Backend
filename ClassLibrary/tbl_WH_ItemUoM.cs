...
namespace ClassLibrary
{
    ...
    public partial class tbl_WH_ItemUoM
    {
...
{
	using System;
	public partial class DTO_WH_ItemUoM
	{
		public int Id { get; set; }
		public Nullable<int> IDItem { get; set; }
		public int IDUoM { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WH_ItemUoM 
    {
		...
		public static IQueryable<DTO_WH_ItemUoM> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WH_ItemUoM";
		...
		public static DTO_WH_ItemUoM getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WH_ItemUoM.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_WH_ItemUoM getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WH_ItemUoM
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WH_ItemUoM.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WH_ItemUoM",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WH_ItemUoM dbitem, string Username)
        {
            Type type = typeof(tbl_WH_ItemUoM);
        ...
        public static void patchDTOtoDBValue( DTO_WH_ItemUoM item, tbl_WH_ItemUoM dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WH_ItemUoM post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WH_ItemUoM dbitem = new tbl_WH_ItemUoM();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WH_ItemUoM.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WH_ItemUoM",e);
                    return null;
                }
            }
            return toDTO(dbitem);
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_WH_ItemUoM();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WH_ItemUoM.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WH_ItemUoM.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WH_ItemUoM.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_WH_ItemUoM", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WH_ItemUoM",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WH_ItemUoM",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WH_ItemUoM.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WH_ItemUoM.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WH_ItemUoM> toDTO(IQueryable<tbl_WH_ItemUoM> query)
        {
			return query
			.Select(s => new DTO_WH_ItemUoM(){							
				Id = s.Id,							
				IDItem = s.IDItem,							
				IDUoM = s.IDUoM,							
				Code = s.Code,							
		...
		public static DTO_WH_ItemUoM toDTO(tbl_WH_ItemUoM dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WH_ItemUoM()
				{							
					Id = dbResult.Id,							
		...
		public static IQueryable<tbl_WH_ItemUoM> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WH_ItemUoM> query = db.tbl_WH_ItemUoM.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
        ...
        public static IQueryable<tbl_WH_ItemUoM> _sortBuilder(IQueryable<tbl_WH_ItemUoM> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WH_ItemUoM>;
        ...
        public static IQueryable<tbl_WH_ItemUoM> _pagingBuilder(IQueryable<tbl_WH_ItemUoM> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
