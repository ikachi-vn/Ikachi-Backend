...
namespace ClassLibrary
{
    ...
    public partial class tbl_CRM_Activity
    {
...
{
	using System;
	public partial class DTO_CRM_Activity
	{
		public Nullable<int> IDLead { get; set; }
		public Nullable<int> IDOpportunity { get; set; }
		public Nullable<int> IDContact { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CRM_Activity 
    {
		...
		public static IQueryable<DTO_CRM_Activity> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS CRM_Activity";
		...
		public static DTO_CRM_Activity getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_CRM_Activity.Find(id);
		...
		public static DTO_CRM_Activity getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_CRM_Activity
        ...
        {
            bool result = false;
            var dbitem = db.tbl_CRM_Activity.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_CRM_Activity",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_CRM_Activity dbitem, string Username)
        {
            Type type = typeof(tbl_CRM_Activity);
        ...
        public static void patchDTOtoDBValue( DTO_CRM_Activity item, tbl_CRM_Activity dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_CRM_Activity post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_CRM_Activity dbitem = new tbl_CRM_Activity();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_CRM_Activity.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_CRM_Activity",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_CRM_Activity();
                    ...
                    {
                        dbitem = new tbl_CRM_Activity();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_CRM_Activity.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_CRM_Activity.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_CRM_Activity.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_CRM_Activity", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_CRM_Activity",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_CRM_Activity",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_CRM_Activity.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_CRM_Activity.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_CRM_Activity> toDTO(IQueryable<tbl_CRM_Activity> query)
        {
			return query
			.Select(s => new DTO_CRM_Activity(){							
				IDLead = s.IDLead,							
		...
		public static DTO_CRM_Activity toDTO(tbl_CRM_Activity dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CRM_Activity()
				{							
		...
		public static IQueryable<tbl_CRM_Activity> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_CRM_Activity> query = db.tbl_CRM_Activity.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_CRM_Activity> _sortBuilder(IQueryable<tbl_CRM_Activity> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_CRM_Activity>;
        ...
        public static IQueryable<tbl_CRM_Activity> _pagingBuilder(IQueryable<tbl_CRM_Activity> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
