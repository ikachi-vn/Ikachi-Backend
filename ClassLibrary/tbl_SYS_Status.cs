...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_Status
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_SYS_Status()
        {
            ...
            this.tbl_SYS_Status1 = new HashSet<tbl_SYS_Status>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbl_SYS_Status> tbl_SYS_Status1 { get; set; }
        //List 0:1
        public virtual tbl_SYS_Status tbl_SYS_Status2 { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_SYS_Status
	{
		public Nullable<int> IDParent { get; set; }
		public int Id { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_Status 
    {
		...
		public static IQueryable<DTO_SYS_Status> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_SYS_Status> allItems = db.tbl_SYS_Status.Where(d => d.IsDeleted == false).Select(s => new DTO_SYS_Status()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_SYS_Status.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_SYS_Status> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_SYS_Status> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_Status";
            ...
            if (workBook != null)
            {
                ...
                //var SYS_Status2List = BS_SYS_Status.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_SYS_Status getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_Status.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_SYS_Status getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_SYS_Status
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_Status.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_Status",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_Status dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_Status);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_Status item, tbl_SYS_Status dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IsSMS = item.IsSMS;							
			dbitem.IsEmail = item.IsEmail;							
			dbitem.IsDisabled = item.IsDisabled;							
			dbitem.IsDeleted = item.IsDeleted;        }

		public static DTO_SYS_Status post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_Status dbitem = new tbl_SYS_Status();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_Status.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_Status",e);
                    return null;
                }
            }
            return toDTO(dbitem);
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_SYS_Status();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_Status.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_Status.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_Status.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_SYS_Status", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_Status",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_Status",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_Status.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_Status.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_Status> toDTO(IQueryable<tbl_SYS_Status> query)
        {
			return query
			.Select(s => new DTO_SYS_Status(){							
				IDParent = s.IDParent,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
		...
		public static DTO_SYS_Status toDTO(tbl_SYS_Status dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_Status()
				{							
					...
					IsSMS = dbResult.IsSMS,							
					IsEmail = dbResult.IsEmail,							
		...
		public static IQueryable<tbl_SYS_Status> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_Status> query = db.tbl_SYS_Status.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
			...
			//Query IsSMS (bool)
			if (QueryStrings.Any(d => d.Key == "IsSMS"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsSMS").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsSMS);
            }

			//Query IsEmail (bool)
			if (QueryStrings.Any(d => d.Key == "IsEmail"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsEmail").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsEmail);
            }
        ...
        public static IQueryable<tbl_SYS_Status> _sortBuilder(IQueryable<tbl_SYS_Status> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_Status>;
                        ...
                        switch (item)
                        {
							...
							case "IsDefault_desc":
                                ...
                                break;
							case "IsSMS":
								query = isOrdered ? ordered.ThenBy(o => o.IsSMS) : query.OrderBy(o => o.IsSMS);
								 break;
							case "IsSMS_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsSMS) : query.OrderByDescending(o => o.IsSMS);
                                break;
							case "IsEmail":
								query = isOrdered ? ordered.ThenBy(o => o.IsEmail) : query.OrderBy(o => o.IsEmail);
								 break;
							case "IsEmail_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsEmail) : query.OrderByDescending(o => o.IsEmail);
                                break;
							case "IsDisabled":
        ...
        public static IQueryable<tbl_SYS_Status> _pagingBuilder(IQueryable<tbl_SYS_Status> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
