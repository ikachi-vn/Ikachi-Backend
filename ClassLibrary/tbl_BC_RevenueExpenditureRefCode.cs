...
namespace ClassLibrary
{
    ...
    public partial class tbl_BC_RevenueExpenditureRefCode
    {
        public int IDBranch { get; set; }
        public int IDRevenueExpenditureComponent { get; set; }
...
{
	using System;
	public partial class DTO_BC_RevenueExpenditureRefCode
	{
		public int IDBranch { get; set; }
		public int IDRevenueExpenditureComponent { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_BC_RevenueExpenditureRefCode 
    {
		...
		public static IQueryable<DTO_BC_RevenueExpenditureRefCode> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS BC_RevenueExpenditureRefCode";
		...
		public static DTO_BC_RevenueExpenditureRefCode getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_BC_RevenueExpenditureRefCode.Find(id);
		...
		public static DTO_BC_RevenueExpenditureRefCode getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_BC_RevenueExpenditureRefCode
        ...
        {
            bool result = false;
            var dbitem = db.tbl_BC_RevenueExpenditureRefCode.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_BC_RevenueExpenditureRefCode",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_BC_RevenueExpenditureRefCode dbitem, string Username)
        {
            Type type = typeof(tbl_BC_RevenueExpenditureRefCode);
        ...
        public static void patchDTOtoDBValue( DTO_BC_RevenueExpenditureRefCode item, tbl_BC_RevenueExpenditureRefCode dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDRevenueExpenditureComponent = item.IDRevenueExpenditureComponent;							
			dbitem.Code = item.Code;							
			dbitem.Sort = item.Sort;							
			dbitem.IsDisabled = item.IsDisabled;							
			dbitem.IsDeleted = item.IsDeleted;        }

		public static DTO_BC_RevenueExpenditureRefCode post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_BC_RevenueExpenditureRefCode dbitem = new tbl_BC_RevenueExpenditureRefCode();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_BC_RevenueExpenditureRefCode.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_BC_RevenueExpenditureRefCode",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_BC_RevenueExpenditureRefCode();
                    ...
                    {
                        dbitem = new tbl_BC_RevenueExpenditureRefCode();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_BC_RevenueExpenditureRefCode.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_BC_RevenueExpenditureRefCode.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_BC_RevenueExpenditureRefCode.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_BC_RevenueExpenditureRefCode", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_BC_RevenueExpenditureRefCode",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_BC_RevenueExpenditureRefCode",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_BC_RevenueExpenditureRefCode.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_BC_RevenueExpenditureRefCode.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_BC_RevenueExpenditureRefCode> toDTO(IQueryable<tbl_BC_RevenueExpenditureRefCode> query)
        {
			return query
			.Select(s => new DTO_BC_RevenueExpenditureRefCode(){							
				IDBranch = s.IDBranch,							
				IDRevenueExpenditureComponent = s.IDRevenueExpenditureComponent,							
				Id = s.Id,							
				Code = s.Code,							
				Sort = s.Sort,							
		...
		public static DTO_BC_RevenueExpenditureRefCode toDTO(tbl_BC_RevenueExpenditureRefCode dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_BC_RevenueExpenditureRefCode()
				{							
					IDBranch = dbResult.IDBranch,							
					IDRevenueExpenditureComponent = dbResult.IDRevenueExpenditureComponent,							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Sort = dbResult.Sort,							
		...
		public static IQueryable<tbl_BC_RevenueExpenditureRefCode> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_BC_RevenueExpenditureRefCode> query = db.tbl_BC_RevenueExpenditureRefCode.AsNoTracking();//.Where(d => d.IsDeleted == false);
			...
			//Query IDRevenueExpenditureComponent (int)
			if (QueryStrings.Any(d => d.Key == "IDRevenueExpenditureComponent"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDRevenueExpenditureComponent").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int> IDs = new List<int>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDRevenueExpenditureComponent));
            }
        ...
        public static IQueryable<tbl_BC_RevenueExpenditureRefCode> _sortBuilder(IQueryable<tbl_BC_RevenueExpenditureRefCode> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_BC_RevenueExpenditureRefCode>;
                        ...
                        switch (item)
                        {
							...
							case "IDBranch_desc":
                                ...
                                break;
							case "IDRevenueExpenditureComponent":
								query = isOrdered ? ordered.ThenBy(o => o.IDRevenueExpenditureComponent) : query.OrderBy(o => o.IDRevenueExpenditureComponent);
								 break;
							case "IDRevenueExpenditureComponent_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDRevenueExpenditureComponent) : query.OrderByDescending(o => o.IDRevenueExpenditureComponent);
                                break;
							case "Id":
        ...
        public static IQueryable<tbl_BC_RevenueExpenditureRefCode> _pagingBuilder(IQueryable<tbl_BC_RevenueExpenditureRefCode> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
