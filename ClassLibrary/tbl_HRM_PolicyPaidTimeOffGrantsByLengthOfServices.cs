...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices
    {
        public int IDPTO { get; set; }
        public int Id { get; set; }
        public string Code { get; set; }
        public string Name { get; set; }
        public int MonthsOfServices { get; set; }
        ...
        //List 0:1
        public virtual tbl_HRM_PolicyPaidTimeOff tbl_HRM_PolicyPaidTimeOff { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices
	{
		public int IDPTO { get; set; }
		public int Id { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_PolicyPaidTimeOffGrantsByLengthOfServices 
    {
		...
		public static IQueryable<DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_PolicyPaidTimeOffGrantsByLengthOfServices";
            ...
            if (workBook != null)
            {
                ...
                //var HRM_PolicyPaidTimeOffList = BS_HRM_PolicyPaidTimeOff.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_PolicyPaidTimeOffGrantsByLengthOfServices",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices item, tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDPTO = item.IDPTO;							
			dbitem.Code = item.Code;							
			dbitem.Name = item.Name;							
			dbitem.MonthsOfServices = item.MonthsOfServices;							
			dbitem.DaysGranted = item.DaysGranted;							
			dbitem.Remark = item.Remark;							
			dbitem.Sort = item.Sort;							
			dbitem.IsDisabled = item.IsDisabled;							
			dbitem.IsDeleted = item.IsDeleted;        }

		public static DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices dbitem = new tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_PolicyPaidTimeOffGrantsByLengthOfServices",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices();
                    ...
                    {
                        dbitem = new tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_PolicyPaidTimeOffGrantsByLengthOfServices",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_PolicyPaidTimeOffGrantsByLengthOfServices",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> toDTO(IQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> query)
        {
			return query
			.Select(s => new DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices(){							
				IDPTO = s.IDPTO,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				MonthsOfServices = s.MonthsOfServices,							
		...
		public static DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices toDTO(tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_PolicyPaidTimeOffGrantsByLengthOfServices()
				{							
					IDPTO = dbResult.IDPTO,							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					MonthsOfServices = dbResult.MonthsOfServices,							
					DaysGranted = dbResult.DaysGranted,							
		...
		public static IQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> query = db.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices.AsNoTracking();//.Where(d => d.IsDeleted == false );
			...
			//Query IDPTO (int)
			if (QueryStrings.Any(d => d.Key == "IDPTO"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDPTO").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int> IDs = new List<int>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDPTO));
            }
			...
			//Query MonthsOfServices (int)
			if (QueryStrings.Any(d => d.Key == "MonthsOfServicesFrom") && QueryStrings.Any(d => d.Key == "MonthsOfServicesTo"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "MonthsOfServicesFrom").Value, out int fromVal) && int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "MonthsOfServicesTo").Value, out int toVal))
                    query = query.Where(d => fromVal <= d.MonthsOfServices && d.MonthsOfServices <= toVal);
            
            if (QueryStrings.Any(d => d.Key == "MonthsOfServices"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "MonthsOfServices").Value, out int val))
                    query = query.Where(d => val == d.MonthsOfServices);


			//Query DaysGranted (int)
			if (QueryStrings.Any(d => d.Key == "DaysGrantedFrom") && QueryStrings.Any(d => d.Key == "DaysGrantedTo"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "DaysGrantedFrom").Value, out int fromVal) && int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "DaysGrantedTo").Value, out int toVal))
                    query = query.Where(d => fromVal <= d.DaysGranted && d.DaysGranted <= toVal);
            
            if (QueryStrings.Any(d => d.Key == "DaysGranted"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "DaysGranted").Value, out int val))
                    query = query.Where(d => val == d.DaysGranted);
        ...
        public static IQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> _sortBuilder(IQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices>;
                        bool isOrdered = ordered.ToString().IndexOf("ORDER BY") !=-1;

                        switch (item)
                        {
							case "IDPTO":
								query = isOrdered ? ordered.ThenBy(o => o.IDPTO) : query.OrderBy(o => o.IDPTO);
								 break;
							case "IDPTO_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDPTO) : query.OrderByDescending(o => o.IDPTO);
                                break;
							case "Id":
							...
							case "Name_desc":
                                ...
                                break;
							case "MonthsOfServices":
								query = isOrdered ? ordered.ThenBy(o => o.MonthsOfServices) : query.OrderBy(o => o.MonthsOfServices);
								 break;
							case "MonthsOfServices_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.MonthsOfServices) : query.OrderByDescending(o => o.MonthsOfServices);
                                break;
							case "DaysGranted":
								query = isOrdered ? ordered.ThenBy(o => o.DaysGranted) : query.OrderBy(o => o.DaysGranted);
								 break;
							case "DaysGranted_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.DaysGranted) : query.OrderByDescending(o => o.DaysGranted);
                                break;
							case "Remark":
        ...
        public static IQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> _pagingBuilder(IQueryable<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
