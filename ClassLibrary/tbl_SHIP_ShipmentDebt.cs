...
namespace ClassLibrary
{
    ...
    public partial class tbl_SHIP_ShipmentDebt
    {
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SHIP_ShipmentDebt 
    {
		...
		public static IQueryable<DTO_SHIP_ShipmentDebt> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SHIP_ShipmentDebt";
		...
		public static DTO_SHIP_ShipmentDebt getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SHIP_ShipmentDebt.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_SHIP_ShipmentDebt getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_SHIP_ShipmentDebt
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SHIP_ShipmentDebt.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SHIP_ShipmentDebt",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SHIP_ShipmentDebt dbitem, string Username)
        {
            Type type = typeof(tbl_SHIP_ShipmentDebt);
        ...
        public static void patchDTOtoDBValue( DTO_SHIP_ShipmentDebt item, tbl_SHIP_ShipmentDebt dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SHIP_ShipmentDebt post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SHIP_ShipmentDebt dbitem = new tbl_SHIP_ShipmentDebt();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SHIP_ShipmentDebt.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SHIP_ShipmentDebt",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_SHIP_ShipmentDebt();
                    ...
                    {
                        dbitem = new tbl_SHIP_ShipmentDebt();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SHIP_ShipmentDebt.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SHIP_ShipmentDebt.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SHIP_ShipmentDebt.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_SHIP_ShipmentDebt", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SHIP_ShipmentDebt",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SHIP_ShipmentDebt",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SHIP_ShipmentDebt.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SHIP_ShipmentDebt.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SHIP_ShipmentDebt> toDTO(IQueryable<tbl_SHIP_ShipmentDebt> query)
        {
			return query
			.Select(s => new DTO_SHIP_ShipmentDebt(){							
		...
		public static DTO_SHIP_ShipmentDebt toDTO(tbl_SHIP_ShipmentDebt dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SHIP_ShipmentDebt()
				{							
		...
		public static IQueryable<tbl_SHIP_ShipmentDebt> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SHIP_ShipmentDebt> query = db.tbl_SHIP_ShipmentDebt.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
        ...
        public static IQueryable<tbl_SHIP_ShipmentDebt> _sortBuilder(IQueryable<tbl_SHIP_ShipmentDebt> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SHIP_ShipmentDebt>;
        ...
        public static IQueryable<tbl_SHIP_ShipmentDebt> _pagingBuilder(IQueryable<tbl_SHIP_ShipmentDebt> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
