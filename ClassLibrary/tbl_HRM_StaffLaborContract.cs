...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffLaborContract
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_HRM_StaffLaborContract()
        {
        ...
        public bool IsAppendixContract { get; set; }
        public Nullable<int> IDParentContract { get; set; }
        public string ContractNumber { get; set; }
        public Nullable<int> IDContractType { get; set; }
        public Nullable<System.DateTime> SignDate { get; set; }
        public Nullable<System.DateTime> EffectiveDate { get; set; }
        public Nullable<System.DateTime> ExpiryDate { get; set; }
        public Nullable<int> IDContractSignedBy { get; set; }
        public Nullable<bool> IsRenewalAutomatilly { get; set; }
        public Nullable<int> NumberOfYearsRenewal { get; set; }
        public Nullable<int> IDContractTemplate { get; set; }
        public string ContentOfContract { get; set; }
        //List 0:1
        public virtual tbl_HRM_Staff tbl_HRM_Staff { get; set; }
        //List 0:1
        public virtual tbl_HRM_Staff tbl_HRM_Staff1 { get; set; }
        //List 0:1
        public virtual tbl_LIST_ContractTemplate tbl_LIST_ContractTemplate { get; set; }
        //List 0:1
        public virtual tbl_LIST_General tbl_LIST_General { get; set; }
        //List 0:1
        public virtual tbl_LIST_ContractTemplate tbl_LIST_ContractTemplate1 { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbl_HRM_StaffLaborContract> tbl_HRM_StaffLaborContract1 { get; set; }
        //List 0:1
        public virtual tbl_HRM_StaffLaborContract tbl_HRM_StaffLaborContract2 { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_HRM_StaffLaborContract
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffLaborContract 
    {
		...
		public static IQueryable<DTO_HRM_StaffLaborContract> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffLaborContract";
            ...
            if (workBook != null)
            {
                ...
                //var LIST_ContractTemplateList = BS_LIST_ContractTemplate.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
                //var LIST_GeneralList = BS_LIST_General.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
                //var LIST_ContractTemplate1List = BS_LIST_ContractTemplate.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
                //var HRM_StaffLaborContract2List = BS_HRM_StaffLaborContract.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_HRM_StaffLaborContract getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffLaborContract.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffLaborContract getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffLaborContract
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffLaborContract.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffLaborContract",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffLaborContract dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffLaborContract);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffLaborContract item, tbl_HRM_StaffLaborContract dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IsAppendixContract = item.IsAppendixContract;							
			dbitem.IDParentContract = item.IDParentContract;							
			dbitem.ContractNumber = item.ContractNumber;							
			dbitem.IDContractType = item.IDContractType;							
			dbitem.SignDate = item.SignDate;							
			dbitem.EffectiveDate = item.EffectiveDate;							
			dbitem.ExpiryDate = item.ExpiryDate;							
			dbitem.IDContractSignedBy = item.IDContractSignedBy;							
			dbitem.IsRenewalAutomatilly = item.IsRenewalAutomatilly;							
			dbitem.NumberOfYearsRenewal = item.NumberOfYearsRenewal;							
			dbitem.IDContractTemplate = item.IDContractTemplate;							
			dbitem.ContentOfContract = item.ContentOfContract;        }

		public static DTO_HRM_StaffLaborContract post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffLaborContract dbitem = new tbl_HRM_StaffLaborContract();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffLaborContract.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffLaborContract",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffLaborContract();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffLaborContract();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffLaborContract.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffLaborContract.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffLaborContract.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffLaborContract", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffLaborContract",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_StaffLaborContract",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_StaffLaborContract.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_StaffLaborContract.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffLaborContract> toDTO(IQueryable<tbl_HRM_StaffLaborContract> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffLaborContract(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
				...
				IDStaff = s.IDStaff,							
				IsAppendixContract = s.IsAppendixContract,							
				IDParentContract = s.IDParentContract,							
				ContractNumber = s.ContractNumber,							
				IDContractType = s.IDContractType,							
				SignDate = s.SignDate,							
				EffectiveDate = s.EffectiveDate,							
				ExpiryDate = s.ExpiryDate,							
				IDContractSignedBy = s.IDContractSignedBy,							
				IsRenewalAutomatilly = s.IsRenewalAutomatilly,							
				NumberOfYearsRenewal = s.NumberOfYearsRenewal,							
				IDContractTemplate = s.IDContractTemplate,							
				ContentOfContract = s.ContentOfContract,					
			});//.OrderBy(o => o.Sort == null).ThenBy(u => u.Sort);
                              
        }

		public static DTO_HRM_StaffLaborContract toDTO(tbl_HRM_StaffLaborContract dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffLaborContract()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					IsAppendixContract = dbResult.IsAppendixContract,							
					IDParentContract = dbResult.IDParentContract,							
					ContractNumber = dbResult.ContractNumber,							
					IDContractType = dbResult.IDContractType,							
					SignDate = dbResult.SignDate,							
					EffectiveDate = dbResult.EffectiveDate,							
					ExpiryDate = dbResult.ExpiryDate,							
					IDContractSignedBy = dbResult.IDContractSignedBy,							
					IsRenewalAutomatilly = dbResult.IsRenewalAutomatilly,							
					NumberOfYearsRenewal = dbResult.NumberOfYearsRenewal,							
					IDContractTemplate = dbResult.IDContractTemplate,							
					ContentOfContract = dbResult.ContentOfContract,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_HRM_StaffLaborContract> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffLaborContract> query = db.tbl_HRM_StaffLaborContract.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
			...
			//Query IsAppendixContract (bool)
			if (QueryStrings.Any(d => d.Key == "IsAppendixContract"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsAppendixContract").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsAppendixContract);
            }

			//Query IDParentContract (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDParentContract"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDParentContract").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDParentContract));
////                    query = query.Where(d => IDs.Contains(d.IDParentContract));
//                    
            }

			//Query ContractNumber (string)
			if (QueryStrings.Any(d => d.Key == "ContractNumber_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ContractNumber_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ContractNumber_eq").Value;
                query = query.Where(d=>d.ContractNumber == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "ContractNumber") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ContractNumber").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ContractNumber").Value;
                query = query.Where(d=>d.ContractNumber.Contains(keyword));
            }
            

			//Query IDContractType (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDContractType"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDContractType").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDContractType));
////                    query = query.Where(d => IDs.Contains(d.IDContractType));
//                    
            }

			//Query SignDate (Nullable<System.DateTime>)
			if (QueryStrings.Any(d => d.Key == "SignDateFrom") && QueryStrings.Any(d => d.Key == "SignDateTo"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "SignDateFrom").Value, out DateTime fromDate) && DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "SignDateTo").Value, out DateTime toDate))
                    query = query.Where(d => fromDate <= d.SignDate && d.SignDate <= toDate);

            if (QueryStrings.Any(d => d.Key == "SignDate"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "SignDate").Value, out DateTime val))
                    query = query.Where(d => d.SignDate != null && DbFunctions.TruncateTime(val) == DbFunctions.TruncateTime(d.SignDate));
			...
			//Query ExpiryDate (Nullable<System.DateTime>)
			if (QueryStrings.Any(d => d.Key == "ExpiryDateFrom") && QueryStrings.Any(d => d.Key == "ExpiryDateTo"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ExpiryDateFrom").Value, out DateTime fromDate) && DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ExpiryDateTo").Value, out DateTime toDate))
                    query = query.Where(d => fromDate <= d.ExpiryDate && d.ExpiryDate <= toDate);

            if (QueryStrings.Any(d => d.Key == "ExpiryDate"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ExpiryDate").Value, out DateTime val))
                    query = query.Where(d => d.ExpiryDate != null && DbFunctions.TruncateTime(val) == DbFunctions.TruncateTime(d.ExpiryDate));


			//Query IDContractSignedBy (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDContractSignedBy"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDContractSignedBy").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDContractSignedBy));
////                    query = query.Where(d => IDs.Contains(d.IDContractSignedBy));
//                    
            }

			//Query IsRenewalAutomatilly (Nullable<bool>)

			//Query NumberOfYearsRenewal (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "NumberOfYearsRenewalFrom") && QueryStrings.Any(d => d.Key == "NumberOfYearsRenewalTo"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfYearsRenewalFrom").Value, out int fromVal) && int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfYearsRenewalTo").Value, out int toVal))
                    query = query.Where(d => fromVal <= d.NumberOfYearsRenewal && d.NumberOfYearsRenewal <= toVal);

			//Query IDContractTemplate (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDContractTemplate"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDContractTemplate").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDContractTemplate));
////                    query = query.Where(d => IDs.Contains(d.IDContractTemplate));
//                    
            }

			//Query ContentOfContract (string)
			if (QueryStrings.Any(d => d.Key == "ContentOfContract_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ContentOfContract_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ContentOfContract_eq").Value;
                query = query.Where(d=>d.ContentOfContract == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "ContentOfContract") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ContentOfContract").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ContentOfContract").Value;
                query = query.Where(d=>d.ContentOfContract.Contains(keyword));
            }
            
            return query;
        }
		
        public static IQueryable<tbl_HRM_StaffLaborContract> _sortBuilder(IQueryable<tbl_HRM_StaffLaborContract> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffLaborContract>;
                        ...
                        switch (item)
                        {
							...
							case "IDStaff_desc":
                                ...
                                break;
							case "IsAppendixContract":
								query = isOrdered ? ordered.ThenBy(o => o.IsAppendixContract) : query.OrderBy(o => o.IsAppendixContract);
								 break;
							case "IsAppendixContract_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsAppendixContract) : query.OrderByDescending(o => o.IsAppendixContract);
                                break;
							case "IDParentContract":
								query = isOrdered ? ordered.ThenBy(o => o.IDParentContract) : query.OrderBy(o => o.IDParentContract);
								 break;
							case "IDParentContract_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDParentContract) : query.OrderByDescending(o => o.IDParentContract);
                                break;
							case "ContractNumber":
								query = isOrdered ? ordered.ThenBy(o => o.ContractNumber) : query.OrderBy(o => o.ContractNumber);
								 break;
							case "ContractNumber_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.ContractNumber) : query.OrderByDescending(o => o.ContractNumber);
                                break;
							case "IDContractType":
								query = isOrdered ? ordered.ThenBy(o => o.IDContractType) : query.OrderBy(o => o.IDContractType);
								 break;
							case "IDContractType_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDContractType) : query.OrderByDescending(o => o.IDContractType);
                                break;
							case "SignDate":
								query = isOrdered ? ordered.ThenBy(o => o.SignDate) : query.OrderBy(o => o.SignDate);
								 break;
							case "SignDate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.SignDate) : query.OrderByDescending(o => o.SignDate);
                                break;
							case "EffectiveDate":
							...
							case "EffectiveDate_desc":
                                ...
                                break;
							case "ExpiryDate":
								query = isOrdered ? ordered.ThenBy(o => o.ExpiryDate) : query.OrderBy(o => o.ExpiryDate);
								 break;
							case "ExpiryDate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.ExpiryDate) : query.OrderByDescending(o => o.ExpiryDate);
                                break;
							case "IDContractSignedBy":
								query = isOrdered ? ordered.ThenBy(o => o.IDContractSignedBy) : query.OrderBy(o => o.IDContractSignedBy);
								 break;
							case "IDContractSignedBy_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDContractSignedBy) : query.OrderByDescending(o => o.IDContractSignedBy);
                                break;
							case "IsRenewalAutomatilly":
								query = isOrdered ? ordered.ThenBy(o => o.IsRenewalAutomatilly) : query.OrderBy(o => o.IsRenewalAutomatilly);
								 break;
							case "IsRenewalAutomatilly_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsRenewalAutomatilly) : query.OrderByDescending(o => o.IsRenewalAutomatilly);
                                break;
							case "NumberOfYearsRenewal":
								query = isOrdered ? ordered.ThenBy(o => o.NumberOfYearsRenewal) : query.OrderBy(o => o.NumberOfYearsRenewal);
								 break;
							case "NumberOfYearsRenewal_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.NumberOfYearsRenewal) : query.OrderByDescending(o => o.NumberOfYearsRenewal);
                                break;
							case "IDContractTemplate":
								query = isOrdered ? ordered.ThenBy(o => o.IDContractTemplate) : query.OrderBy(o => o.IDContractTemplate);
								 break;
							case "IDContractTemplate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDContractTemplate) : query.OrderByDescending(o => o.IDContractTemplate);
                                break;
							case "ContentOfContract":
								query = isOrdered ? ordered.ThenBy(o => o.ContentOfContract) : query.OrderBy(o => o.ContentOfContract);
								 break;
							case "ContentOfContract_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.ContentOfContract) : query.OrderByDescending(o => o.ContentOfContract);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_HRM_StaffLaborContract> _pagingBuilder(IQueryable<tbl_HRM_StaffLaborContract> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
