...
namespace ClassLibrary
{
    ...
    public partial class tbl_WMS_Lot
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_WMS_Lot()
        {
            this.tbl_WMS_AdjustmentDetail = new HashSet<tbl_WMS_AdjustmentDetail>();
            this.tbl_WMS_LotAttribute = new HashSet<tbl_WMS_LotAttribute>();
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbl_WMS_LotAttribute> tbl_WMS_LotAttribute { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
...
{
	using System;
	public partial class DTO_WMS_Lot
	{
		public int IDBranch { get; set; }
		public int IDStorer { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WMS_Lot 
    {
		...
		public static IQueryable<DTO_WMS_Lot> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WMS_Lot";
		...
		public static DTO_WMS_Lot getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WMS_Lot.Find(id);
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WMS_Lot.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WMS_Lot",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WMS_Lot dbitem, string Username)
        {
            Type type = typeof(tbl_WMS_Lot);
        ...
        public static void patchDTOtoDBValue( DTO_WMS_Lot item, tbl_WMS_Lot dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WMS_Lot post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WMS_Lot dbitem = new tbl_WMS_Lot();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WMS_Lot.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WMS_Lot",e);
                    return null;
                }
            }
            return toDTO(dbitem);
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_WMS_Lot();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WMS_Lot.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WMS_Lot.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WMS_Lot.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WMS_Lot", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WMS_Lot",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WMS_Lot",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WMS_Lot.Any(e => e.Id == id && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WMS_Lot> toDTO(IQueryable<tbl_WMS_Lot> query)
        {
			return query
			.Select(s => new DTO_WMS_Lot(){							
				IDBranch = s.IDBranch,							
				IDStorer = s.IDStorer,							
				Id = s.Id,							
				Name = s.Name,							
		...
		public static DTO_WMS_Lot toDTO(tbl_WMS_Lot dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WMS_Lot()
				{							
		...
		public static IQueryable<tbl_WMS_Lot> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WMS_Lot> query = db.tbl_WMS_Lot.AsNoTracking();//.Where(d => d.IsDeleted == false);
        ...
        public static IQueryable<tbl_WMS_Lot> _sortBuilder(IQueryable<tbl_WMS_Lot> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WMS_Lot>;
        ...
        public static IQueryable<tbl_WMS_Lot> _pagingBuilder(IQueryable<tbl_WMS_Lot> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
