...
namespace ClassLibrary
{
    ...
    public partial class tbl_WMS_PriceListDetail
    {
...
{
	using System;
	public partial class DTO_WMS_PriceListDetail
	{
		public int IDPriceList { get; set; }
		public int IDItem { get; set; }
		public int IDItemUoM { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WMS_PriceListDetail 
    {
		...
		public static IQueryable<DTO_WMS_PriceListDetail> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WMS_PriceListDetail";
		...
		public static DTO_WMS_PriceListDetail getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WMS_PriceListDetail.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_WMS_PriceListDetail getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WMS_PriceListDetail
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WMS_PriceListDetail.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WMS_PriceListDetail",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WMS_PriceListDetail dbitem, string Username)
        {
            Type type = typeof(tbl_WMS_PriceListDetail);
        ...
        public static void patchDTOtoDBValue( DTO_WMS_PriceListDetail item, tbl_WMS_PriceListDetail dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WMS_PriceListDetail post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WMS_PriceListDetail dbitem = new tbl_WMS_PriceListDetail();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WMS_PriceListDetail();
                    ...
                    {
                        dbitem = db.tbl_WMS_PriceListDetail.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WMS_PriceListDetail.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WMS_PriceListDetail.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_WMS_PriceListDetail", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WMS_PriceListDetail",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WMS_PriceListDetail",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WMS_PriceListDetail.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WMS_PriceListDetail.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WMS_PriceListDetail> toDTO(IQueryable<tbl_WMS_PriceListDetail> query)
        {
			return query
			.Select(s => new DTO_WMS_PriceListDetail(){							
		...
		public static DTO_WMS_PriceListDetail toDTO(tbl_WMS_PriceListDetail dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WMS_PriceListDetail()
				{							
		...
		public static IQueryable<tbl_WMS_PriceListDetail> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WMS_PriceListDetail> query = db.tbl_WMS_PriceListDetail.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_WMS_PriceListDetail> _sortBuilder(IQueryable<tbl_WMS_PriceListDetail> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WMS_PriceListDetail>;
        ...
        public static IQueryable<tbl_WMS_PriceListDetail> _pagingBuilder(IQueryable<tbl_WMS_PriceListDetail> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
