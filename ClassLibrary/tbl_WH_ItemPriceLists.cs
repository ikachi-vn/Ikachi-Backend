...
namespace ClassLibrary
{
    ...
    public partial class tbl_WH_ItemPriceLists
    {
...
{
	using System;
	public partial class DTO_WH_ItemPriceLists
	{
		public int Id { get; set; }
		public int IDPriceList { get; set; }
		public int IDItem { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WH_ItemPriceLists 
    {
		...
		public static IQueryable<DTO_WH_ItemPriceLists> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WH_ItemPriceLists";
		...
		public static DTO_WH_ItemPriceLists getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WH_ItemPriceLists.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_WH_ItemPriceLists getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WH_ItemPriceLists
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WH_ItemPriceLists.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WH_ItemPriceLists",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WH_ItemPriceLists dbitem, string Username)
        {
            Type type = typeof(tbl_WH_ItemPriceLists);
        ...
        public static void patchDTOtoDBValue( DTO_WH_ItemPriceLists item, tbl_WH_ItemPriceLists dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WH_ItemPriceLists post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WH_ItemPriceLists dbitem = new tbl_WH_ItemPriceLists();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WH_ItemPriceLists.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WH_ItemPriceLists",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WH_ItemPriceLists();
                    ...
                    {
                        dbitem = new tbl_WH_ItemPriceLists();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WH_ItemPriceLists.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WH_ItemPriceLists.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WH_ItemPriceLists.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_WH_ItemPriceLists", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WH_ItemPriceLists",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WH_ItemPriceLists",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WH_ItemPriceLists.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WH_ItemPriceLists.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WH_ItemPriceLists> toDTO(IQueryable<tbl_WH_ItemPriceLists> query)
        {
			return query
			.Select(s => new DTO_WH_ItemPriceLists(){							
				Id = s.Id,							
		...
		public static DTO_WH_ItemPriceLists toDTO(tbl_WH_ItemPriceLists dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WH_ItemPriceLists()
				{							
					Id = dbResult.Id,							
		...
		public static IQueryable<tbl_WH_ItemPriceLists> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WH_ItemPriceLists> query = db.tbl_WH_ItemPriceLists.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_WH_ItemPriceLists> _sortBuilder(IQueryable<tbl_WH_ItemPriceLists> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WH_ItemPriceLists>;
        ...
        public static IQueryable<tbl_WH_ItemPriceLists> _pagingBuilder(IQueryable<tbl_WH_ItemPriceLists> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
