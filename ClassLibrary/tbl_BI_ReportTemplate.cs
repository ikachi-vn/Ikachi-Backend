...
namespace ClassLibrary
{
    ...
    public partial class tbl_BI_ReportTemplate
    {
...
{
	using System;
	public partial class DTO_BI_ReportTemplate
	{
		public int Id { get; set; }
		public string Type { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_BI_ReportTemplate 
    {
		...
		public static IQueryable<DTO_BI_ReportTemplate> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS BI_ReportTemplate";
		...
		public static DTO_BI_ReportTemplate getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_BI_ReportTemplate.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_BI_ReportTemplate getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_BI_ReportTemplate
        ...
        {
            bool result = false;
            var dbitem = db.tbl_BI_ReportTemplate.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_BI_ReportTemplate",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_BI_ReportTemplate dbitem, string Username)
        {
            Type type = typeof(tbl_BI_ReportTemplate);
        ...
        public static void patchDTOtoDBValue( DTO_BI_ReportTemplate item, tbl_BI_ReportTemplate dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_BI_ReportTemplate post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_BI_ReportTemplate dbitem = new tbl_BI_ReportTemplate();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_BI_ReportTemplate.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_BI_ReportTemplate",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_BI_ReportTemplate();
                    ...
                    {
                        dbitem = new tbl_BI_ReportTemplate();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_BI_ReportTemplate.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_BI_ReportTemplate.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_BI_ReportTemplate.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_BI_ReportTemplate", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_BI_ReportTemplate",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_BI_ReportTemplate",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_BI_ReportTemplate.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_BI_ReportTemplate.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_BI_ReportTemplate> toDTO(IQueryable<tbl_BI_ReportTemplate> query)
        {
			return query
			.Select(s => new DTO_BI_ReportTemplate(){							
				Id = s.Id,							
				Type = s.Type,							
				Code = s.Code,							
				Name = s.Name,							
		...
		public static DTO_BI_ReportTemplate toDTO(tbl_BI_ReportTemplate dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_BI_ReportTemplate()
				{							
					Id = dbResult.Id,							
					Type = dbResult.Type,							
					Code = dbResult.Code,							
		...
		public static IQueryable<tbl_BI_ReportTemplate> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_BI_ReportTemplate> query = db.tbl_BI_ReportTemplate.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_BI_ReportTemplate> _sortBuilder(IQueryable<tbl_BI_ReportTemplate> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_BI_ReportTemplate>;
        ...
        public static IQueryable<tbl_BI_ReportTemplate> _pagingBuilder(IQueryable<tbl_BI_ReportTemplate> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
