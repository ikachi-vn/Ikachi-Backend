...
namespace ClassLibrary
{
    ...
    public partial class tbl_WMS_LicencePlateNumber
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_WMS_LicencePlateNumber()
        {
        ...
        public Nullable<int> IDReceipPalletization { get; set; }
        ...
        //List 0:1
        public virtual tbl_WMS_ReceiptPalletization tbl_WMS_ReceiptPalletization { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
...
{
	using System;
	public partial class DTO_WMS_LicencePlateNumber
	{
		public int IDBranch { get; set; }
		public int IDStorer { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WMS_LicencePlateNumber 
    {
		...
		public static IQueryable<DTO_WMS_LicencePlateNumber> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WMS_LicencePlateNumber";
		...
		public static DTO_WMS_LicencePlateNumber getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WMS_LicencePlateNumber.Find(id);
		...
		public static DTO_WMS_LicencePlateNumber getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WMS_LicencePlateNumber
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WMS_LicencePlateNumber.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WMS_LicencePlateNumber",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WMS_LicencePlateNumber dbitem, string Username)
        {
            Type type = typeof(tbl_WMS_LicencePlateNumber);
        ...
        public static void patchDTOtoDBValue( DTO_WMS_LicencePlateNumber item, tbl_WMS_LicencePlateNumber dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDReceipPalletization = item.IDReceipPalletization;        }

		public static DTO_WMS_LicencePlateNumber post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WMS_LicencePlateNumber dbitem = new tbl_WMS_LicencePlateNumber();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WMS_LicencePlateNumber.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WMS_LicencePlateNumber",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WMS_LicencePlateNumber();
                    ...
                    {
                        dbitem = new tbl_WMS_LicencePlateNumber();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WMS_LicencePlateNumber.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WMS_LicencePlateNumber.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WMS_LicencePlateNumber.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WMS_LicencePlateNumber", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WMS_LicencePlateNumber",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WMS_LicencePlateNumber",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WMS_LicencePlateNumber.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WMS_LicencePlateNumber.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WMS_LicencePlateNumber> toDTO(IQueryable<tbl_WMS_LicencePlateNumber> query)
        {
			return query
			.Select(s => new DTO_WMS_LicencePlateNumber(){							
				IDBranch = s.IDBranch,							
				IDStorer = s.IDStorer,							
				Id = s.Id,							
				IDItem = s.IDItem,							
				...
				Code = s.Code,							
				IDReceipPalletization = s.IDReceipPalletization,					
			});//;
                              
        }

		public static DTO_WMS_LicencePlateNumber toDTO(tbl_WMS_LicencePlateNumber dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WMS_LicencePlateNumber()
				{							
					...
					Code = dbResult.Code,							
					IDReceipPalletization = dbResult.IDReceipPalletization,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_WMS_LicencePlateNumber> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WMS_LicencePlateNumber> query = db.tbl_WMS_LicencePlateNumber.AsNoTracking();//.Where(d => d.IsDeleted == false);
			...
			//Query IDReceipPalletization (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDReceipPalletization"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDReceipPalletization").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDReceipPalletization));
////                    query = query.Where(d => IDs.Contains(d.IDReceipPalletization));
//                    
            }
            return query;
        ...
        public static IQueryable<tbl_WMS_LicencePlateNumber> _sortBuilder(IQueryable<tbl_WMS_LicencePlateNumber> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WMS_LicencePlateNumber>;
                        ...
                        switch (item)
                        {
							...
							case "Code_desc":
                                ...
                                break;
							case "IDReceipPalletization":
								query = isOrdered ? ordered.ThenBy(o => o.IDReceipPalletization) : query.OrderBy(o => o.IDReceipPalletization);
								 break;
							case "IDReceipPalletization_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDReceipPalletization) : query.OrderByDescending(o => o.IDReceipPalletization);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_WMS_LicencePlateNumber> _pagingBuilder(IQueryable<tbl_WMS_LicencePlateNumber> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
