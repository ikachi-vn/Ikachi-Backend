...
namespace BaseBusiness
{
    ...
    public static partial class BS_WEB_Tag 
    {
		...
		public static IQueryable<DTO_WEB_Tag> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WEB_Tag";
		...
		public static DTO_WEB_Tag getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
		...
		public static DTO_WEB_Tag getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WEB_Tag dbitem, string Username)
        {
            Type type = typeof(tbl_WEB_Tag);
        ...
        public static void patchDTOtoDBValue( DTO_WEB_Tag item, tbl_WEB_Tag dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WEB_Tag post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_WEB_Tag();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WEB_Tag.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WEB_Tag.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WEB_Tag.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_WEB_Tag", updateDate, Username);
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WEB_Tag",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WEB_Tag.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WEB_Tag.Any(e => e.Code == Code && e.IsDeleted == false);
		...
		public static IQueryable<tbl_WEB_Tag> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WEB_Tag> query = db.tbl_WEB_Tag.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_WEB_Tag> _sortBuilder(IQueryable<tbl_WEB_Tag> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WEB_Tag>;
        ...
        public static IQueryable<tbl_WEB_Tag> _pagingBuilder(IQueryable<tbl_WEB_Tag> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
