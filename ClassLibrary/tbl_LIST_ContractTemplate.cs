...
namespace ClassLibrary
{
    ...
    public partial class tbl_LIST_ContractTemplate
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_LIST_ContractTemplate()
        {
...
{
	using System;
	public partial class DTO_LIST_ContractTemplate
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_LIST_ContractTemplate 
    {
		...
		public static IQueryable<DTO_LIST_ContractTemplate> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS LIST_ContractTemplate";
		...
		public static DTO_LIST_ContractTemplate getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_LIST_ContractTemplate.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_LIST_ContractTemplate getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_LIST_ContractTemplate
        ...
        {
            bool result = false;
            var dbitem = db.tbl_LIST_ContractTemplate.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_LIST_ContractTemplate",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_LIST_ContractTemplate dbitem, string Username)
        {
            Type type = typeof(tbl_LIST_ContractTemplate);
        ...
        public static void patchDTOtoDBValue( DTO_LIST_ContractTemplate item, tbl_LIST_ContractTemplate dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_LIST_ContractTemplate post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_LIST_ContractTemplate dbitem = new tbl_LIST_ContractTemplate();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_LIST_ContractTemplate.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_LIST_ContractTemplate",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_LIST_ContractTemplate();
                    ...
                    {
                        dbitem = new tbl_LIST_ContractTemplate();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_LIST_ContractTemplate.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_LIST_ContractTemplate.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_LIST_ContractTemplate.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_LIST_ContractTemplate", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_LIST_ContractTemplate",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_LIST_ContractTemplate",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_LIST_ContractTemplate.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_LIST_ContractTemplate.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_LIST_ContractTemplate> toDTO(IQueryable<tbl_LIST_ContractTemplate> query)
        {
			return query
			.Select(s => new DTO_LIST_ContractTemplate(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
		...
		public static DTO_LIST_ContractTemplate toDTO(tbl_LIST_ContractTemplate dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_LIST_ContractTemplate()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
		...
		public static IQueryable<tbl_LIST_ContractTemplate> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_LIST_ContractTemplate> query = db.tbl_LIST_ContractTemplate.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_LIST_ContractTemplate> _sortBuilder(IQueryable<tbl_LIST_ContractTemplate> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_LIST_ContractTemplate>;
        ...
        public static IQueryable<tbl_LIST_ContractTemplate> _pagingBuilder(IQueryable<tbl_LIST_ContractTemplate> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
