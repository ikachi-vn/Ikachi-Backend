...
namespace ClassLibrary
{
    ...
    public partial class tbl_BC_RevenueExpenditureComponent
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_BC_RevenueExpenditureComponent()
        {
            this.tbl_BC_RevenueExpenditureComponent1 = new HashSet<tbl_BC_RevenueExpenditureComponent>();
        }
        ...
        public bool IsDividedByWeeks { get; set; }
        public Nullable<int> IDAccount { get; set; }
        public string AccountCode { get; set; }
        public string CostCenter { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbl_BC_RevenueExpenditureComponent> tbl_BC_RevenueExpenditureComponent1 { get; set; }
        //List 0:1
        public virtual tbl_BC_RevenueExpenditureComponent tbl_BC_RevenueExpenditureComponent2 { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_BC_RevenueExpenditureComponent
	{
		public Nullable<int> IDParent { get; set; }
		public Nullable<int> IDBranch { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_BC_RevenueExpenditureComponent 
    {
		...
		public static IQueryable<DTO_BC_RevenueExpenditureComponent> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_BC_RevenueExpenditureComponent> allItems = db.tbl_BC_RevenueExpenditureComponent.Where(d => d.IsDeleted == false).Select(s => new DTO_BC_RevenueExpenditureComponent()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_BC_RevenueExpenditureComponent.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_BC_RevenueExpenditureComponent> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_BC_RevenueExpenditureComponent> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS BC_RevenueExpenditureComponent";
            ...
            if (workBook != null)
            {
                ...
                //var BC_RevenueExpenditureComponent2List = BS_BC_RevenueExpenditureComponent.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_BC_RevenueExpenditureComponent getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_BC_RevenueExpenditureComponent.Find(id);
		...
		public static DTO_BC_RevenueExpenditureComponent getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_BC_RevenueExpenditureComponent
        ...
        {
            bool result = false;
            var dbitem = db.tbl_BC_RevenueExpenditureComponent.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_BC_RevenueExpenditureComponent",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_BC_RevenueExpenditureComponent dbitem, string Username)
        {
            Type type = typeof(tbl_BC_RevenueExpenditureComponent);
        ...
        public static void patchDTOtoDBValue( DTO_BC_RevenueExpenditureComponent item, tbl_BC_RevenueExpenditureComponent dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IsRevenue = item.IsRevenue;							
			dbitem.Type = item.Type;							
			dbitem.IsDividedByWeeks = item.IsDividedByWeeks;							
			dbitem.IDAccount = item.IDAccount;							
			dbitem.AccountCode = item.AccountCode;							
			dbitem.CostCenter = item.CostCenter;        }

		public static DTO_BC_RevenueExpenditureComponent post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_BC_RevenueExpenditureComponent dbitem = new tbl_BC_RevenueExpenditureComponent();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_BC_RevenueExpenditureComponent.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_BC_RevenueExpenditureComponent",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_BC_RevenueExpenditureComponent();
                    ...
                    {
                        dbitem = new tbl_BC_RevenueExpenditureComponent();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_BC_RevenueExpenditureComponent.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_BC_RevenueExpenditureComponent.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_BC_RevenueExpenditureComponent.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_BC_RevenueExpenditureComponent", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_BC_RevenueExpenditureComponent",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_BC_RevenueExpenditureComponent",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_BC_RevenueExpenditureComponent.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_BC_RevenueExpenditureComponent.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_BC_RevenueExpenditureComponent> toDTO(IQueryable<tbl_BC_RevenueExpenditureComponent> query)
        {
			return query
			.Select(s => new DTO_BC_RevenueExpenditureComponent(){							
				IDParent = s.IDParent,							
				IDBranch = s.IDBranch,							
				Id = s.Id,							
				Code = s.Code,							
				...
				Type = s.Type,							
				IsDividedByWeeks = s.IsDividedByWeeks,							
		...
		public static DTO_BC_RevenueExpenditureComponent toDTO(tbl_BC_RevenueExpenditureComponent dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_BC_RevenueExpenditureComponent()
				{							
					...
					IsRevenue = dbResult.IsRevenue,							
					Type = dbResult.Type,							
					IsDividedByWeeks = dbResult.IsDividedByWeeks,							
		...
		public static IQueryable<tbl_BC_RevenueExpenditureComponent> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_BC_RevenueExpenditureComponent> query = db.tbl_BC_RevenueExpenditureComponent.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
			...
			//Query IsRevenue (bool)
			if (QueryStrings.Any(d => d.Key == "IsRevenue"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsRevenue").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsRevenue);
            }
			...
			//Query IsDividedByWeeks (bool)
			if (QueryStrings.Any(d => d.Key == "IsDividedByWeeks"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsDividedByWeeks").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsDividedByWeeks);
            }
...
//                    
			...
			//Query CostCenter (string)
			if (QueryStrings.Any(d => d.Key == "CostCenter_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "CostCenter_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "CostCenter_eq").Value;
                query = query.Where(d=>d.CostCenter == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "CostCenter") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "CostCenter").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "CostCenter").Value;
                query = query.Where(d=>d.CostCenter.Contains(keyword));
            }
            
            return query;
        }
		
        public static IQueryable<tbl_BC_RevenueExpenditureComponent> _sortBuilder(IQueryable<tbl_BC_RevenueExpenditureComponent> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_BC_RevenueExpenditureComponent>;
                        ...
                        switch (item)
                        {
							...
							case "ModifiedDate_desc":
                                ...
                                break;
							case "IsRevenue":
								query = isOrdered ? ordered.ThenBy(o => o.IsRevenue) : query.OrderBy(o => o.IsRevenue);
								 break;
							case "IsRevenue_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsRevenue) : query.OrderByDescending(o => o.IsRevenue);
                                break;
							case "Type":
							...
							case "Type_desc":
                                ...
                                break;
							case "IsDividedByWeeks":
								query = isOrdered ? ordered.ThenBy(o => o.IsDividedByWeeks) : query.OrderBy(o => o.IsDividedByWeeks);
								 break;
							case "IsDividedByWeeks_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsDividedByWeeks) : query.OrderByDescending(o => o.IsDividedByWeeks);
                                break;
							case "IDAccount":
							...
							case "AccountCode_desc":
                                ...
                                break;
							case "CostCenter":
								query = isOrdered ? ordered.ThenBy(o => o.CostCenter) : query.OrderBy(o => o.CostCenter);
								 break;
							case "CostCenter_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.CostCenter) : query.OrderByDescending(o => o.CostCenter);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_BC_RevenueExpenditureComponent> _pagingBuilder(IQueryable<tbl_BC_RevenueExpenditureComponent> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
