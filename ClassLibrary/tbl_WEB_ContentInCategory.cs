...
namespace ClassLibrary
{
    ...
    public partial class tbl_WEB_ContentInCategory
    {
...
{
	using System;
	public partial class DTO_WEB_ContentInCategory
	{
		public int IDDanhMuc { get; set; }
		public int IDBaiViet { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WEB_ContentInCategory 
    {
		...
		public static IQueryable<DTO_WEB_ContentInCategory> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WEB_ContentInCategory";
		...
		public static DTO_WEB_ContentInCategory getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WEB_ContentInCategory.Find(id);
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WEB_ContentInCategory.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WEB_ContentInCategory",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WEB_ContentInCategory dbitem, string Username)
        {
            Type type = typeof(tbl_WEB_ContentInCategory);
        ...
        public static void patchDTOtoDBValue( DTO_WEB_ContentInCategory item, tbl_WEB_ContentInCategory dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WEB_ContentInCategory post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WEB_ContentInCategory dbitem = new tbl_WEB_ContentInCategory();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WEB_ContentInCategory.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WEB_ContentInCategory",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WEB_ContentInCategory();
                    ...
                    {
                        dbitem = new tbl_WEB_ContentInCategory();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WEB_ContentInCategory.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WEB_ContentInCategory.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WEB_ContentInCategory.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_WEB_ContentInCategory", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WEB_ContentInCategory",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WEB_ContentInCategory",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WEB_ContentInCategory.Any(e => e.Id == id && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WEB_ContentInCategory> toDTO(IQueryable<tbl_WEB_ContentInCategory> query)
        {
			return query
			.Select(s => new DTO_WEB_ContentInCategory(){							
		...
		public static DTO_WEB_ContentInCategory toDTO(tbl_WEB_ContentInCategory dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WEB_ContentInCategory()
				{							
		...
		public static IQueryable<tbl_WEB_ContentInCategory> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WEB_ContentInCategory> query = db.tbl_WEB_ContentInCategory.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_WEB_ContentInCategory> _sortBuilder(IQueryable<tbl_WEB_ContentInCategory> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WEB_ContentInCategory>;
                        ...
                        switch (item)
                        {
							...
							case "IDDanhMuc_desc":
                                ...
                                break;
							case "IDBaiViet":
								query = isOrdered ? ordered.ThenBy(o => o.IDBaiViet) : query.OrderBy(o => o.IDBaiViet);
								 break;
							case "IDBaiViet_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDBaiViet) : query.OrderByDescending(o => o.IDBaiViet);
                                break;
							case "Id":
        ...
        public static IQueryable<tbl_WEB_ContentInCategory> _pagingBuilder(IQueryable<tbl_WEB_ContentInCategory> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
