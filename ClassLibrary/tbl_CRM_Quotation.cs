...
namespace ClassLibrary
{
    ...
    public partial class tbl_CRM_Quotation
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_CRM_Quotation()
        {
...
{
	using System;
	public partial class DTO_CRM_Quotation
	{
		public Nullable<int> IDContact { get; set; }
		public Nullable<int> IDOpportunity { get; set; }
		public int IDBranch { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CRM_Quotation 
    {
		...
		public static IQueryable<DTO_CRM_Quotation> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS CRM_Quotation";
		...
		public static DTO_CRM_Quotation getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_CRM_Quotation.Find(id);
		...
		public static DTO_CRM_Quotation getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_CRM_Quotation
        ...
        {
            bool result = false;
            var dbitem = db.tbl_CRM_Quotation.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_CRM_Quotation",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_CRM_Quotation dbitem, string Username)
        {
            Type type = typeof(tbl_CRM_Quotation);
        ...
        public static void patchDTOtoDBValue( DTO_CRM_Quotation item, tbl_CRM_Quotation dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_CRM_Quotation post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_CRM_Quotation dbitem = new tbl_CRM_Quotation();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_CRM_Quotation.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_CRM_Quotation",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_CRM_Quotation();
                    ...
                    {
                        dbitem = new tbl_CRM_Quotation();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_CRM_Quotation.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_CRM_Quotation.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_CRM_Quotation.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_CRM_Quotation", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_CRM_Quotation",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_CRM_Quotation",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_CRM_Quotation.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_CRM_Quotation.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_CRM_Quotation> toDTO(IQueryable<tbl_CRM_Quotation> query)
        {
			return query
			.Select(s => new DTO_CRM_Quotation(){							
		...
		public static DTO_CRM_Quotation toDTO(tbl_CRM_Quotation dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CRM_Quotation()
				{							
		...
		public static IQueryable<tbl_CRM_Quotation> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_CRM_Quotation> query = db.tbl_CRM_Quotation.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_CRM_Quotation> _sortBuilder(IQueryable<tbl_CRM_Quotation> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_CRM_Quotation>;
        ...
        public static IQueryable<tbl_CRM_Quotation> _pagingBuilder(IQueryable<tbl_CRM_Quotation> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
