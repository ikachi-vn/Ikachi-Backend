...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffAcademicLevel
    {
        ...
        public Nullable<int> IDAcademicLevel { get; set; }
        public Nullable<int> IDAcademicRank { get; set; }
...
{
	using System;
	public partial class DTO_HRM_StaffAcademicLevel
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffAcademicLevel 
    {
		...
		public static IQueryable<DTO_HRM_StaffAcademicLevel> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffAcademicLevel";
		...
		public static DTO_HRM_StaffAcademicLevel getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffAcademicLevel.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffAcademicLevel getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffAcademicLevel
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffAcademicLevel.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffAcademicLevel",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffAcademicLevel dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffAcademicLevel);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffAcademicLevel item, tbl_HRM_StaffAcademicLevel dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDAcademicLevel = item.IDAcademicLevel;							
			dbitem.IDAcademicRank = item.IDAcademicRank;							
			dbitem.IDDegree = item.IDDegree;							
			dbitem.IsDeleted = item.IsDeleted;        }

		public static DTO_HRM_StaffAcademicLevel post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffAcademicLevel dbitem = new tbl_HRM_StaffAcademicLevel();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffAcademicLevel.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffAcademicLevel",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffAcademicLevel();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffAcademicLevel();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffAcademicLevel.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffAcademicLevel.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffAcademicLevel.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffAcademicLevel", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffAcademicLevel",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_StaffAcademicLevel.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_StaffAcademicLevel.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffAcademicLevel> toDTO(IQueryable<tbl_HRM_StaffAcademicLevel> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffAcademicLevel(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
				...
				IDAcademicLevel = s.IDAcademicLevel,							
				IDAcademicRank = s.IDAcademicRank,							
				IDDegree = s.IDDegree,							
		...
		public static DTO_HRM_StaffAcademicLevel toDTO(tbl_HRM_StaffAcademicLevel dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffAcademicLevel()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					IDAcademicLevel = dbResult.IDAcademicLevel,							
					IDAcademicRank = dbResult.IDAcademicRank,							
					IDDegree = dbResult.IDDegree,							
		...
		public static IQueryable<tbl_HRM_StaffAcademicLevel> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffAcademicLevel> query = db.tbl_HRM_StaffAcademicLevel.AsNoTracking();//.Where(d => d.IsDeleted == false );
			...
			//Query IDAcademicLevel (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDAcademicLevel"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDAcademicLevel").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDAcademicLevel));
////                    query = query.Where(d => IDs.Contains(d.IDAcademicLevel));
//                    
            }

			//Query IDAcademicRank (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDAcademicRank"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDAcademicRank").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDAcademicRank));
////                    query = query.Where(d => IDs.Contains(d.IDAcademicRank));
//                    
            }

			//Query IDDegree (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDDegree"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDDegree").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDDegree));
////                    query = query.Where(d => IDs.Contains(d.IDDegree));
//                    
            }
        ...
        public static IQueryable<tbl_HRM_StaffAcademicLevel> _sortBuilder(IQueryable<tbl_HRM_StaffAcademicLevel> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffAcademicLevel>;
                        ...
                        switch (item)
                        {
							...
							case "ModifiedDate_desc":
                                ...
                                break;
							case "IDAcademicLevel":
								query = isOrdered ? ordered.ThenBy(o => o.IDAcademicLevel) : query.OrderBy(o => o.IDAcademicLevel);
								 break;
							case "IDAcademicLevel_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDAcademicLevel) : query.OrderByDescending(o => o.IDAcademicLevel);
                                break;
							case "IDAcademicRank":
								query = isOrdered ? ordered.ThenBy(o => o.IDAcademicRank) : query.OrderBy(o => o.IDAcademicRank);
								 break;
							case "IDAcademicRank_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDAcademicRank) : query.OrderByDescending(o => o.IDAcademicRank);
                                break;
							case "IDDegree":
								query = isOrdered ? ordered.ThenBy(o => o.IDDegree) : query.OrderBy(o => o.IDDegree);
								 break;
							case "IDDegree_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDDegree) : query.OrderByDescending(o => o.IDDegree);
                                break;
							case "IsDeleted":
        ...
        public static IQueryable<tbl_HRM_StaffAcademicLevel> _pagingBuilder(IQueryable<tbl_HRM_StaffAcademicLevel> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
