...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_PersonalIncomePaymentProcess
    {
        ...
        public Nullable<int> IDMainBranch { get; set; }
        public Nullable<decimal> PISalary { get; set; }
        public Nullable<decimal> PIAnotherIncome { get; set; }
        public Nullable<decimal> TotalInsuranceAmountPaidByEm { get; set; }
        public Nullable<decimal> TaxableIncome { get; set; }
        public Nullable<decimal> FamilyCircumtanceDeductions { get; set; }
...
{
	using System;
	public partial class DTO_HRM_PersonalIncomePaymentProcess
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_PersonalIncomePaymentProcess 
    {
		...
		public static IQueryable<DTO_HRM_PersonalIncomePaymentProcess> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_PersonalIncomePaymentProcess";
		...
		public static DTO_HRM_PersonalIncomePaymentProcess getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_PersonalIncomePaymentProcess.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_PersonalIncomePaymentProcess getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_PersonalIncomePaymentProcess
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_PersonalIncomePaymentProcess.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_PersonalIncomePaymentProcess",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_PersonalIncomePaymentProcess dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_PersonalIncomePaymentProcess);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_PersonalIncomePaymentProcess item, tbl_HRM_PersonalIncomePaymentProcess dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDMainBranch = item.IDMainBranch;							
			dbitem.PISalary = item.PISalary;							
			dbitem.PIAnotherIncome = item.PIAnotherIncome;							
			dbitem.TotalInsuranceAmountPaidByEm = item.TotalInsuranceAmountPaidByEm;							
			dbitem.TaxableIncome = item.TaxableIncome;							
			dbitem.FamilyCircumtanceDeductions = item.FamilyCircumtanceDeductions;							
			dbitem.AssessableIncome = item.AssessableIncome;							
			dbitem.PersonalIncomeTax = item.PersonalIncomeTax;        }

		public static DTO_HRM_PersonalIncomePaymentProcess post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_PersonalIncomePaymentProcess dbitem = new tbl_HRM_PersonalIncomePaymentProcess();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_PersonalIncomePaymentProcess.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_PersonalIncomePaymentProcess",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_PersonalIncomePaymentProcess();
                    ...
                    {
                        dbitem = new tbl_HRM_PersonalIncomePaymentProcess();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_PersonalIncomePaymentProcess.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_PersonalIncomePaymentProcess.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_PersonalIncomePaymentProcess.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_PersonalIncomePaymentProcess", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_PersonalIncomePaymentProcess",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_PersonalIncomePaymentProcess",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_PersonalIncomePaymentProcess.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_PersonalIncomePaymentProcess.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_PersonalIncomePaymentProcess> toDTO(IQueryable<tbl_HRM_PersonalIncomePaymentProcess> query)
        {
			return query
			.Select(s => new DTO_HRM_PersonalIncomePaymentProcess(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
				...
				IDMainBranch = s.IDMainBranch,							
				PISalary = s.PISalary,							
				PIAnotherIncome = s.PIAnotherIncome,							
				TotalInsuranceAmountPaidByEm = s.TotalInsuranceAmountPaidByEm,							
				TaxableIncome = s.TaxableIncome,							
				FamilyCircumtanceDeductions = s.FamilyCircumtanceDeductions,							
				AssessableIncome = s.AssessableIncome,							
				PersonalIncomeTax = s.PersonalIncomeTax,					
			});//.OrderBy(o => o.Sort == null).ThenBy(u => u.Sort);
                              
        }

		public static DTO_HRM_PersonalIncomePaymentProcess toDTO(tbl_HRM_PersonalIncomePaymentProcess dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_PersonalIncomePaymentProcess()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					IDMainBranch = dbResult.IDMainBranch,							
					PISalary = dbResult.PISalary,							
					PIAnotherIncome = dbResult.PIAnotherIncome,							
					TotalInsuranceAmountPaidByEm = dbResult.TotalInsuranceAmountPaidByEm,							
					TaxableIncome = dbResult.TaxableIncome,							
					FamilyCircumtanceDeductions = dbResult.FamilyCircumtanceDeductions,							
					AssessableIncome = dbResult.AssessableIncome,							
					PersonalIncomeTax = dbResult.PersonalIncomeTax,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_HRM_PersonalIncomePaymentProcess> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_PersonalIncomePaymentProcess> query = db.tbl_HRM_PersonalIncomePaymentProcess.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
			...
			//Query IDMainBranch (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDMainBranch"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDMainBranch").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDMainBranch));
////                    query = query.Where(d => IDs.Contains(d.IDMainBranch));
//                    
            }
			...
			//Query PIAnotherIncome (Nullable<decimal>)
			if (QueryStrings.Any(d => d.Key == "PIAnotherIncomeFrom") && QueryStrings.Any(d => d.Key == "PIAnotherIncomeTo"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "PIAnotherIncomeFrom").Value, out decimal fromVal) && decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "PIAnotherIncomeTo").Value, out decimal toVal))
                    query = query.Where(d => fromVal <= d.PIAnotherIncome && d.PIAnotherIncome <= toVal);

			//Query TotalInsuranceAmountPaidByEm (Nullable<decimal>)
			if (QueryStrings.Any(d => d.Key == "TotalInsuranceAmountPaidByEmFrom") && QueryStrings.Any(d => d.Key == "TotalInsuranceAmountPaidByEmTo"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "TotalInsuranceAmountPaidByEmFrom").Value, out decimal fromVal) && decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "TotalInsuranceAmountPaidByEmTo").Value, out decimal toVal))
                    query = query.Where(d => fromVal <= d.TotalInsuranceAmountPaidByEm && d.TotalInsuranceAmountPaidByEm <= toVal);

			//Query TaxableIncome (Nullable<decimal>)
			if (QueryStrings.Any(d => d.Key == "TaxableIncomeFrom") && QueryStrings.Any(d => d.Key == "TaxableIncomeTo"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "TaxableIncomeFrom").Value, out decimal fromVal) && decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "TaxableIncomeTo").Value, out decimal toVal))
                    query = query.Where(d => fromVal <= d.TaxableIncome && d.TaxableIncome <= toVal);

			//Query FamilyCircumtanceDeductions (Nullable<decimal>)
			if (QueryStrings.Any(d => d.Key == "FamilyCircumtanceDeductionsFrom") && QueryStrings.Any(d => d.Key == "FamilyCircumtanceDeductionsTo"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "FamilyCircumtanceDeductionsFrom").Value, out decimal fromVal) && decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "FamilyCircumtanceDeductionsTo").Value, out decimal toVal))
                    query = query.Where(d => fromVal <= d.FamilyCircumtanceDeductions && d.FamilyCircumtanceDeductions <= toVal);

			//Query AssessableIncome (Nullable<decimal>)
			if (QueryStrings.Any(d => d.Key == "AssessableIncomeFrom") && QueryStrings.Any(d => d.Key == "AssessableIncomeTo"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "AssessableIncomeFrom").Value, out decimal fromVal) && decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "AssessableIncomeTo").Value, out decimal toVal))
                    query = query.Where(d => fromVal <= d.AssessableIncome && d.AssessableIncome <= toVal);

			//Query PersonalIncomeTax (Nullable<decimal>)
			if (QueryStrings.Any(d => d.Key == "PersonalIncomeTaxFrom") && QueryStrings.Any(d => d.Key == "PersonalIncomeTaxTo"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "PersonalIncomeTaxFrom").Value, out decimal fromVal) && decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "PersonalIncomeTaxTo").Value, out decimal toVal))
                    query = query.Where(d => fromVal <= d.PersonalIncomeTax && d.PersonalIncomeTax <= toVal);
            return query;
        }
		
        public static IQueryable<tbl_HRM_PersonalIncomePaymentProcess> _sortBuilder(IQueryable<tbl_HRM_PersonalIncomePaymentProcess> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_PersonalIncomePaymentProcess>;
                        ...
                        switch (item)
                        {
							...
							case "IDMainJobTitle_desc":
                                ...
                                break;
							case "IDMainBranch":
								query = isOrdered ? ordered.ThenBy(o => o.IDMainBranch) : query.OrderBy(o => o.IDMainBranch);
								 break;
							case "IDMainBranch_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDMainBranch) : query.OrderByDescending(o => o.IDMainBranch);
                                break;
							case "PISalary":
							...
							case "PISalary_desc":
                                ...
                                break;
							case "PIAnotherIncome":
								query = isOrdered ? ordered.ThenBy(o => o.PIAnotherIncome) : query.OrderBy(o => o.PIAnotherIncome);
								 break;
							case "PIAnotherIncome_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.PIAnotherIncome) : query.OrderByDescending(o => o.PIAnotherIncome);
                                break;
							case "TotalInsuranceAmountPaidByEm":
								query = isOrdered ? ordered.ThenBy(o => o.TotalInsuranceAmountPaidByEm) : query.OrderBy(o => o.TotalInsuranceAmountPaidByEm);
								 break;
							case "TotalInsuranceAmountPaidByEm_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.TotalInsuranceAmountPaidByEm) : query.OrderByDescending(o => o.TotalInsuranceAmountPaidByEm);
                                break;
							case "TaxableIncome":
								query = isOrdered ? ordered.ThenBy(o => o.TaxableIncome) : query.OrderBy(o => o.TaxableIncome);
								 break;
							case "TaxableIncome_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.TaxableIncome) : query.OrderByDescending(o => o.TaxableIncome);
                                break;
							case "FamilyCircumtanceDeductions":
								query = isOrdered ? ordered.ThenBy(o => o.FamilyCircumtanceDeductions) : query.OrderBy(o => o.FamilyCircumtanceDeductions);
								 break;
							case "FamilyCircumtanceDeductions_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.FamilyCircumtanceDeductions) : query.OrderByDescending(o => o.FamilyCircumtanceDeductions);
                                break;
							case "AssessableIncome":
								query = isOrdered ? ordered.ThenBy(o => o.AssessableIncome) : query.OrderBy(o => o.AssessableIncome);
								 break;
							case "AssessableIncome_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.AssessableIncome) : query.OrderByDescending(o => o.AssessableIncome);
                                break;
							case "PersonalIncomeTax":
								query = isOrdered ? ordered.ThenBy(o => o.PersonalIncomeTax) : query.OrderBy(o => o.PersonalIncomeTax);
								 break;
							case "PersonalIncomeTax_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.PersonalIncomeTax) : query.OrderByDescending(o => o.PersonalIncomeTax);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_HRM_PersonalIncomePaymentProcess> _pagingBuilder(IQueryable<tbl_HRM_PersonalIncomePaymentProcess> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
