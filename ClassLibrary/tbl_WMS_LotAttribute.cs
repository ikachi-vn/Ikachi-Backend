...
namespace ClassLibrary
{
    ...
    public partial class tbl_WMS_LotAttribute
    {
...
{
	using System;
	public partial class DTO_WMS_LotAttribute
	{
		public int IDBranch { get; set; }
		public int IDLot { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WMS_LotAttribute 
    {
		...
		public static IQueryable<DTO_WMS_LotAttribute> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WMS_LotAttribute";
            ...
            if (workBook != null)
            {
                ...
                //var WMS_LotList = BS_WMS_Lot.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_WMS_LotAttribute getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WMS_LotAttribute.Find(id);
		...
		public static DTO_WMS_LotAttribute getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WMS_LotAttribute
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WMS_LotAttribute.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WMS_LotAttribute",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WMS_LotAttribute dbitem, string Username)
        {
            Type type = typeof(tbl_WMS_LotAttribute);
        ...
        public static void patchDTOtoDBValue( DTO_WMS_LotAttribute item, tbl_WMS_LotAttribute dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WMS_LotAttribute post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WMS_LotAttribute dbitem = new tbl_WMS_LotAttribute();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WMS_LotAttribute.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WMS_LotAttribute",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WMS_LotAttribute();
                    ...
                    {
                        dbitem = new tbl_WMS_LotAttribute();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WMS_LotAttribute.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WMS_LotAttribute.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WMS_LotAttribute.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WMS_LotAttribute", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WMS_LotAttribute",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WMS_LotAttribute",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WMS_LotAttribute.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WMS_LotAttribute.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WMS_LotAttribute> toDTO(IQueryable<tbl_WMS_LotAttribute> query)
        {
			return query
			.Select(s => new DTO_WMS_LotAttribute(){							
				IDBranch = s.IDBranch,							
				IDLot = s.IDLot,							
				Id = s.Id,							
				Code = s.Code,							
		...
		public static DTO_WMS_LotAttribute toDTO(tbl_WMS_LotAttribute dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WMS_LotAttribute()
				{							
		...
		public static IQueryable<tbl_WMS_LotAttribute> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WMS_LotAttribute> query = db.tbl_WMS_LotAttribute.AsNoTracking();//.Where(d => d.IsDeleted == false);
        ...
        public static IQueryable<tbl_WMS_LotAttribute> _sortBuilder(IQueryable<tbl_WMS_LotAttribute> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WMS_LotAttribute>;
        ...
        public static IQueryable<tbl_WMS_LotAttribute> _pagingBuilder(IQueryable<tbl_WMS_LotAttribute> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
