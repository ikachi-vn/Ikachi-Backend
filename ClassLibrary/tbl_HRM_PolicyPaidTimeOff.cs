...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_PolicyPaidTimeOff
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_HRM_PolicyPaidTimeOff()
        {
            this.tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices = new HashSet<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices>();
        }
        ...
        public int NumberOfCarryOnDays { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices> tbl_HRM_PolicyPaidTimeOffGrantsByLengthOfServices { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_HRM_PolicyPaidTimeOff
	{
		public int IDBranch { get; set; }
		public int Id { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_PolicyPaidTimeOff 
    {
		...
		public static IQueryable<DTO_HRM_PolicyPaidTimeOff> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_PolicyPaidTimeOff";
		...
		public static DTO_HRM_PolicyPaidTimeOff getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_PolicyPaidTimeOff.Find(id);
		...
		public static DTO_HRM_PolicyPaidTimeOff getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_PolicyPaidTimeOff
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_PolicyPaidTimeOff.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_PolicyPaidTimeOff",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_PolicyPaidTimeOff dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_PolicyPaidTimeOff);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_PolicyPaidTimeOff item, tbl_HRM_PolicyPaidTimeOff dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.NumberOfDays = item.NumberOfDays;							
			dbitem.NumberOfCarryOnDays = item.NumberOfCarryOnDays;        }

		public static DTO_HRM_PolicyPaidTimeOff post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_PolicyPaidTimeOff dbitem = new tbl_HRM_PolicyPaidTimeOff();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_PolicyPaidTimeOff.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_PolicyPaidTimeOff",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_PolicyPaidTimeOff();
                    ...
                    {
                        dbitem = new tbl_HRM_PolicyPaidTimeOff();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_PolicyPaidTimeOff.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_PolicyPaidTimeOff.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_PolicyPaidTimeOff.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_HRM_PolicyPaidTimeOff", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_PolicyPaidTimeOff",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_PolicyPaidTimeOff",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_PolicyPaidTimeOff.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_PolicyPaidTimeOff.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_PolicyPaidTimeOff> toDTO(IQueryable<tbl_HRM_PolicyPaidTimeOff> query)
        {
			return query
			.Select(s => new DTO_HRM_PolicyPaidTimeOff(){							
				IDBranch = s.IDBranch,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				...
				NumberOfCarryOnDays = s.NumberOfCarryOnDays,					
			});//.OrderBy(o => o.Sort == null).ThenBy(u => u.Sort);
                              
        }

		public static DTO_HRM_PolicyPaidTimeOff toDTO(tbl_HRM_PolicyPaidTimeOff dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_PolicyPaidTimeOff()
				{							
					...
					Type = dbResult.Type,							
					NumberOfDays = dbResult.NumberOfDays,							
					NumberOfCarryOnDays = dbResult.NumberOfCarryOnDays,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_HRM_PolicyPaidTimeOff> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_PolicyPaidTimeOff> query = db.tbl_HRM_PolicyPaidTimeOff.AsNoTracking();//.Where(d => d.IsDeleted == false);
			...
			//Query NumberOfDays (int)
			if (QueryStrings.Any(d => d.Key == "NumberOfDaysFrom") && QueryStrings.Any(d => d.Key == "NumberOfDaysTo"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfDaysFrom").Value, out int fromVal) && int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfDaysTo").Value, out int toVal))
                    query = query.Where(d => fromVal <= d.NumberOfDays && d.NumberOfDays <= toVal);
            
            if (QueryStrings.Any(d => d.Key == "NumberOfDays"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfDays").Value, out int val))
                    query = query.Where(d => val == d.NumberOfDays);


			//Query NumberOfCarryOnDays (int)
			if (QueryStrings.Any(d => d.Key == "NumberOfCarryOnDaysFrom") && QueryStrings.Any(d => d.Key == "NumberOfCarryOnDaysTo"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfCarryOnDaysFrom").Value, out int fromVal) && int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfCarryOnDaysTo").Value, out int toVal))
                    query = query.Where(d => fromVal <= d.NumberOfCarryOnDays && d.NumberOfCarryOnDays <= toVal);
            
            if (QueryStrings.Any(d => d.Key == "NumberOfCarryOnDays"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "NumberOfCarryOnDays").Value, out int val))
                    query = query.Where(d => val == d.NumberOfCarryOnDays);

            return query;
        }
		
        public static IQueryable<tbl_HRM_PolicyPaidTimeOff> _sortBuilder(IQueryable<tbl_HRM_PolicyPaidTimeOff> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_PolicyPaidTimeOff>;
                        ...
                        switch (item)
                        {
							...
							case "Type_desc":
                                ...
                                break;
							case "NumberOfDays":
								query = isOrdered ? ordered.ThenBy(o => o.NumberOfDays) : query.OrderBy(o => o.NumberOfDays);
								 break;
							case "NumberOfDays_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.NumberOfDays) : query.OrderByDescending(o => o.NumberOfDays);
                                break;
							case "NumberOfCarryOnDays":
								query = isOrdered ? ordered.ThenBy(o => o.NumberOfCarryOnDays) : query.OrderBy(o => o.NumberOfCarryOnDays);
								 break;
							case "NumberOfCarryOnDays_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.NumberOfCarryOnDays) : query.OrderByDescending(o => o.NumberOfCarryOnDays);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_HRM_PolicyPaidTimeOff> _pagingBuilder(IQueryable<tbl_HRM_PolicyPaidTimeOff> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
