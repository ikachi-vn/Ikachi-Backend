...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_Type
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_SYS_Type()
        {
            this.tbl_SYS_Type1 = new HashSet<tbl_SYS_Type>();
        }
        ...
        public virtual ICollection<tbl_SYS_Type> tbl_SYS_Type1 { get; set; }
        //List 0:1
        public virtual tbl_SYS_Type tbl_SYS_Type2 { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_SYS_Type
	{
		public Nullable<int> IDPartner { get; set; }
		public Nullable<int> IDParent { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_Type 
    {
		...
		public static IQueryable<DTO_SYS_Type> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_SYS_Type> allItems = db.tbl_SYS_Type.Where(d => d.IsDeleted == false).Select(s => new DTO_SYS_Type()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_SYS_Type.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_SYS_Type> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_SYS_Type> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_Type";
            ...
            if (workBook != null)
            {
                ...
                //var SYS_Type2List = BS_SYS_Type.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_SYS_Type getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_Type.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_SYS_Type getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_SYS_Type
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_Type.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_Type",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_Type dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_Type);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_Type item, tbl_SYS_Type dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SYS_Type post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_Type dbitem = new tbl_SYS_Type();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_Type.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_Type",e);
                    return null;
                }
            }
            return toDTO(dbitem);
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_SYS_Type();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_Type.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_Type.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_Type.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_SYS_Type", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_Type",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_Type",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_Type.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_Type.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_Type> toDTO(IQueryable<tbl_SYS_Type> query)
        {
			return query
			.Select(s => new DTO_SYS_Type(){							
		...
		public static DTO_SYS_Type toDTO(tbl_SYS_Type dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_Type()
				{							
		...
		public static IQueryable<tbl_SYS_Type> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_Type> query = db.tbl_SYS_Type.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
        ...
        public static IQueryable<tbl_SYS_Type> _sortBuilder(IQueryable<tbl_SYS_Type> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_Type>;
        ...
        public static IQueryable<tbl_SYS_Type> _pagingBuilder(IQueryable<tbl_SYS_Type> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
