...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffConcurrentPosition
    {
...
{
	using System;
	public partial class DTO_HRM_StaffConcurrentPosition
	{
		public int IDStaff { get; set; }
		public int Id { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffConcurrentPosition 
    {
		...
		public static IQueryable<DTO_HRM_StaffConcurrentPosition> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffConcurrentPosition";
		...
		public static DTO_HRM_StaffConcurrentPosition getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffConcurrentPosition.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffConcurrentPosition getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffConcurrentPosition
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffConcurrentPosition.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffConcurrentPosition",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffConcurrentPosition dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffConcurrentPosition);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffConcurrentPosition item, tbl_HRM_StaffConcurrentPosition dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_HRM_StaffConcurrentPosition post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffConcurrentPosition dbitem = new tbl_HRM_StaffConcurrentPosition();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffConcurrentPosition.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffConcurrentPosition",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffConcurrentPosition();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffConcurrentPosition();
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffConcurrentPosition.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffConcurrentPosition.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffConcurrentPosition.Where(d => IDs.Contains(d.Id));
            ...
            foreach (var dbitem in dbitems)
            {
				...
				db.tbl_HRM_StaffConcurrentPosition.Remove(dbitem);
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffConcurrentPosition", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffConcurrentPosition",e);
                result = false;
            }
		...
		{
            			return db.tbl_HRM_StaffConcurrentPosition.Any(e => e.Id == id);
            
		}
		
		public static bool check_Exists(AppEntities db, string Code)
		{
            			return db.tbl_HRM_StaffConcurrentPosition.Any(e => e.Code == Code);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffConcurrentPosition> toDTO(IQueryable<tbl_HRM_StaffConcurrentPosition> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffConcurrentPosition(){							
				IDStaff = s.IDStaff,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
		...
		public static DTO_HRM_StaffConcurrentPosition toDTO(tbl_HRM_StaffConcurrentPosition dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffConcurrentPosition()
				{							
		...
		public static IQueryable<tbl_HRM_StaffConcurrentPosition> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffConcurrentPosition> query = db.tbl_HRM_StaffConcurrentPosition.AsNoTracking();//;
...
//                    
        ...
        public static IQueryable<tbl_HRM_StaffConcurrentPosition> _sortBuilder(IQueryable<tbl_HRM_StaffConcurrentPosition> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffConcurrentPosition>;
        ...
        public static IQueryable<tbl_HRM_StaffConcurrentPosition> _pagingBuilder(IQueryable<tbl_HRM_StaffConcurrentPosition> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
