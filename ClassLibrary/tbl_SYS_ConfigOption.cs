...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_ConfigOption
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_SYS_ConfigOption()
        {
            this.tbl_SYS_ConfigOption1 = new HashSet<tbl_SYS_ConfigOption>();
        }
        ...
        public Nullable<int> UDFListID { get; set; }
        ...
        public virtual ICollection<tbl_SYS_ConfigOption> tbl_SYS_ConfigOption1 { get; set; }
        //List 0:1
        public virtual tbl_SYS_ConfigOption tbl_SYS_ConfigOption2 { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_SYS_ConfigOption
	{
		public Nullable<int> IDParent { get; set; }
		public int Id { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_ConfigOption 
    {
		...
		public static IQueryable<DTO_SYS_ConfigOption> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_SYS_ConfigOption> allItems = db.tbl_SYS_ConfigOption.Where(d => d.IsDeleted == false).Select(s => new DTO_SYS_ConfigOption()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_SYS_ConfigOption.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_SYS_ConfigOption> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_SYS_ConfigOption> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_ConfigOption";
            ...
            if (workBook != null)
            {
                ...
                //var SYS_ConfigOption2List = BS_SYS_ConfigOption.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_SYS_ConfigOption getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_ConfigOption.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_SYS_ConfigOption getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_SYS_ConfigOption
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_ConfigOption.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_ConfigOption",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_ConfigOption dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_ConfigOption);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_ConfigOption item, tbl_SYS_ConfigOption dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.SelectOptions = item.SelectOptions;							
			dbitem.Formula = item.Formula;							
			dbitem.UDFListID = item.UDFListID;							
			dbitem.IsRequired = item.IsRequired;							
			dbitem.IsHidden = item.IsHidden;							
			dbitem.HiddenFormula = item.HiddenFormula;							
			dbitem.IsValidated = item.IsValidated;							
			dbitem.ValidatePattern = item.ValidatePattern;							
			dbitem.ValidateMessage = item.ValidateMessage;							
			dbitem.Sort = item.Sort;							
			dbitem.IsDisabled = item.IsDisabled;							
			dbitem.IsDeleted = item.IsDeleted;        }

		public static DTO_SYS_ConfigOption post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_ConfigOption dbitem = new tbl_SYS_ConfigOption();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_ConfigOption.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_ConfigOption",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_SYS_ConfigOption();
                    ...
                    {
                        dbitem = new tbl_SYS_ConfigOption();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_ConfigOption.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_ConfigOption.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_ConfigOption.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_SYS_ConfigOption", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_ConfigOption",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_ConfigOption",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_ConfigOption.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_ConfigOption.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_ConfigOption> toDTO(IQueryable<tbl_SYS_ConfigOption> query)
        {
			return query
			.Select(s => new DTO_SYS_ConfigOption(){							
				IDParent = s.IDParent,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				...
				Formula = s.Formula,							
				UDFListID = s.UDFListID,							
				IsRequired = s.IsRequired,							
				IsHidden = s.IsHidden,							
				HiddenFormula = s.HiddenFormula,							
				IsValidated = s.IsValidated,							
				ValidatePattern = s.ValidatePattern,							
				ValidateMessage = s.ValidateMessage,							
				Sort = s.Sort,							
		...
		public static DTO_SYS_ConfigOption toDTO(tbl_SYS_ConfigOption dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_ConfigOption()
				{							
					...
					DataType = dbResult.DataType,							
					DefaultValue = dbResult.DefaultValue,							
					SelectOptions = dbResult.SelectOptions,							
					Formula = dbResult.Formula,							
					UDFListID = dbResult.UDFListID,							
					IsRequired = dbResult.IsRequired,							
					IsHidden = dbResult.IsHidden,							
					HiddenFormula = dbResult.HiddenFormula,							
					IsValidated = dbResult.IsValidated,							
					ValidatePattern = dbResult.ValidatePattern,							
					ValidateMessage = dbResult.ValidateMessage,							
					Sort = dbResult.Sort,							
		...
		public static IQueryable<tbl_SYS_ConfigOption> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_ConfigOption> query = db.tbl_SYS_ConfigOption.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
			...
			if (QueryStrings.Any(d => d.Key == "DataType_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "DataType_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "DataType_eq").Value;
                query = query.Where(d=>d.DataType == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "DataType") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "DataType").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "DataType").Value;
                query = query.Where(d=>d.DataType.Contains(keyword));
            }
            

			//Query DefaultValue (string)
			if (QueryStrings.Any(d => d.Key == "DefaultValue_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "DefaultValue_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "DefaultValue_eq").Value;
                query = query.Where(d=>d.DefaultValue == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "DefaultValue") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "DefaultValue").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "DefaultValue").Value;
                query = query.Where(d=>d.DefaultValue.Contains(keyword));
            }
            

			//Query SelectOptions (string)
			if (QueryStrings.Any(d => d.Key == "SelectOptions_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "SelectOptions_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "SelectOptions_eq").Value;
                query = query.Where(d=>d.SelectOptions == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "SelectOptions") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "SelectOptions").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "SelectOptions").Value;
                query = query.Where(d=>d.SelectOptions.Contains(keyword));
            }
            

			//Query Formula (string)
			if (QueryStrings.Any(d => d.Key == "Formula_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Formula_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Formula_eq").Value;
                query = query.Where(d=>d.Formula == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "Formula") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Formula").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Formula").Value;
                query = query.Where(d=>d.Formula.Contains(keyword));
            }
            

			//Query UDFListID (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "UDFListID"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "UDFListID").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.UDFListID));
////                    query = query.Where(d => IDs.Contains(d.UDFListID));
//                    
            }

			//Query IsRequired (bool)
			if (QueryStrings.Any(d => d.Key == "IsRequired"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsRequired").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsRequired);
            }

			//Query IsHidden (bool)
			if (QueryStrings.Any(d => d.Key == "IsHidden"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsHidden").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsHidden);
            }

			//Query HiddenFormula (bool)
			if (QueryStrings.Any(d => d.Key == "HiddenFormula"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "HiddenFormula").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.HiddenFormula);
            }

			//Query IsValidated (bool)
			if (QueryStrings.Any(d => d.Key == "IsValidated"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsValidated").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsValidated);
            }

			//Query ValidatePattern (string)
			if (QueryStrings.Any(d => d.Key == "ValidatePattern_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ValidatePattern_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ValidatePattern_eq").Value;
                query = query.Where(d=>d.ValidatePattern == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "ValidatePattern") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ValidatePattern").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ValidatePattern").Value;
                query = query.Where(d=>d.ValidatePattern.Contains(keyword));
            }
            

			//Query ValidateMessage (string)
			if (QueryStrings.Any(d => d.Key == "ValidateMessage_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ValidateMessage_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ValidateMessage_eq").Value;
                query = query.Where(d=>d.ValidateMessage == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "ValidateMessage") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "ValidateMessage").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "ValidateMessage").Value;
                query = query.Where(d=>d.ValidateMessage.Contains(keyword));
            }
        ...
        public static IQueryable<tbl_SYS_ConfigOption> _sortBuilder(IQueryable<tbl_SYS_ConfigOption> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_ConfigOption>;
                        ...
                        switch (item)
                        {
							...
							case "Remark_desc":
                                ...
                                break;
							case "DataType":
								query = isOrdered ? ordered.ThenBy(o => o.DataType) : query.OrderBy(o => o.DataType);
								 break;
							case "DataType_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.DataType) : query.OrderByDescending(o => o.DataType);
                                break;
							case "DefaultValue":
								query = isOrdered ? ordered.ThenBy(o => o.DefaultValue) : query.OrderBy(o => o.DefaultValue);
								 break;
							case "DefaultValue_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.DefaultValue) : query.OrderByDescending(o => o.DefaultValue);
                                break;
							case "SelectOptions":
								query = isOrdered ? ordered.ThenBy(o => o.SelectOptions) : query.OrderBy(o => o.SelectOptions);
								 break;
							case "SelectOptions_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.SelectOptions) : query.OrderByDescending(o => o.SelectOptions);
                                break;
							case "Formula":
								query = isOrdered ? ordered.ThenBy(o => o.Formula) : query.OrderBy(o => o.Formula);
								 break;
							case "Formula_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.Formula) : query.OrderByDescending(o => o.Formula);
                                break;
							case "UDFListID":
								query = isOrdered ? ordered.ThenBy(o => o.UDFListID) : query.OrderBy(o => o.UDFListID);
								 break;
							case "UDFListID_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.UDFListID) : query.OrderByDescending(o => o.UDFListID);
                                break;
							case "IsRequired":
								query = isOrdered ? ordered.ThenBy(o => o.IsRequired) : query.OrderBy(o => o.IsRequired);
								 break;
							case "IsRequired_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsRequired) : query.OrderByDescending(o => o.IsRequired);
                                break;
							case "IsHidden":
								query = isOrdered ? ordered.ThenBy(o => o.IsHidden) : query.OrderBy(o => o.IsHidden);
								 break;
							case "IsHidden_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsHidden) : query.OrderByDescending(o => o.IsHidden);
                                break;
							case "HiddenFormula":
								query = isOrdered ? ordered.ThenBy(o => o.HiddenFormula) : query.OrderBy(o => o.HiddenFormula);
								 break;
							case "HiddenFormula_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.HiddenFormula) : query.OrderByDescending(o => o.HiddenFormula);
                                break;
							case "IsValidated":
								query = isOrdered ? ordered.ThenBy(o => o.IsValidated) : query.OrderBy(o => o.IsValidated);
								 break;
							case "IsValidated_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsValidated) : query.OrderByDescending(o => o.IsValidated);
                                break;
							case "ValidatePattern":
								query = isOrdered ? ordered.ThenBy(o => o.ValidatePattern) : query.OrderBy(o => o.ValidatePattern);
								 break;
							case "ValidatePattern_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.ValidatePattern) : query.OrderByDescending(o => o.ValidatePattern);
                                break;
							case "ValidateMessage":
								query = isOrdered ? ordered.ThenBy(o => o.ValidateMessage) : query.OrderBy(o => o.ValidateMessage);
								 break;
							case "ValidateMessage_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.ValidateMessage) : query.OrderByDescending(o => o.ValidateMessage);
                                break;
							case "Sort":
        ...
        public static IQueryable<tbl_SYS_ConfigOption> _pagingBuilder(IQueryable<tbl_SYS_ConfigOption> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
