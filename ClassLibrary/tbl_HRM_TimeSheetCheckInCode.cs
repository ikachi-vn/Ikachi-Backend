...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_TimeSheetCheckInCode
    {
...
{
	using System;
	public partial class DTO_HRM_TimeSheetCheckInCode
	{
		public int IDOffice { get; set; }
		public int IDStaff { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_TimeSheetCheckInCode 
    {
		...
		public static IQueryable<DTO_HRM_TimeSheetCheckInCode> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_TimeSheetCheckInCode";
		...
		public static DTO_HRM_TimeSheetCheckInCode getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_TimeSheetCheckInCode.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_TimeSheetCheckInCode getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_TimeSheetCheckInCode
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_TimeSheetCheckInCode.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_TimeSheetCheckInCode",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_TimeSheetCheckInCode dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_TimeSheetCheckInCode);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_TimeSheetCheckInCode item, tbl_HRM_TimeSheetCheckInCode dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_HRM_TimeSheetCheckInCode post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_TimeSheetCheckInCode dbitem = new tbl_HRM_TimeSheetCheckInCode();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_TimeSheetCheckInCode.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_TimeSheetCheckInCode",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_TimeSheetCheckInCode();
                    ...
                    {
                        dbitem = new tbl_HRM_TimeSheetCheckInCode();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_TimeSheetCheckInCode.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_TimeSheetCheckInCode.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_TimeSheetCheckInCode.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_TimeSheetCheckInCode", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_TimeSheetCheckInCode",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_TimeSheetCheckInCode",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_TimeSheetCheckInCode.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_TimeSheetCheckInCode.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_TimeSheetCheckInCode> toDTO(IQueryable<tbl_HRM_TimeSheetCheckInCode> query)
        {
			return query
			.Select(s => new DTO_HRM_TimeSheetCheckInCode(){							
				IDOffice = s.IDOffice,							
				IDStaff = s.IDStaff,							
				Id = s.Id,							
				Code = s.Code,							
		...
		public static DTO_HRM_TimeSheetCheckInCode toDTO(tbl_HRM_TimeSheetCheckInCode dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_TimeSheetCheckInCode()
				{							
		...
		public static IQueryable<tbl_HRM_TimeSheetCheckInCode> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_TimeSheetCheckInCode> query = db.tbl_HRM_TimeSheetCheckInCode.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_HRM_TimeSheetCheckInCode> _sortBuilder(IQueryable<tbl_HRM_TimeSheetCheckInCode> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_TimeSheetCheckInCode>;
        ...
        public static IQueryable<tbl_HRM_TimeSheetCheckInCode> _pagingBuilder(IQueryable<tbl_HRM_TimeSheetCheckInCode> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
