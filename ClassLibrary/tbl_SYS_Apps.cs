...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_Apps 
    {
		...
		public static IQueryable<DTO_SYS_Apps> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_Apps";
		...
		public static DTO_SYS_Apps getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
		...
		public static DTO_SYS_Apps getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_Apps dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_Apps);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_Apps item, tbl_SYS_Apps dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SYS_Apps post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_SYS_Apps();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_Apps.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_Apps.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_Apps.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_SYS_Apps", updateDate, Username);
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_Apps",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_Apps.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_Apps.Any(e => e.Code == Code && e.IsDeleted == false);
		...
		public static IQueryable<tbl_SYS_Apps> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_Apps> query = db.tbl_SYS_Apps.AsNoTracking();//.Where(d => d.IsDeleted == false );
			...
			if (QueryStrings.Any(d => d.Key == "AppSecret_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "AppSecret_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "AppSecret_eq").Value;
            ...
            if (QueryStrings.Any(d => d.Key == "AppSecret") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "AppSecret").Value))
            {
                ...
                query = query.Where(d=>d.AppSecret.Contains(keyword));
            }
			...
			if (QueryStrings.Any(d => d.Key == "AppColor_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "AppColor_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "AppColor_eq").Value;
            ...
            if (QueryStrings.Any(d => d.Key == "AppColor") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "AppColor").Value))
            {
                ...
                query = query.Where(d=>d.AppColor.Contains(keyword));
            }
            
            return query;
        }
		
        public static IQueryable<tbl_SYS_Apps> _sortBuilder(IQueryable<tbl_SYS_Apps> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_Apps>;
                        ...
                        switch (item)
                        {
							...
							case "ModifiedDate_desc":
                                ...
                                break;
							case "AppSecret":
								query = isOrdered ? ordered.ThenBy(o => o.AppSecret) : query.OrderBy(o => o.AppSecret);
								 break;
							case "AppSecret_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.AppSecret) : query.OrderByDescending(o => o.AppSecret);
                                break;
							case "IdentityTokenLifetime":
								query = isOrdered ? ordered.ThenBy(o => o.IdentityTokenLifetime) : query.OrderBy(o => o.IdentityTokenLifetime);
								 break;
							case "IdentityTokenLifetime_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IdentityTokenLifetime) : query.OrderByDescending(o => o.IdentityTokenLifetime);
                                break;
							case "AccessTokenLifetime":
								query = isOrdered ? ordered.ThenBy(o => o.AccessTokenLifetime) : query.OrderBy(o => o.AccessTokenLifetime);
								 break;
							case "AccessTokenLifetime_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.AccessTokenLifetime) : query.OrderByDescending(o => o.AccessTokenLifetime);
                                break;
							case "RequireConsent":
								query = isOrdered ? ordered.ThenBy(o => o.RequireConsent) : query.OrderBy(o => o.RequireConsent);
								 break;
							case "RequireConsent_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.RequireConsent) : query.OrderByDescending(o => o.RequireConsent);
                                break;
							case "AppColor":
								query = isOrdered ? ordered.ThenBy(o => o.AppColor) : query.OrderBy(o => o.AppColor);
								 break;
							case "AppColor_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.AppColor) : query.OrderByDescending(o => o.AppColor);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_SYS_Apps> _pagingBuilder(IQueryable<tbl_SYS_Apps> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
