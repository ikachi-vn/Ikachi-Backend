...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_PermissionList
    {
...
{
	using System;
	public partial class DTO_SYS_PermissionList
	{
		public int IDBranch { get; set; }
		public int IDForm { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_PermissionList 
    {
		...
		public static IQueryable<DTO_SYS_PermissionList> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_PermissionList";
		...
		public static DTO_SYS_PermissionList getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_PermissionList.Find(id);
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_PermissionList.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_PermissionList",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_PermissionList dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_PermissionList);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_PermissionList item, tbl_SYS_PermissionList dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SYS_PermissionList post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_PermissionList dbitem = new tbl_SYS_PermissionList();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_PermissionList.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_PermissionList",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_SYS_PermissionList();
                    ...
                    {
                        dbitem = new tbl_SYS_PermissionList();
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_PermissionList.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_PermissionList.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_PermissionList.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_SYS_PermissionList", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_PermissionList",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_PermissionList.Any(e => e.Id == id && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_PermissionList> toDTO(IQueryable<tbl_SYS_PermissionList> query)
        {
			return query
			.Select(s => new DTO_SYS_PermissionList(){							
				IDBranch = s.IDBranch,							
				IDForm = s.IDForm,							
				Id = s.Id,							
				Value = s.Value,							
		...
		public static DTO_SYS_PermissionList toDTO(tbl_SYS_PermissionList dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_PermissionList()
				{							
		...
		public static IQueryable<tbl_SYS_PermissionList> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_PermissionList> query = db.tbl_SYS_PermissionList.AsNoTracking();//.Where(d => d.IsDeleted == false);
            ...
            if (QueryStrings.Any(d => d.Key == "Value"))
                if (int.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "Value").Value, out int val))
        ...
        public static IQueryable<tbl_SYS_PermissionList> _sortBuilder(IQueryable<tbl_SYS_PermissionList> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_PermissionList>;
        ...
        public static IQueryable<tbl_SYS_PermissionList> _pagingBuilder(IQueryable<tbl_SYS_PermissionList> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
