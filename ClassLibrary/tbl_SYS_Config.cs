...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_Config 
    {
		...
		public static IQueryable<DTO_SYS_Config> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_Config";
		...
		public static DTO_SYS_Config getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
		...
		public static DTO_SYS_Config getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_Config dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_Config);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_Config item, tbl_SYS_Config dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SYS_Config post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = db.tbl_SYS_Config.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_Config.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_Config.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_SYS_Config", updateDate, Username);
                }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_Config",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_Config.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_Config.Any(e => e.Code == Code && e.IsDeleted == false);
		...
		public static IQueryable<tbl_SYS_Config> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_Config> query = db.tbl_SYS_Config.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_SYS_Config> _sortBuilder(IQueryable<tbl_SYS_Config> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_Config>;
        ...
        public static IQueryable<tbl_SYS_Config> _pagingBuilder(IQueryable<tbl_SYS_Config> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
