...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_VeifyPhoneNumber
    {
...
{
	using System;
	public partial class DTO_SYS_VeifyPhoneNumber
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_VeifyPhoneNumber 
    {
		...
		public static IQueryable<DTO_SYS_VeifyPhoneNumber> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_VeifyPhoneNumber";
		...
		public static DTO_SYS_VeifyPhoneNumber getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_VeifyPhoneNumber.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_SYS_VeifyPhoneNumber getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_SYS_VeifyPhoneNumber
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_VeifyPhoneNumber.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_VeifyPhoneNumber",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_VeifyPhoneNumber dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_VeifyPhoneNumber);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_VeifyPhoneNumber item, tbl_SYS_VeifyPhoneNumber dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.VerifyCode = item.VerifyCode;							
			dbitem.IsVerified = item.IsVerified;							
			dbitem.VerifiedDate = item.VerifiedDate;        }

		public static DTO_SYS_VeifyPhoneNumber post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_VeifyPhoneNumber dbitem = new tbl_SYS_VeifyPhoneNumber();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_VeifyPhoneNumber.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_VeifyPhoneNumber",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_SYS_VeifyPhoneNumber();
                    ...
                    {
                        dbitem = new tbl_SYS_VeifyPhoneNumber();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_VeifyPhoneNumber.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_VeifyPhoneNumber.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_VeifyPhoneNumber.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_SYS_VeifyPhoneNumber", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_VeifyPhoneNumber",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_VeifyPhoneNumber",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_VeifyPhoneNumber.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_VeifyPhoneNumber.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_VeifyPhoneNumber> toDTO(IQueryable<tbl_SYS_VeifyPhoneNumber> query)
        {
			return query
			.Select(s => new DTO_SYS_VeifyPhoneNumber(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
		...
		public static DTO_SYS_VeifyPhoneNumber toDTO(tbl_SYS_VeifyPhoneNumber dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_VeifyPhoneNumber()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					VerifyCode = dbResult.VerifyCode,							
					IsVerified = dbResult.IsVerified,							
					VerifiedDate = dbResult.VerifiedDate,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_SYS_VeifyPhoneNumber> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_VeifyPhoneNumber> query = db.tbl_SYS_VeifyPhoneNumber.AsNoTracking();//.Where(d => d.IsDeleted == false );
			...
			//Query VerifyCode (string)
			if (QueryStrings.Any(d => d.Key == "VerifyCode_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "VerifyCode_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "VerifyCode_eq").Value;
                query = query.Where(d=>d.VerifyCode == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "VerifyCode") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "VerifyCode").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "VerifyCode").Value;
                query = query.Where(d=>d.VerifyCode.Contains(keyword));
            }
            

			//Query IsVerified (bool)
			if (QueryStrings.Any(d => d.Key == "IsVerified"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsVerified").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsVerified);
            }

			//Query VerifiedDate (Nullable<System.DateTime>)
			if (QueryStrings.Any(d => d.Key == "VerifiedDateFrom") && QueryStrings.Any(d => d.Key == "VerifiedDateTo"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "VerifiedDateFrom").Value, out DateTime fromDate) && DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "VerifiedDateTo").Value, out DateTime toDate))
                    query = query.Where(d => fromDate <= d.VerifiedDate && d.VerifiedDate <= toDate);

            if (QueryStrings.Any(d => d.Key == "VerifiedDate"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "VerifiedDate").Value, out DateTime val))
                    query = query.Where(d => d.VerifiedDate != null && DbFunctions.TruncateTime(val) == DbFunctions.TruncateTime(d.VerifiedDate));

            return query;
        }
		
        public static IQueryable<tbl_SYS_VeifyPhoneNumber> _sortBuilder(IQueryable<tbl_SYS_VeifyPhoneNumber> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_VeifyPhoneNumber>;
                        ...
                        switch (item)
                        {
							...
							case "PhoneNumber_desc":
                                ...
                                break;
							case "VerifyCode":
								query = isOrdered ? ordered.ThenBy(o => o.VerifyCode) : query.OrderBy(o => o.VerifyCode);
								 break;
							case "VerifyCode_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.VerifyCode) : query.OrderByDescending(o => o.VerifyCode);
                                break;
							case "IsVerified":
								query = isOrdered ? ordered.ThenBy(o => o.IsVerified) : query.OrderBy(o => o.IsVerified);
								 break;
							case "IsVerified_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsVerified) : query.OrderByDescending(o => o.IsVerified);
                                break;
							case "VerifiedDate":
								query = isOrdered ? ordered.ThenBy(o => o.VerifiedDate) : query.OrderBy(o => o.VerifiedDate);
								 break;
							case "VerifiedDate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.VerifiedDate) : query.OrderByDescending(o => o.VerifiedDate);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_SYS_VeifyPhoneNumber> _pagingBuilder(IQueryable<tbl_SYS_VeifyPhoneNumber> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
