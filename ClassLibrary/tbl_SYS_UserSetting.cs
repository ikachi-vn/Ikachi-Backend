...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_UserSetting
    {
...
{
	using System;
	public partial class DTO_SYS_UserSetting
	{
		public int IDBranch { get; set; }
		public string IDUser { get; set; }
		public string Email { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_UserSetting 
    {
		...
		public static IQueryable<DTO_SYS_UserSetting> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS SYS_UserSetting";
		...
		public static DTO_SYS_UserSetting getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_SYS_UserSetting.Find(id);
		...
		public static DTO_SYS_UserSetting getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_SYS_UserSetting
        ...
        {
            bool result = false;
            var dbitem = db.tbl_SYS_UserSetting.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_SYS_UserSetting",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_SYS_UserSetting dbitem, string Username)
        {
            Type type = typeof(tbl_SYS_UserSetting);
        ...
        public static void patchDTOtoDBValue( DTO_SYS_UserSetting item, tbl_SYS_UserSetting dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_SYS_UserSetting post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_SYS_UserSetting dbitem = new tbl_SYS_UserSetting();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_SYS_UserSetting.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_SYS_UserSetting",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_SYS_UserSetting();
                    ...
                    {
                        dbitem = new tbl_SYS_UserSetting();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_SYS_UserSetting.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_SYS_UserSetting.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_SYS_UserSetting.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_SYS_UserSetting", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_SYS_UserSetting",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_SYS_UserSetting",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_SYS_UserSetting.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_SYS_UserSetting.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_SYS_UserSetting> toDTO(IQueryable<tbl_SYS_UserSetting> query)
        {
			return query
			.Select(s => new DTO_SYS_UserSetting(){							
				IDBranch = s.IDBranch,							
				IDUser = s.IDUser,							
				Email = s.Email,							
				Id = s.Id,							
		...
		public static DTO_SYS_UserSetting toDTO(tbl_SYS_UserSetting dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_SYS_UserSetting()
				{							
		...
		public static IQueryable<tbl_SYS_UserSetting> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_SYS_UserSetting> query = db.tbl_SYS_UserSetting.AsNoTracking();//.Where(d => d.IsDeleted == false);
        ...
        public static IQueryable<tbl_SYS_UserSetting> _sortBuilder(IQueryable<tbl_SYS_UserSetting> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_SYS_UserSetting>;
        ...
        public static IQueryable<tbl_SYS_UserSetting> _pagingBuilder(IQueryable<tbl_SYS_UserSetting> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
