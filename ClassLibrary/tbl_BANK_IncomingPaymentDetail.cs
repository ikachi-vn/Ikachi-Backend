...
namespace ClassLibrary
{
    ...
    public partial class tbl_BANK_IncomingPaymentDetail
    {
        ...
        //List 0:1
        public virtual tbl_BANK_IncomingPayment tbl_BANK_IncomingPayment { get; set; }
        //List 0:1
...
{
	using System;
	public partial class DTO_BANK_IncomingPaymentDetail
	{
		public Nullable<int> IDBranch { get; set; }
		public Nullable<int> IDCustomer { get; set; }
		public int IDIncomingPayment { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_BANK_IncomingPaymentDetail 
    {
		...
		public static IQueryable<DTO_BANK_IncomingPaymentDetail> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS BANK_IncomingPaymentDetail";
            ...
            if (workBook != null)
            {
                ...
                //var BANK_IncomingPaymentList = BS_BANK_IncomingPayment.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
                //var SALE_OrderList = BS_SALE_Order.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_BANK_IncomingPaymentDetail getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_BANK_IncomingPaymentDetail.Find(id);
		...
		public static DTO_BANK_IncomingPaymentDetail getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_BANK_IncomingPaymentDetail
        ...
        {
            bool result = false;
            var dbitem = db.tbl_BANK_IncomingPaymentDetail.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_BANK_IncomingPaymentDetail",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_BANK_IncomingPaymentDetail dbitem, string Username)
        {
            Type type = typeof(tbl_BANK_IncomingPaymentDetail);
        ...
        public static void patchDTOtoDBValue( DTO_BANK_IncomingPaymentDetail item, tbl_BANK_IncomingPaymentDetail dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDIncomingPayment = item.IDIncomingPayment;							
			dbitem.IDSaleOrder = item.IDSaleOrder;							
			dbitem.IDContract = item.IDContract;							
			dbitem.IDInvoice = item.IDInvoice;							
		...
		public static DTO_BANK_IncomingPaymentDetail post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_BANK_IncomingPaymentDetail dbitem = new tbl_BANK_IncomingPaymentDetail();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_BANK_IncomingPaymentDetail.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_BANK_IncomingPaymentDetail",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_BANK_IncomingPaymentDetail();
                    ...
                    {
                        dbitem = new tbl_BANK_IncomingPaymentDetail();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_BANK_IncomingPaymentDetail.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_BANK_IncomingPaymentDetail.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_BANK_IncomingPaymentDetail.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_BANK_IncomingPaymentDetail", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_BANK_IncomingPaymentDetail",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_BANK_IncomingPaymentDetail",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_BANK_IncomingPaymentDetail.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_BANK_IncomingPaymentDetail.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_BANK_IncomingPaymentDetail> toDTO(IQueryable<tbl_BANK_IncomingPaymentDetail> query)
        {
			return query
			.Select(s => new DTO_BANK_IncomingPaymentDetail(){							
				IDBranch = s.IDBranch,							
				IDCustomer = s.IDCustomer,							
				IDIncomingPayment = s.IDIncomingPayment,							
				IDSaleOrder = s.IDSaleOrder,							
		...
		public static DTO_BANK_IncomingPaymentDetail toDTO(tbl_BANK_IncomingPaymentDetail dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_BANK_IncomingPaymentDetail()
				{							
					IDBranch = dbResult.IDBranch,							
					IDCustomer = dbResult.IDCustomer,							
					IDIncomingPayment = dbResult.IDIncomingPayment,							
					IDSaleOrder = dbResult.IDSaleOrder,							
					IDContract = dbResult.IDContract,							
					IDInvoice = dbResult.IDInvoice,							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
		...
		public static IQueryable<tbl_BANK_IncomingPaymentDetail> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_BANK_IncomingPaymentDetail> query = db.tbl_BANK_IncomingPaymentDetail.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
			...
			//Query IDIncomingPayment (int)
			if (QueryStrings.Any(d => d.Key == "IDIncomingPayment"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDIncomingPayment").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int> IDs = new List<int>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDIncomingPayment));
            }

			//Query IDSaleOrder (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDSaleOrder"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDSaleOrder").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDSaleOrder));
////                    query = query.Where(d => IDs.Contains(d.IDSaleOrder));
//                    
            }
...
//                    
			...
			//Query IDInvoice (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDInvoice"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDInvoice").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDInvoice));
////                    query = query.Where(d => IDs.Contains(d.IDInvoice));
//                    
            }
        ...
        public static IQueryable<tbl_BANK_IncomingPaymentDetail> _sortBuilder(IQueryable<tbl_BANK_IncomingPaymentDetail> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_BANK_IncomingPaymentDetail>;
                        ...
                        switch (item)
                        {
							...
							case "IDCustomer_desc":
                                ...
                                break;
							case "IDIncomingPayment":
								query = isOrdered ? ordered.ThenBy(o => o.IDIncomingPayment) : query.OrderBy(o => o.IDIncomingPayment);
								 break;
							case "IDIncomingPayment_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDIncomingPayment) : query.OrderByDescending(o => o.IDIncomingPayment);
                                break;
							case "IDSaleOrder":
								query = isOrdered ? ordered.ThenBy(o => o.IDSaleOrder) : query.OrderBy(o => o.IDSaleOrder);
								 break;
							case "IDSaleOrder_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDSaleOrder) : query.OrderByDescending(o => o.IDSaleOrder);
                                break;
							case "IDContract":
							...
							case "IDContract_desc":
                                ...
                                break;
							case "IDInvoice":
								query = isOrdered ? ordered.ThenBy(o => o.IDInvoice) : query.OrderBy(o => o.IDInvoice);
								 break;
							case "IDInvoice_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDInvoice) : query.OrderByDescending(o => o.IDInvoice);
                                break;
							case "Id":
        ...
        public static IQueryable<tbl_BANK_IncomingPaymentDetail> _pagingBuilder(IQueryable<tbl_BANK_IncomingPaymentDetail> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
