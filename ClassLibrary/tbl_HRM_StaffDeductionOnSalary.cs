...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffDeductionOnSalary
    {
...
{
	using System;
	public partial class DTO_HRM_StaffDeductionOnSalary
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffDeductionOnSalary 
    {
		...
		public static IQueryable<DTO_HRM_StaffDeductionOnSalary> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffDeductionOnSalary";
		...
		public static DTO_HRM_StaffDeductionOnSalary getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffDeductionOnSalary.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffDeductionOnSalary getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffDeductionOnSalary
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffDeductionOnSalary.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffDeductionOnSalary",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffDeductionOnSalary dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffDeductionOnSalary);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffDeductionOnSalary item, tbl_HRM_StaffDeductionOnSalary dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_HRM_StaffDeductionOnSalary post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffDeductionOnSalary dbitem = new tbl_HRM_StaffDeductionOnSalary();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffDeductionOnSalary.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffDeductionOnSalary",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffDeductionOnSalary();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffDeductionOnSalary();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffDeductionOnSalary.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffDeductionOnSalary.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffDeductionOnSalary.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffDeductionOnSalary", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffDeductionOnSalary",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_StaffDeductionOnSalary",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_StaffDeductionOnSalary.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_StaffDeductionOnSalary.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffDeductionOnSalary> toDTO(IQueryable<tbl_HRM_StaffDeductionOnSalary> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffDeductionOnSalary(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
		...
		public static DTO_HRM_StaffDeductionOnSalary toDTO(tbl_HRM_StaffDeductionOnSalary dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffDeductionOnSalary()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
		...
		public static IQueryable<tbl_HRM_StaffDeductionOnSalary> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffDeductionOnSalary> query = db.tbl_HRM_StaffDeductionOnSalary.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
        ...
        public static IQueryable<tbl_HRM_StaffDeductionOnSalary> _sortBuilder(IQueryable<tbl_HRM_StaffDeductionOnSalary> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffDeductionOnSalary>;
        ...
        public static IQueryable<tbl_HRM_StaffDeductionOnSalary> _pagingBuilder(IQueryable<tbl_HRM_StaffDeductionOnSalary> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
