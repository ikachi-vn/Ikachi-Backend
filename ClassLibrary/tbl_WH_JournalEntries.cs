...
namespace ClassLibrary
{
    ...
    public partial class tbl_WH_JournalEntries
    {
...
{
	using System;
	public partial class DTO_WH_JournalEntries
	{
		public Nullable<int> IDBranch { get; set; }
		public int Id { get; set; }
		public Nullable<int> RefID { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WH_JournalEntries 
    {
		...
		public static IQueryable<DTO_WH_JournalEntries> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WH_JournalEntries";
		...
		public static DTO_WH_JournalEntries getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WH_JournalEntries.Find(id);
		...
		public static DTO_WH_JournalEntries getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WH_JournalEntries
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WH_JournalEntries.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WH_JournalEntries",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WH_JournalEntries dbitem, string Username)
        {
            Type type = typeof(tbl_WH_JournalEntries);
        ...
        public static void patchDTOtoDBValue( DTO_WH_JournalEntries item, tbl_WH_JournalEntries dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WH_JournalEntries post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WH_JournalEntries dbitem = new tbl_WH_JournalEntries();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WH_JournalEntries.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WH_JournalEntries",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WH_JournalEntries();
                    ...
                    {
                        dbitem = new tbl_WH_JournalEntries();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WH_JournalEntries.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WH_JournalEntries.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WH_JournalEntries.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WH_JournalEntries", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WH_JournalEntries",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WH_JournalEntries",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WH_JournalEntries.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WH_JournalEntries.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WH_JournalEntries> toDTO(IQueryable<tbl_WH_JournalEntries> query)
        {
			return query
			.Select(s => new DTO_WH_JournalEntries(){							
				IDBranch = s.IDBranch,							
				Id = s.Id,							
				RefID = s.RefID,							
				Code = s.Code,							
		...
		public static DTO_WH_JournalEntries toDTO(tbl_WH_JournalEntries dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WH_JournalEntries()
				{							
		...
		public static IQueryable<tbl_WH_JournalEntries> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WH_JournalEntries> query = db.tbl_WH_JournalEntries.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_WH_JournalEntries> _sortBuilder(IQueryable<tbl_WH_JournalEntries> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WH_JournalEntries>;
        ...
        public static IQueryable<tbl_WH_JournalEntries> _pagingBuilder(IQueryable<tbl_WH_JournalEntries> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
