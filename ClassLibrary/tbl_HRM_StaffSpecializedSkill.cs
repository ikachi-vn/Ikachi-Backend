...
namespace ClassLibrary
{
    ...
    public partial class tbl_HRM_StaffSpecializedSkill
    {
        ...
        public Nullable<int> IDSpecializedSkill { get; set; }
...
{
	using System;
	public partial class DTO_HRM_StaffSpecializedSkill
	{
		public int Id { get; set; }
		public string Code { get; set; }
		public string Name { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_HRM_StaffSpecializedSkill 
    {
		...
		public static IQueryable<DTO_HRM_StaffSpecializedSkill> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS HRM_StaffSpecializedSkill";
		...
		public static DTO_HRM_StaffSpecializedSkill getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_HRM_StaffSpecializedSkill.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_HRM_StaffSpecializedSkill getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_HRM_StaffSpecializedSkill
        ...
        {
            bool result = false;
            var dbitem = db.tbl_HRM_StaffSpecializedSkill.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_HRM_StaffSpecializedSkill",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_HRM_StaffSpecializedSkill dbitem, string Username)
        {
            Type type = typeof(tbl_HRM_StaffSpecializedSkill);
        ...
        public static void patchDTOtoDBValue( DTO_HRM_StaffSpecializedSkill item, tbl_HRM_StaffSpecializedSkill dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDSpecializedSkill = item.IDSpecializedSkill;							
		...
		public static DTO_HRM_StaffSpecializedSkill post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_HRM_StaffSpecializedSkill dbitem = new tbl_HRM_StaffSpecializedSkill();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_HRM_StaffSpecializedSkill.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_HRM_StaffSpecializedSkill",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_HRM_StaffSpecializedSkill();
                    ...
                    {
                        dbitem = new tbl_HRM_StaffSpecializedSkill();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_HRM_StaffSpecializedSkill.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_HRM_StaffSpecializedSkill.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_HRM_StaffSpecializedSkill.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_HRM_StaffSpecializedSkill", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_HRM_StaffSpecializedSkill",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_HRM_StaffSpecializedSkill",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_HRM_StaffSpecializedSkill.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_HRM_StaffSpecializedSkill.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_HRM_StaffSpecializedSkill> toDTO(IQueryable<tbl_HRM_StaffSpecializedSkill> query)
        {
			return query
			.Select(s => new DTO_HRM_StaffSpecializedSkill(){							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
				Remark = s.Remark,							
				...
				IDStaff = s.IDStaff,							
				IDSpecializedSkill = s.IDSpecializedSkill,							
				Rating = s.Rating,							
		...
		public static DTO_HRM_StaffSpecializedSkill toDTO(tbl_HRM_StaffSpecializedSkill dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_HRM_StaffSpecializedSkill()
				{							
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					Name = dbResult.Name,							
					...
					IDSpecializedSkill = dbResult.IDSpecializedSkill,							
		...
		public static IQueryable<tbl_HRM_StaffSpecializedSkill> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_HRM_StaffSpecializedSkill> query = db.tbl_HRM_StaffSpecializedSkill.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
			...
			//Query IDSpecializedSkill (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDSpecializedSkill"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDSpecializedSkill").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDSpecializedSkill));
////                    query = query.Where(d => IDs.Contains(d.IDSpecializedSkill));
//                    
            }

			//Query Rating (string)
			if (QueryStrings.Any(d => d.Key == "Rating_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Rating_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Rating_eq").Value;
                query = query.Where(d=>d.Rating == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "Rating") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Rating").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Rating").Value;
                query = query.Where(d=>d.Rating.Contains(keyword));
            }
        ...
        public static IQueryable<tbl_HRM_StaffSpecializedSkill> _sortBuilder(IQueryable<tbl_HRM_StaffSpecializedSkill> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_HRM_StaffSpecializedSkill>;
                        ...
                        switch (item)
                        {
							...
							case "IDStaff_desc":
                                ...
                                break;
							case "IDSpecializedSkill":
								query = isOrdered ? ordered.ThenBy(o => o.IDSpecializedSkill) : query.OrderBy(o => o.IDSpecializedSkill);
								 break;
							case "IDSpecializedSkill_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDSpecializedSkill) : query.OrderByDescending(o => o.IDSpecializedSkill);
                                break;
							case "Rating":
								query = isOrdered ? ordered.ThenBy(o => o.Rating) : query.OrderBy(o => o.Rating);
								 break;
							case "Rating_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.Rating) : query.OrderByDescending(o => o.Rating);
                                break;
        ...
        public static IQueryable<tbl_HRM_StaffSpecializedSkill> _pagingBuilder(IQueryable<tbl_HRM_StaffSpecializedSkill> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
