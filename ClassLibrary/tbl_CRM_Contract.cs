...
namespace ClassLibrary
{
    ...
    public partial class tbl_CRM_Contract
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_CRM_Contract()
        {
        ...
        public Nullable<int> RefContractID { get; set; }
        ...
        //List 0:1
        public virtual tbl_CRM_Opportunity tbl_CRM_Opportunity { get; set; }
        //List 0:1
        public virtual tbl_CRM_Quotation tbl_CRM_Quotation { get; set; }
...
{
	using System;
	public partial class DTO_CRM_Contract
	{
		public Nullable<int> IDContact { get; set; }
		public Nullable<int> IDOpportunity { get; set; }
		public int IDBranch { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CRM_Contract 
    {
		...
		public static IQueryable<DTO_CRM_Contract> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS CRM_Contract";
            ...
            if (workBook != null)
            {
                ...
                //var CRM_OpportunityList = BS_CRM_Opportunity.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
                //var CRM_QuotationList = BS_CRM_Quotation.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_CRM_Contract getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_CRM_Contract.Find(id);
		...
		public static DTO_CRM_Contract getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_CRM_Contract
        ...
        {
            bool result = false;
            var dbitem = db.tbl_CRM_Contract.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_CRM_Contract",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_CRM_Contract dbitem, string Username)
        {
            Type type = typeof(tbl_CRM_Contract);
        ...
        public static void patchDTOtoDBValue( DTO_CRM_Contract item, tbl_CRM_Contract dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.RefContractID = item.RefContractID;							
			dbitem.Name = item.Name;							
			dbitem.ContractDate = item.ContractDate;							
			dbitem.Remark = item.Remark;							
			dbitem.Sort = item.Sort;							
			dbitem.IsDisabled = item.IsDisabled;							
			dbitem.IsDeleted = item.IsDeleted;							
			dbitem.IDQuotation = item.IDQuotation;							
			dbitem.EventDate = item.EventDate;							
			dbitem.NumberOfGuests = item.NumberOfGuests;        }

		public static DTO_CRM_Contract post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_CRM_Contract dbitem = new tbl_CRM_Contract();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_CRM_Contract.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_CRM_Contract",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_CRM_Contract();
                    ...
                    {
                        dbitem = new tbl_CRM_Contract();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_CRM_Contract.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_CRM_Contract.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_CRM_Contract.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_CRM_Contract", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_CRM_Contract",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_CRM_Contract",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_CRM_Contract.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_CRM_Contract.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_CRM_Contract> toDTO(IQueryable<tbl_CRM_Contract> query)
        {
			return query
			.Select(s => new DTO_CRM_Contract(){							
				IDContact = s.IDContact,							
				IDOpportunity = s.IDOpportunity,							
				IDBranch = s.IDBranch,							
				Id = s.Id,							
				Code = s.Code,							
				RefContractID = s.RefContractID,							
				Name = s.Name,							
		...
		public static DTO_CRM_Contract toDTO(tbl_CRM_Contract dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CRM_Contract()
				{							
					...
					Id = dbResult.Id,							
					Code = dbResult.Code,							
					RefContractID = dbResult.RefContractID,							
					Name = dbResult.Name,							
					ContractDate = dbResult.ContractDate,							
					...
					IDQuotation = dbResult.IDQuotation,							
		...
		public static IQueryable<tbl_CRM_Contract> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_CRM_Contract> query = db.tbl_CRM_Contract.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
			...
			//Query RefContractID (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "RefContractID"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "RefContractID").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.RefContractID));
////                    query = query.Where(d => IDs.Contains(d.RefContractID));
//                    
            }
			...
			//Query ContractDate (Nullable<System.DateTime>)
			if (QueryStrings.Any(d => d.Key == "ContractDateFrom") && QueryStrings.Any(d => d.Key == "ContractDateTo"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ContractDateFrom").Value, out DateTime fromDate) && DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ContractDateTo").Value, out DateTime toDate))
                    query = query.Where(d => fromDate <= d.ContractDate && d.ContractDate <= toDate);

            if (QueryStrings.Any(d => d.Key == "ContractDate"))
                if (DateTime.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "ContractDate").Value, out DateTime val))
                    query = query.Where(d => d.ContractDate != null && DbFunctions.TruncateTime(val) == DbFunctions.TruncateTime(d.ContractDate));
			...
			//Query IDQuotation (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDQuotation"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDQuotation").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDQuotation));
////                    query = query.Where(d => IDs.Contains(d.IDQuotation));
//                    
            }

			//Query EventDate (Nullable<System.DateTime>)
        ...
        public static IQueryable<tbl_CRM_Contract> _sortBuilder(IQueryable<tbl_CRM_Contract> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_CRM_Contract>;
                        ...
                        switch (item)
                        {
							...
							case "Code_desc":
                                ...
                                break;
							case "RefContractID":
								query = isOrdered ? ordered.ThenBy(o => o.RefContractID) : query.OrderBy(o => o.RefContractID);
								 break;
							case "RefContractID_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.RefContractID) : query.OrderByDescending(o => o.RefContractID);
                                break;
							case "Name":
							...
							case "Name_desc":
                                ...
                                break;
							case "ContractDate":
								query = isOrdered ? ordered.ThenBy(o => o.ContractDate) : query.OrderBy(o => o.ContractDate);
								 break;
							case "ContractDate_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.ContractDate) : query.OrderByDescending(o => o.ContractDate);
                                break;
							case "Remark":
							...
							case "ModifiedDate_desc":
                                ...
                                break;
							case "IDQuotation":
								query = isOrdered ? ordered.ThenBy(o => o.IDQuotation) : query.OrderBy(o => o.IDQuotation);
								 break;
							case "IDQuotation_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDQuotation) : query.OrderByDescending(o => o.IDQuotation);
                                break;
							case "EventDate":
        ...
        public static IQueryable<tbl_CRM_Contract> _pagingBuilder(IQueryable<tbl_CRM_Contract> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
