...
namespace ClassLibrary
{
    ...
    public partial class tbl_BI_Finance_BalanceSheetCategory
    {
...
{
	using System;
	public partial class DTO_BI_Finance_BalanceSheetCategory
	{
		public Nullable<int> IDBranch { get; set; }
		public Nullable<int> IDParent { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_BI_Finance_BalanceSheetCategory 
    {
		...
		public static IQueryable<DTO_BI_Finance_BalanceSheetCategory> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_BI_Finance_BalanceSheetCategory> allItems = db.tbl_BI_Finance_BalanceSheetCategory.Where(d => d.IsDeleted == false).Select(s => new DTO_BI_Finance_BalanceSheetCategory()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_BI_Finance_BalanceSheetCategory.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_BI_Finance_BalanceSheetCategory> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_BI_Finance_BalanceSheetCategory> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS BI_Finance_BalanceSheetCategory";
		...
		public static DTO_BI_Finance_BalanceSheetCategory getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_BI_Finance_BalanceSheetCategory.Find(id);
		...
		public static DTO_BI_Finance_BalanceSheetCategory getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_BI_Finance_BalanceSheetCategory
        ...
        {
            bool result = false;
            var dbitem = db.tbl_BI_Finance_BalanceSheetCategory.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_BI_Finance_BalanceSheetCategory",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_BI_Finance_BalanceSheetCategory dbitem, string Username)
        {
            Type type = typeof(tbl_BI_Finance_BalanceSheetCategory);
        ...
        public static void patchDTOtoDBValue( DTO_BI_Finance_BalanceSheetCategory item, tbl_BI_Finance_BalanceSheetCategory dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IsTitle = item.IsTitle;							
			dbitem.IsDisabled = item.IsDisabled;							
			dbitem.IsDeleted = item.IsDeleted;        }

		public static DTO_BI_Finance_BalanceSheetCategory post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_BI_Finance_BalanceSheetCategory dbitem = new tbl_BI_Finance_BalanceSheetCategory();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_BI_Finance_BalanceSheetCategory.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_BI_Finance_BalanceSheetCategory",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_BI_Finance_BalanceSheetCategory();
                    ...
                    {
                        dbitem = new tbl_BI_Finance_BalanceSheetCategory();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_BI_Finance_BalanceSheetCategory.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_BI_Finance_BalanceSheetCategory.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_BI_Finance_BalanceSheetCategory.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_BI_Finance_BalanceSheetCategory", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_BI_Finance_BalanceSheetCategory",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_BI_Finance_BalanceSheetCategory",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_BI_Finance_BalanceSheetCategory.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_BI_Finance_BalanceSheetCategory.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_BI_Finance_BalanceSheetCategory> toDTO(IQueryable<tbl_BI_Finance_BalanceSheetCategory> query)
        {
			return query
			.Select(s => new DTO_BI_Finance_BalanceSheetCategory(){							
				IDBranch = s.IDBranch,							
				IDParent = s.IDParent,							
				Id = s.Id,							
				N0 = s.N0,							
		...
		public static DTO_BI_Finance_BalanceSheetCategory toDTO(tbl_BI_Finance_BalanceSheetCategory dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_BI_Finance_BalanceSheetCategory()
				{							
		...
		public static IQueryable<tbl_BI_Finance_BalanceSheetCategory> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_BI_Finance_BalanceSheetCategory> query = db.tbl_BI_Finance_BalanceSheetCategory.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
			...
			//Query N0 (string)
			if (QueryStrings.Any(d => d.Key == "N0_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "N0_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "N0_eq").Value;
                query = query.Where(d=>d.N0 == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "N0") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "N0").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "N0").Value;
                query = query.Where(d=>d.N0.Contains(keyword));
            }
            

			//Query N1 (string)
			if (QueryStrings.Any(d => d.Key == "N1_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "N1_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "N1_eq").Value;
                query = query.Where(d=>d.N1 == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "N1") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "N1").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "N1").Value;
                query = query.Where(d=>d.N1.Contains(keyword));
            }
			...
			//Query IsTitle (bool)
			if (QueryStrings.Any(d => d.Key == "IsTitle"))
            {
                var qValue = QueryStrings.FirstOrDefault(d => d.Key == "IsTitle").Value;
                if (bool.TryParse(qValue, out bool qBoolValue))
                    query = query.Where(d => qBoolValue == d.IsTitle);
            }
        ...
        public static IQueryable<tbl_BI_Finance_BalanceSheetCategory> _sortBuilder(IQueryable<tbl_BI_Finance_BalanceSheetCategory> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_BI_Finance_BalanceSheetCategory>;
                        ...
                        switch (item)
                        {
							...
							case "Id_desc":
                                ...
                                break;
							case "N0":
								query = isOrdered ? ordered.ThenBy(o => o.N0) : query.OrderBy(o => o.N0);
								 break;
							case "N0_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.N0) : query.OrderByDescending(o => o.N0);
                                break;
							case "N1":
								query = isOrdered ? ordered.ThenBy(o => o.N1) : query.OrderBy(o => o.N1);
								 break;
							case "N1_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.N1) : query.OrderByDescending(o => o.N1);
                                break;
							case "Code":
							...
							case "Sort_desc":
                                ...
                                break;
							case "IsTitle":
								query = isOrdered ? ordered.ThenBy(o => o.IsTitle) : query.OrderBy(o => o.IsTitle);
								 break;
							case "IsTitle_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IsTitle) : query.OrderByDescending(o => o.IsTitle);
                                break;
							case "IsDisabled":
        ...
        public static IQueryable<tbl_BI_Finance_BalanceSheetCategory> _pagingBuilder(IQueryable<tbl_BI_Finance_BalanceSheetCategory> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
