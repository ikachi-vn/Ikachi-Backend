...
namespace ClassLibrary
{
    ...
    public partial class tbl_CRM_Route
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_CRM_Route()
        {
        ...
        public Nullable<int> IDVehicleForSample { get; set; }
        public Nullable<int> IDVehicleForUrgent { get; set; }
        public Nullable<int> IDVehicleForWholeSale { get; set; }
...
{
	using System;
	public partial class DTO_CRM_Route
	{
		public Nullable<int> IDBranch { get; set; }
		public Nullable<int> IDSeller { get; set; }
		public Nullable<int> IDParent { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CRM_Route 
    {
		...
		public static IQueryable<DTO_CRM_Route> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_CRM_Route> allItems = db.tbl_CRM_Route.Where(d => d.IsDeleted == false).Select(s => new DTO_CRM_Route()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_CRM_Route.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_CRM_Route> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_CRM_Route> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS CRM_Route";
		...
		public static DTO_CRM_Route getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_CRM_Route.Find(id);
		...
		public static DTO_CRM_Route getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_CRM_Route
        ...
        {
            bool result = false;
            var dbitem = db.tbl_CRM_Route.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_CRM_Route",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_CRM_Route dbitem, string Username)
        {
            Type type = typeof(tbl_CRM_Route);
        ...
        public static void patchDTOtoDBValue( DTO_CRM_Route item, tbl_CRM_Route dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDSeller = item.IDSeller;							
			dbitem.IDParent = item.IDParent;							
			dbitem.IDVehicle = item.IDVehicle;							
			dbitem.IDVehicleForSample = item.IDVehicleForSample;							
			dbitem.IDVehicleForUrgent = item.IDVehicleForUrgent;							
			dbitem.IDVehicleForWholeSale = item.IDVehicleForWholeSale;							
		...
		public static DTO_CRM_Route post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_CRM_Route dbitem = new tbl_CRM_Route();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_CRM_Route.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_CRM_Route",e);
                    return null;
                }
            }
            return toDTO(dbitem);
        ...
        public static dynamic import(ExcelPackage package, AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings, string Username)
        {
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    {
                        dbitem = new tbl_CRM_Route();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_CRM_Route.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_CRM_Route.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_CRM_Route.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_CRM_Route", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_CRM_Route",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_CRM_Route",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_CRM_Route.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_CRM_Route.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_CRM_Route> toDTO(IQueryable<tbl_CRM_Route> query)
        {
			return query
			.Select(s => new DTO_CRM_Route(){							
				IDBranch = s.IDBranch,							
				IDSeller = s.IDSeller,							
				IDParent = s.IDParent,							
				IDVehicle = s.IDVehicle,							
				IDVehicleForSample = s.IDVehicleForSample,							
				IDVehicleForUrgent = s.IDVehicleForUrgent,							
				IDVehicleForWholeSale = s.IDVehicleForWholeSale,							
		...
		public static DTO_CRM_Route toDTO(tbl_CRM_Route dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CRM_Route()
				{							
					IDBranch = dbResult.IDBranch,							
					IDSeller = dbResult.IDSeller,							
					IDParent = dbResult.IDParent,							
					IDVehicle = dbResult.IDVehicle,							
					IDVehicleForSample = dbResult.IDVehicleForSample,							
					IDVehicleForUrgent = dbResult.IDVehicleForUrgent,							
					IDVehicleForWholeSale = dbResult.IDVehicleForWholeSale,							
		...
		public static IQueryable<tbl_CRM_Route> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_CRM_Route> query = db.tbl_CRM_Route.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
			...
			//Query IDSeller (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDSeller"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDSeller").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDSeller));
////                    query = query.Where(d => IDs.Contains(d.IDSeller));
//                    
            }
...
//                    
			...
			//Query IDVehicleForSample (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDVehicleForSample"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDVehicleForSample").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDVehicleForSample));
////                    query = query.Where(d => IDs.Contains(d.IDVehicleForSample));
//                    
            }

			//Query IDVehicleForUrgent (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDVehicleForUrgent"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDVehicleForUrgent").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDVehicleForUrgent));
////                    query = query.Where(d => IDs.Contains(d.IDVehicleForUrgent));
//                    
            }

			//Query IDVehicleForWholeSale (Nullable<int>)
			if (QueryStrings.Any(d => d.Key == "IDVehicleForWholeSale"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDVehicleForWholeSale").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int?> IDs = new List<int?>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
						...
						IDs.Add(null);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDVehicleForWholeSale));
////                    query = query.Where(d => IDs.Contains(d.IDVehicleForWholeSale));
//                    
            }
...
//                    
        ...
        public static IQueryable<tbl_CRM_Route> _sortBuilder(IQueryable<tbl_CRM_Route> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_CRM_Route>;
                        ...
                        switch (item)
                        {
							...
							case "IDBranch_desc":
                                ...
                                break;
							case "IDSeller":
								query = isOrdered ? ordered.ThenBy(o => o.IDSeller) : query.OrderBy(o => o.IDSeller);
								 break;
							case "IDSeller_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDSeller) : query.OrderByDescending(o => o.IDSeller);
                                break;
							case "IDParent":
							...
							case "IDVehicle_desc":
                                ...
                                break;
							case "IDVehicleForSample":
								query = isOrdered ? ordered.ThenBy(o => o.IDVehicleForSample) : query.OrderBy(o => o.IDVehicleForSample);
								 break;
							case "IDVehicleForSample_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDVehicleForSample) : query.OrderByDescending(o => o.IDVehicleForSample);
                                break;
							case "IDVehicleForUrgent":
								query = isOrdered ? ordered.ThenBy(o => o.IDVehicleForUrgent) : query.OrderBy(o => o.IDVehicleForUrgent);
								 break;
							case "IDVehicleForUrgent_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDVehicleForUrgent) : query.OrderByDescending(o => o.IDVehicleForUrgent);
                                break;
							case "IDVehicleForWholeSale":
								query = isOrdered ? ordered.ThenBy(o => o.IDVehicleForWholeSale) : query.OrderBy(o => o.IDVehicleForWholeSale);
								 break;
							case "IDVehicleForWholeSale_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDVehicleForWholeSale) : query.OrderByDescending(o => o.IDVehicleForWholeSale);
                                break;
							case "IDShipper":
        ...
        public static IQueryable<tbl_CRM_Route> _pagingBuilder(IQueryable<tbl_CRM_Route> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
