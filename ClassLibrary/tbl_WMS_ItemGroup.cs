...
namespace ClassLibrary
{
    ...
    public partial class tbl_WMS_ItemGroup
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_WMS_ItemGroup()
        {
            this.tbl_WMS_Item = new HashSet<tbl_WMS_Item>();
            this.tbl_WMS_ItemGroup1 = new HashSet<tbl_WMS_ItemGroup>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbl_WMS_ItemGroup> tbl_WMS_ItemGroup1 { get; set; }
        //List 0:1
        public virtual tbl_WMS_ItemGroup tbl_WMS_ItemGroup2 { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_WMS_ItemGroup
	{
		public Nullable<int> IDBranch { get; set; }
		public Nullable<int> IDParent { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WMS_ItemGroup 
    {
		...
		public static IQueryable<DTO_WMS_ItemGroup> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        public static List<int> findParent(List<DTO_WMS_ItemGroup> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_WMS_ItemGroup> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WMS_ItemGroup";
            ...
            if (workBook != null)
            {
                ...
                //var WMS_ItemGroup2List = BS_WMS_ItemGroup.get(db,IDBranch, StaffID,QueryStrings).Select(s => new ItemModel { Id = s.Id, Name = s.Name });
		...
		public static DTO_WMS_ItemGroup getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WMS_ItemGroup.Find(id);
		...
		public static DTO_WMS_ItemGroup getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WMS_ItemGroup
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WMS_ItemGroup.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WMS_ItemGroup",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WMS_ItemGroup dbitem, string Username)
        {
            Type type = typeof(tbl_WMS_ItemGroup);
        ...
        public static void patchDTOtoDBValue( DTO_WMS_ItemGroup item, tbl_WMS_ItemGroup dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.General = item.General;							
			dbitem.Accounting = item.Accounting;        }

		public static DTO_WMS_ItemGroup post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WMS_ItemGroup dbitem = new tbl_WMS_ItemGroup();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WMS_ItemGroup.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WMS_ItemGroup",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WMS_ItemGroup();
                    ...
                    {
                        dbitem = new tbl_WMS_ItemGroup();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WMS_ItemGroup.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WMS_ItemGroup.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WMS_ItemGroup.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WMS_ItemGroup", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WMS_ItemGroup",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WMS_ItemGroup",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WMS_ItemGroup.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WMS_ItemGroup.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WMS_ItemGroup> toDTO(IQueryable<tbl_WMS_ItemGroup> query)
        {
			return query
			.Select(s => new DTO_WMS_ItemGroup(){							
				IDBranch = s.IDBranch,							
				IDParent = s.IDParent,							
				Id = s.Id,							
				Code = s.Code,							
		...
		public static DTO_WMS_ItemGroup toDTO(tbl_WMS_ItemGroup dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WMS_ItemGroup()
				{							
					...
					General = dbResult.General,							
					Accounting = dbResult.Accounting,
				};
			}
			else
				return null; 
		...
		public static IQueryable<tbl_WMS_ItemGroup> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WMS_ItemGroup> query = db.tbl_WMS_ItemGroup.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
			...
			if (QueryStrings.Any(d => d.Key == "General_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "General_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "General_eq").Value;
                query = query.Where(d=>d.General == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "General") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "General").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "General").Value;
                query = query.Where(d=>d.General.Contains(keyword));
            }
            

			//Query Accounting (string)
			if (QueryStrings.Any(d => d.Key == "Accounting_eq") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Accounting_eq").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Accounting_eq").Value;
                query = query.Where(d=>d.Accounting == keyword);
            }
            if (QueryStrings.Any(d => d.Key == "Accounting") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "Accounting").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "Accounting").Value;
                query = query.Where(d=>d.Accounting.Contains(keyword));
            }
            
            return query;
        }
		
        public static IQueryable<tbl_WMS_ItemGroup> _sortBuilder(IQueryable<tbl_WMS_ItemGroup> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WMS_ItemGroup>;
                        ...
                        switch (item)
                        {
							...
							case "ModifiedDate_desc":
                                ...
                                break;
							case "General":
								query = isOrdered ? ordered.ThenBy(o => o.General) : query.OrderBy(o => o.General);
								 break;
							case "General_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.General) : query.OrderByDescending(o => o.General);
                                break;
							case "Accounting":
								query = isOrdered ? ordered.ThenBy(o => o.Accounting) : query.OrderBy(o => o.Accounting);
								 break;
							case "Accounting_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.Accounting) : query.OrderByDescending(o => o.Accounting);
                                break;
                            default:
                                if(!isOrdered)
        ...
        public static IQueryable<tbl_WMS_ItemGroup> _pagingBuilder(IQueryable<tbl_WMS_ItemGroup> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
