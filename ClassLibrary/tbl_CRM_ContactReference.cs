...
namespace ClassLibrary
{
    ...
    public partial class tbl_CRM_ContactReference
    {
...
{
	using System;
	public partial class DTO_CRM_ContactReference
	{
		public int Id { get; set; }
		public int IDContact { get; set; }
		public Nullable<int> IDVendor { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CRM_ContactReference 
    {
		...
		public static IQueryable<DTO_CRM_ContactReference> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS CRM_ContactReference";
		...
		public static DTO_CRM_ContactReference getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_CRM_ContactReference.Find(id);

			return toDTO(dbResult);
			
        }
		
		public static DTO_CRM_ContactReference getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_CRM_ContactReference
        ...
        {
            bool result = false;
            var dbitem = db.tbl_CRM_ContactReference.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_CRM_ContactReference",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_CRM_ContactReference dbitem, string Username)
        {
            Type type = typeof(tbl_CRM_ContactReference);
        ...
        public static void patchDTOtoDBValue( DTO_CRM_ContactReference item, tbl_CRM_ContactReference dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_CRM_ContactReference post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_CRM_ContactReference dbitem = new tbl_CRM_ContactReference();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_CRM_ContactReference.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_CRM_ContactReference",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_CRM_ContactReference();
                    ...
                    {
                        dbitem = new tbl_CRM_ContactReference();
                                            }
                    else
                    {
                        dbitem = db.tbl_CRM_ContactReference.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_CRM_ContactReference.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_CRM_ContactReference.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_CRM_ContactReference", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_CRM_ContactReference",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_CRM_ContactReference.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_CRM_ContactReference.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_CRM_ContactReference> toDTO(IQueryable<tbl_CRM_ContactReference> query)
        {
			return query
			.Select(s => new DTO_CRM_ContactReference(){							
				Id = s.Id,							
		...
		public static DTO_CRM_ContactReference toDTO(tbl_CRM_ContactReference dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CRM_ContactReference()
				{							
					Id = dbResult.Id,							
		...
		public static IQueryable<tbl_CRM_ContactReference> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_CRM_ContactReference> query = db.tbl_CRM_ContactReference.AsNoTracking();//.Where(d => d.IsDeleted == false );
...
//                    
        ...
        public static IQueryable<tbl_CRM_ContactReference> _sortBuilder(IQueryable<tbl_CRM_ContactReference> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_CRM_ContactReference>;
        ...
        public static IQueryable<tbl_CRM_ContactReference> _pagingBuilder(IQueryable<tbl_CRM_ContactReference> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
