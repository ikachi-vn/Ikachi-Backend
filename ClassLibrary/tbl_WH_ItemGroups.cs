...
namespace ClassLibrary
{
    ...
    public partial class tbl_WH_ItemGroups
    {
...
{
	using System;
	public partial class DTO_WH_ItemGroups
	{
		public int Id { get; set; }
		public Nullable<int> IDParent { get; set; }
		public Nullable<int> IDBranch { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WH_ItemGroups 
    {
		...
		public static IQueryable<DTO_WH_ItemGroups> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            ...
            if (QueryStrings.Any(d => d.Key == "AllChildren")  || QueryStrings.Any(d => d.Key == "AllParent"))
            {
                ...
                List<DTO_WH_ItemGroups> allItems = db.tbl_WH_ItemGroups.Where(d => d.IsDeleted == false).Select(s => new DTO_WH_ItemGroups()
                {
                    Id = s.Id,
                    IDParent = s.IDParent
                }).ToList();
                ...
                foreach (var item in query)
                {
                    ...
                    query = db.tbl_WH_ItemGroups.Where(d => Ids.Contains(d.Id));
                }
        ...
        public static List<int> findParent(List<DTO_WH_ItemGroups> allItems, int Id)
        {
        ...
        public static List<int> findChildrent(List<DTO_WH_ItemGroups> allItems, int Id)
        {
            var Ids = new List<int>();
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WH_ItemGroups";
		...
		public static DTO_WH_ItemGroups getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WH_ItemGroups.Find(id);
		...
		public static DTO_WH_ItemGroups getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WH_ItemGroups
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WH_ItemGroups.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WH_ItemGroups",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WH_ItemGroups dbitem, string Username)
        {
            Type type = typeof(tbl_WH_ItemGroups);
        ...
        public static void patchDTOtoDBValue( DTO_WH_ItemGroups item, tbl_WH_ItemGroups dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WH_ItemGroups post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WH_ItemGroups dbitem = new tbl_WH_ItemGroups();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WH_ItemGroups.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WH_ItemGroups",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WH_ItemGroups();
                    ...
                    {
                        dbitem = new tbl_WH_ItemGroups();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WH_ItemGroups.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WH_ItemGroups.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WH_ItemGroups.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WH_ItemGroups", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WH_ItemGroups",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WH_ItemGroups",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WH_ItemGroups.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WH_ItemGroups.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WH_ItemGroups> toDTO(IQueryable<tbl_WH_ItemGroups> query)
        {
			return query
			.Select(s => new DTO_WH_ItemGroups(){							
				Id = s.Id,							
				IDParent = s.IDParent,							
				IDBranch = s.IDBranch,							
				Code = s.Code,							
		...
		public static DTO_WH_ItemGroups toDTO(tbl_WH_ItemGroups dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WH_ItemGroups()
				{							
					Id = dbResult.Id,							
		...
		public static IQueryable<tbl_WH_ItemGroups> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WH_ItemGroups> query = db.tbl_WH_ItemGroups.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_WH_ItemGroups> _sortBuilder(IQueryable<tbl_WH_ItemGroups> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WH_ItemGroups>;
        ...
        public static IQueryable<tbl_WH_ItemGroups> _pagingBuilder(IQueryable<tbl_WH_ItemGroups> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
