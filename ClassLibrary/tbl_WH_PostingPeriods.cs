...
namespace ClassLibrary
{
    ...
    public partial class tbl_WH_PostingPeriods
    {
...
{
	using System;
	public partial class DTO_WH_PostingPeriods
	{
		public int Id { get; set; }
		public Nullable<int> IDBranch { get; set; }
		public Nullable<int> RefID { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WH_PostingPeriods 
    {
		...
		public static IQueryable<DTO_WH_PostingPeriods> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WH_PostingPeriods";
		...
		public static DTO_WH_PostingPeriods getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WH_PostingPeriods.Find(id);
		...
		public static DTO_WH_PostingPeriods getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WH_PostingPeriods
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WH_PostingPeriods.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WH_PostingPeriods",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WH_PostingPeriods dbitem, string Username)
        {
            Type type = typeof(tbl_WH_PostingPeriods);
        ...
        public static void patchDTOtoDBValue( DTO_WH_PostingPeriods item, tbl_WH_PostingPeriods dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WH_PostingPeriods post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WH_PostingPeriods dbitem = new tbl_WH_PostingPeriods();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WH_PostingPeriods.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WH_PostingPeriods",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WH_PostingPeriods();
                    ...
                    {
                        dbitem = new tbl_WH_PostingPeriods();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WH_PostingPeriods.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WH_PostingPeriods.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WH_PostingPeriods.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WH_PostingPeriods", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WH_PostingPeriods",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WH_PostingPeriods",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WH_PostingPeriods.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WH_PostingPeriods.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WH_PostingPeriods> toDTO(IQueryable<tbl_WH_PostingPeriods> query)
        {
			return query
			.Select(s => new DTO_WH_PostingPeriods(){							
				Id = s.Id,							
				IDBranch = s.IDBranch,							
				RefID = s.RefID,							
				Code = s.Code,							
		...
		public static DTO_WH_PostingPeriods toDTO(tbl_WH_PostingPeriods dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WH_PostingPeriods()
				{							
					Id = dbResult.Id,							
		...
		public static IQueryable<tbl_WH_PostingPeriods> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WH_PostingPeriods> query = db.tbl_WH_PostingPeriods.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
        ...
        public static IQueryable<tbl_WH_PostingPeriods> _sortBuilder(IQueryable<tbl_WH_PostingPeriods> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WH_PostingPeriods>;
        ...
        public static IQueryable<tbl_WH_PostingPeriods> _pagingBuilder(IQueryable<tbl_WH_PostingPeriods> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
