...
namespace ClassLibrary
{
    ...
    public partial class tbl_MR_TrackingCompetitor
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_MR_TrackingCompetitor()
        {
            this.tbl_MR_CompetiorOrder = new HashSet<tbl_MR_CompetiorOrder>();
        }
        ...
        public virtual ICollection<tbl_MR_CompetiorOrder> tbl_MR_CompetiorOrder { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_MR_TrackingCompetitor
	{
		public Nullable<int> IDBranch { get; set; }
		public int IDAccount { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_MR_TrackingCompetitor 
    {
		...
		public static IQueryable<DTO_MR_TrackingCompetitor> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS MR_TrackingCompetitor";
		...
		public static DTO_MR_TrackingCompetitor getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_MR_TrackingCompetitor.Find(id);
		...
		public static DTO_MR_TrackingCompetitor getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_MR_TrackingCompetitor
        ...
        {
            bool result = false;
            var dbitem = db.tbl_MR_TrackingCompetitor.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_MR_TrackingCompetitor",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_MR_TrackingCompetitor dbitem, string Username)
        {
            Type type = typeof(tbl_MR_TrackingCompetitor);
        ...
        public static void patchDTOtoDBValue( DTO_MR_TrackingCompetitor item, tbl_MR_TrackingCompetitor dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
			...
			dbitem.IDSegment = item.IDSegment;							
			dbitem.AveragePrice = item.AveragePrice;							
			dbitem.FromDate = item.FromDate;        }

		public static DTO_MR_TrackingCompetitor post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_MR_TrackingCompetitor dbitem = new tbl_MR_TrackingCompetitor();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_MR_TrackingCompetitor.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_MR_TrackingCompetitor",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_MR_TrackingCompetitor();
                    ...
                    {
                        dbitem = new tbl_MR_TrackingCompetitor();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_MR_TrackingCompetitor.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_MR_TrackingCompetitor.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_MR_TrackingCompetitor.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_MR_TrackingCompetitor", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_MR_TrackingCompetitor",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_MR_TrackingCompetitor",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_MR_TrackingCompetitor.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_MR_TrackingCompetitor.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_MR_TrackingCompetitor> toDTO(IQueryable<tbl_MR_TrackingCompetitor> query)
        {
			return query
			.Select(s => new DTO_MR_TrackingCompetitor(){							
				IDBranch = s.IDBranch,							
		...
		public static DTO_MR_TrackingCompetitor toDTO(tbl_MR_TrackingCompetitor dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_MR_TrackingCompetitor()
				{							
					...
					IDSegment = dbResult.IDSegment,							
					AveragePrice = dbResult.AveragePrice,							
		...
		public static IQueryable<tbl_MR_TrackingCompetitor> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_MR_TrackingCompetitor> query = db.tbl_MR_TrackingCompetitor.AsNoTracking();//.Where(d => d.IsDeleted == false);
...
//                    
			...
			//Query IDSegment (int)
			if (QueryStrings.Any(d => d.Key == "IDSegment"))
            {
                var IDList = QueryStrings.FirstOrDefault(d => d.Key == "IDSegment").Value.Replace("[", "").Replace("]", "").Split(',');
                List<int> IDs = new List<int>();
                foreach (var item in IDList)
                    if (int.TryParse(item, out int i))
                        IDs.Add(i);
                if (IDs.Count > 0)
                    query = query.Where(d => IDs.Contains(d.IDSegment));
            }

			//Query AveragePrice (decimal)
			if (QueryStrings.Any(d => d.Key == "AveragePriceFrom") && QueryStrings.Any(d => d.Key == "AveragePriceTo"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "AveragePriceFrom").Value, out decimal fromVal) && decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "AveragePriceTo").Value, out decimal toVal))
                    query = query.Where(d => fromVal <= d.AveragePrice && d.AveragePrice <= toVal);
            
            if (QueryStrings.Any(d => d.Key == "AveragePrice"))
                if (decimal.TryParse(QueryStrings.FirstOrDefault(d => d.Key == "AveragePrice").Value, out decimal val))
                    query = query.Where(d => val == d.AveragePrice);
        ...
        public static IQueryable<tbl_MR_TrackingCompetitor> _sortBuilder(IQueryable<tbl_MR_TrackingCompetitor> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_MR_TrackingCompetitor>;
                        ...
                        switch (item)
                        {
							...
							case "ModifiedDate_desc":
                                ...
                                break;
							case "IDSegment":
								query = isOrdered ? ordered.ThenBy(o => o.IDSegment) : query.OrderBy(o => o.IDSegment);
								 break;
							case "IDSegment_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDSegment) : query.OrderByDescending(o => o.IDSegment);
                                break;
							case "AveragePrice":
								query = isOrdered ? ordered.ThenBy(o => o.AveragePrice) : query.OrderBy(o => o.AveragePrice);
								 break;
							case "AveragePrice_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.AveragePrice) : query.OrderByDescending(o => o.AveragePrice);
                                break;
							case "FromDate":
        ...
        public static IQueryable<tbl_MR_TrackingCompetitor> _pagingBuilder(IQueryable<tbl_MR_TrackingCompetitor> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
