...
namespace ClassLibrary
{
    ...
    public partial class tbl_WMS_PutawayStrategy
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_WMS_PutawayStrategy()
        {
            this.tbl_WMS_PutawayStrategyDetail = new HashSet<tbl_WMS_PutawayStrategyDetail>();
        }
        ...
        public virtual ICollection<tbl_WMS_PutawayStrategyDetail> tbl_WMS_PutawayStrategyDetail { get; set; }
    }
}
...
{
	using System;
	public partial class DTO_WMS_PutawayStrategy
	{
		public int IDBranch { get; set; }
		public int Id { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WMS_PutawayStrategy 
    {
		...
		public static IQueryable<DTO_WMS_PutawayStrategy> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WMS_PutawayStrategy";
		...
		public static DTO_WMS_PutawayStrategy getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WMS_PutawayStrategy.Find(id);
		...
		public static DTO_WMS_PutawayStrategy getAnItemByCode(AppEntities db, int IDBranch, int StaffID, string code)
        {
            var dbResult = db.tbl_WMS_PutawayStrategy
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WMS_PutawayStrategy.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WMS_PutawayStrategy",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WMS_PutawayStrategy dbitem, string Username)
        {
            Type type = typeof(tbl_WMS_PutawayStrategy);
        ...
        public static void patchDTOtoDBValue( DTO_WMS_PutawayStrategy item, tbl_WMS_PutawayStrategy dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WMS_PutawayStrategy post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WMS_PutawayStrategy dbitem = new tbl_WMS_PutawayStrategy();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WMS_PutawayStrategy.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WMS_PutawayStrategy",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WMS_PutawayStrategy();
                    ...
                    {
                        dbitem = new tbl_WMS_PutawayStrategy();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WMS_PutawayStrategy.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WMS_PutawayStrategy.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WMS_PutawayStrategy.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                {
                    BS_Version.update_Version(db, IDBranch, "DTO_WMS_PutawayStrategy", updateDate, Username);
                }
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WMS_PutawayStrategy",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WMS_PutawayStrategy",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WMS_PutawayStrategy.Any(e => e.Id == id && e.IsDeleted == false);
		...
		public static bool check_Exists(AppEntities db, string Code)
		{
            ...
            return db.tbl_WMS_PutawayStrategy.Any(e => e.Code == Code && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WMS_PutawayStrategy> toDTO(IQueryable<tbl_WMS_PutawayStrategy> query)
        {
			return query
			.Select(s => new DTO_WMS_PutawayStrategy(){							
				IDBranch = s.IDBranch,							
				Id = s.Id,							
				Code = s.Code,							
				Name = s.Name,							
		...
		public static DTO_WMS_PutawayStrategy toDTO(tbl_WMS_PutawayStrategy dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WMS_PutawayStrategy()
				{							
		...
		public static IQueryable<tbl_WMS_PutawayStrategy> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WMS_PutawayStrategy> query = db.tbl_WMS_PutawayStrategy.AsNoTracking();//.Where(d => d.IsDeleted == false);
        ...
        public static IQueryable<tbl_WMS_PutawayStrategy> _sortBuilder(IQueryable<tbl_WMS_PutawayStrategy> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WMS_PutawayStrategy>;
        ...
        public static IQueryable<tbl_WMS_PutawayStrategy> _pagingBuilder(IQueryable<tbl_WMS_PutawayStrategy> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
