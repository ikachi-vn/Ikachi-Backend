...
namespace ClassLibrary
{
    ...
    public partial class tbl_WEB_Content_Tag
    {
        ...
        //List 0:1
        public virtual tbl_WEB_Content tbl_WEB_Content { get; set; }
        //List 0:1
...
{
	using System;
	public partial class DTO_WEB_Content_Tag
	{
		public int IDBaiViet { get; set; }
		public int IDTag { get; set; }
		public int Id { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_WEB_Content_Tag 
    {
		...
		public static IQueryable<DTO_WEB_Content_Tag> get(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
        ...
        {
            package.Workbook.Properties.Title = "ART-DMS WEB_Content_Tag";
		...
		public static DTO_WEB_Content_Tag getAnItem(AppEntities db, int IDBranch, int StaffID, int id)
        {
            var dbResult = db.tbl_WEB_Content_Tag.Find(id);
        ...
        {
            bool result = false;
            var dbitem = db.tbl_WEB_Content_Tag.Find(Id);
            ...
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("put_WEB_Content_Tag",e);
                    result = false;
                }
            }
            else
        ...
        public static void patchDynamicToDB(dynamic item, tbl_WEB_Content_Tag dbitem, string Username)
        {
            Type type = typeof(tbl_WEB_Content_Tag);
        ...
        public static void patchDTOtoDBValue( DTO_WEB_Content_Tag item, tbl_WEB_Content_Tag dbitem)
        {
            if (item == null){
                dbitem = null;
                return;
		...
		public static DTO_WEB_Content_Tag post(AppEntities db, int IDBranch, int StaffID, dynamic item, string Username)
        {
            tbl_WEB_Content_Tag dbitem = new tbl_WEB_Content_Tag();
            if (item != null)
            {
                patchDynamicToDB(item, dbitem, Username);
                ...
                try
                {
					db.tbl_WEB_Content_Tag.Add(dbitem);
                    db.SaveChanges();
				
                }
                catch (DbEntityValidationException e)
                {
					errorLog.logMessage("post_WEB_Content_Tag",e);
                    return null;
                }
            }
            return toDTO(dbitem);
            ...
            if (workBook != null)
            {
                ...
                for (int r = firstRow; r <= SheetRowCount; r++){
                    ...
                    for (int c = firstColIndex; c <= SheetColumnsCount; c++)
                    {
                        ...
                        var target = new tbl_WEB_Content_Tag();
                    ...
                    {
                        dbitem = new tbl_WEB_Content_Tag();
                        dbitem.CreatedBy = Username;
				        dbitem.CreatedDate = DateTime.Now;
                                            }
                    else
                    {
                        dbitem = db.tbl_WEB_Content_Tag.Find((int)it.Id);
                    }
                    ...
                    try
                    {
                        ...
                        if (dbitem.Id == 0) db.tbl_WEB_Content_Tag.Add(dbitem);
                    }
                    catch (Exception ex)
                    {
                        errCount++;
		...
		public static bool delete(AppEntities db, string ids, string Username)
        {
            ...
            var dbitems = db.tbl_WEB_Content_Tag.Where(d => IDs.Contains(d.Id));
            ...
            try
            {
                ...
                BS_Version.update_Version(db, null, "DTO_WEB_Content_Tag", updateDate, Username);
			
            }
            catch (DbEntityValidationException e)
            {
				errorLog.logMessage("delete_WEB_Content_Tag",e);
                result = false;
            }
        ...
        public static bool disable(AppEntities db, string ids, bool isDisable, string Username)
        {
            ...
            {
				errorLog.logMessage("disable_WEB_Content_Tag",e);
                result = false;
            }
		...
		public static bool check_Exists(AppEntities db, int id)
		{
            ...
            return db.tbl_WEB_Content_Tag.Any(e => e.Id == id && e.IsDeleted == false);
            
		}
		
		//---//
		public static IQueryable<DTO_WEB_Content_Tag> toDTO(IQueryable<tbl_WEB_Content_Tag> query)
        {
			return query
			.Select(s => new DTO_WEB_Content_Tag(){							
		...
		public static DTO_WEB_Content_Tag toDTO(tbl_WEB_Content_Tag dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_WEB_Content_Tag()
				{							
		...
		public static IQueryable<tbl_WEB_Content_Tag> _queryBuilder(AppEntities db, int IDBranch, int StaffID, Dictionary<string, string> QueryStrings)
        {
            
			IQueryable<tbl_WEB_Content_Tag> query = db.tbl_WEB_Content_Tag.AsNoTracking();//.Where(d => d.IsDeleted == false );
        ...
        public static IQueryable<tbl_WEB_Content_Tag> _sortBuilder(IQueryable<tbl_WEB_Content_Tag> query, Dictionary<string, string> QueryStrings)
        {
            if (QueryStrings.Any(d => d.Key == "SortBy"))
            {
                ...
                foreach (var item in sorts)
                    ...
                    {
                        var ordered = query as IOrderedQueryable<tbl_WEB_Content_Tag>;
                        ...
                        switch (item)
                        {
							...
							case "IDBaiViet_desc":
                                ...
                                break;
							case "IDTag":
								query = isOrdered ? ordered.ThenBy(o => o.IDTag) : query.OrderBy(o => o.IDTag);
								 break;
							case "IDTag_desc":
                                query = isOrdered ? ordered.ThenByDescending(o => o.IDTag) : query.OrderByDescending(o => o.IDTag);
                                break;
							case "Id":
        ...
        public static IQueryable<tbl_WEB_Content_Tag> _pagingBuilder(IQueryable<tbl_WEB_Content_Tag> query, Dictionary<string, string> QueryStrings)
        {
            int skip = 0;
            int take = 200;
